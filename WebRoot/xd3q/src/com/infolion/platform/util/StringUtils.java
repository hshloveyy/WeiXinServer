...
public class StringUtils
{
    ...
    public static String[] splitString(String sourceStr,String splitStr)
    {
        ...
        if(null == splitStr || "".equals(splitStr)){
            arrayRetu = new String[1];
            arrayRetu[0] = sourceStr;
            return arrayRetu;
        }

        StringTokenizer tokenizer = new StringTokenizer(sourceStr,splitStr);
        arrayRetu = new String[tokenizer.countTokens()];
        int i = 0;
        while(tokenizer.hasMoreTokens()){
            arrayRetu[i] = tokenizer.nextToken();
            i++;
        }
        return arrayRetu;
    }
     ...
     * 删除指定的前导、后导子串（大小写敏感）.
     * <br>例子：
     * <br>StringUtils.trim("and and username = '123' and password = 'abc' and ",'a');
     * <br>结果：nd and username = '123' and password = 'abc' and
     * @param sourceStr String
     * 待删除的字符串
     ...
     * @param source String
     * @return boolean
     * 只包含数字返回true,source为空返回false,为空字符串返回true
     */
    public static boolean isAllNumChar(String source)
    {
        if(source == null){
            return false;
        }
        ...
        for(int i=0,iLen=chars.length;i<iLen;i++){
            if(nums.indexOf(chars[i]) < 0){
                return false;
            }
        }
        return true;
    ...
    public static void main(String[] args)
    {
        /*
             StringBuffer strBuf = new StringBuffer("");
             System.out.println(StringUtils.getNumFormat(1234.15,"###.0"));
             System.out.println("--------------------------------");
        ...
        /*
             ...
             String oldstr = ";;";
             String newstr = ";";
         System.out.println(StringUtils.replaceString(str, oldstr, newstr, true));
         */
        /*
            String res = StringUtils.substring("abc",3,"...");
            System.out.println(res);
            System.out.println((int)'z');
            for(int i=0;i<5;i++){
          System.out.println(StringUtils.random(6));
          System.out.println(StringUtils.randomString(6));
          System.out.println(StringUtils.randomNumber(6));
            }
         */
        String src = "中abcd.，()?；efg";
        System.out.println(src);
        String res = StringUtils.encrypt(src,true);
        System.out.println(res);
        System.out.println(StringUtils.encrypt(res,false));
    }
}
