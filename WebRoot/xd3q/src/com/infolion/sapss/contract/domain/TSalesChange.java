...
@Entity
@Table(name = "T_SALES_CHANGE")
public class TSalesChange extends ProcessObject{
	@Id
	@Column(name = "CHANGE_ID", unique = true, nullable = false, length = 36)
	private String changeId;
	@Column(name="CONTRACT_SALES_ID")
	...
	public void setWorkflowModelName() {
		this.workflowModelName="销售合同变更申请";
		
	}
	@Override
	public void setWorkflowProcessName() {
//		this.workflowProcessName="contract_sales_modify_v1";
		
	}
	@Override
	public void setWorkflowProcessUrl() {
		//this.workflowProcessUrl="projectController.spr?action=projectExamine";
		this.workflowProcessUrl="saleChangeController.spr?action=workflowSubmit";
	}
