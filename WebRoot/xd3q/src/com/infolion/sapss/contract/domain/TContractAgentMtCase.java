 ...
 */
@Entity
@Table(name = "T_CONTRACT_AGENT_MT_CASE")
public class TContractAgentMtCase implements java.io.Serializable {
	...
	//其他费用对应的销售合同物料信息
	@ManyToOne
    @JoinColumn(name = "PURCHASE_ROWS_ID", nullable = false)
	private TContractAgentMateriel contractAgentMateriel;
	// Constructors

	/** default constructor */
	public TContractAgentMtCase() {
	}

	/** minimal constructor */
	public TContractAgentMtCase(String materielCaseId, String konvKschl,
	...
	/** full constructor */
	public TContractAgentMtCase(String materielCaseId, String salesRowsId,
	...
	@Transient	
	public TContractAgentMateriel getContractAgentMateriel() {
		return contractAgentMateriel;
	}

	public void setContractAgentMateriel(
			TContractAgentMateriel contractAgentMateriel) {
		this.contractAgentMateriel = contractAgentMateriel;
	}
