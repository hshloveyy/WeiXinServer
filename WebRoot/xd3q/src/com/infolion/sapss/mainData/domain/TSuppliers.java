...
public class TSuppliers extends ProcessObject {
	...
	/** minimal constructor */
	public TSuppliers(String suppliersId) {
		this.suppliersId = suppliersId;
	}

//	/** full constructor */
//	public TSuppliers(String suppliersId, String accountGroup,
...
//	}
	...
	// Property accessors
	@Id
	@Column(name = "SUPPLIERS_ID", unique = true, nullable = false, length = 36)
	...
	public void setWorkflowModelName() {
		this.workflowModelName = "供应商主数据";
	}

	@Override
	public void setWorkflowProcessName() {
		// this.workflowProcessName = "supplier_data_v1";
	}

	@Override
	public void setWorkflowProcessUrl() {
		this.workflowProcessUrl = "supplyController.spr?action=examine";
	}
