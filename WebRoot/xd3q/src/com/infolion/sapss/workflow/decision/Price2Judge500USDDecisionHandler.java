 ...
 * @since 1.0
 */
public class Price2Judge500USDDecisionHandler implements DecisionHandler {
	...
	public String decide(ExecutionContext executionContext) throws Exception {
		...
		if(value==null) return "金额小于500万美金或3500万人民币";
		...
		if("USD".equals(currency)){//如果是美金
			if(totalValue>=500)
				return "金额大于500万美金或3500万人民币";
			else
				return "金额小于500万美金或3500万人民币";
		} else {//其它币种
