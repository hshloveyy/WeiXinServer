 ...
 * @since 1.0
 */
public class Price3Judge1000USDDecisionHandler implements DecisionHandler {
	...
	public String decide(ExecutionContext executionContext) throws Exception {
		...
		if(value==null) return "金额小于1000万美金或7000万人民币";
		...
		if("USD".equals(currency)){//如果是美金
			if(totalValue>=1000)
				return "金额大于1000万美金或7000万人民币";
			else
				return "金额小于1000万美金或7000万人民币";
		} else {//其它币种
			if (totalValue*Double.parseDouble(rate) >= 3500)
				return "金额大于1000万美金或7000万人民币";
			else
				return "金额小于1000万美金或7000万人民币";
		}
