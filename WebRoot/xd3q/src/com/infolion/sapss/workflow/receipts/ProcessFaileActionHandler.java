...
public class ProcessFaileActionHandler implements ActionHandler {
	public void execute(ExecutionContext context) throws Exception {
		...
		//
		ReceiptsProcessService receiptsProcessService = (ReceiptsProcessService) EasyApplicationContextUtils
			.getBeanByName("receiptsProcessService");
		receiptsProcessService.processFaile(businessRecordId, processId);
