 ...
 */
@Service
public class ReceiptMoneyProcessService extends BaseHibernateService
{
	/**
	 * 流程通过
	 * 
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "更新收款信息通过");
		ReceiptMoneyService receiptMoneyService = (ReceiptMoneyService) EasyApplicationContextUtils
			.getBeanByName("receiptMoneyService");
		receiptMoneyService.updateBusinessRecord(businessRecordId, ProcessCallBack.EXAMINE_SUCCESSFUL, null);
	}
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "更新收款信息不通过");
