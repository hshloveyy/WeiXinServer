...
public class SalesReturnAmount02DecisionHandler implements DecisionHandler{

	public String decide(ExecutionContext executionContext) throws Exception {
		Object value = executionContext.getVariable("totalMoney");
		if(value==null) return "金额小于200万USD或1400万CNY";
		Double totalValue=0.0;
		totalValue = Double.parseDouble(value.toString())/10000;
		if(totalValue>1400)
			return "金额大于200万USD或1400万CNY";
		else
			return "金额小于200万USD或1400万CNY";
	}
