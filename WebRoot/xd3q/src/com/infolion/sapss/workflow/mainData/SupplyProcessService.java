 ...
 */
@Service
public class SupplyProcessService extends BaseHibernateService
{
	/**
	 * 物料主数据流程审批通过
	 * 
	...
	public void processBaleLoanSucessful(String businessRecordId, long processId)
	{
		...
		SupplyHibernateService supplyHibernateService = (SupplyHibernateService) EasyApplicationContextUtils
			.getBeanByName("supplyHibernateService");
		supplyHibernateService.updateBusinessRecord(businessRecordId,
	...
	public void processBaleLoanFaile(String businessRecordId, long processId)
	{
		...
		SupplyHibernateService supplyHibernateService = (SupplyHibernateService) EasyApplicationContextUtils
		.getBeanByName("supplyHibernateService");
		ProcessCallBack callBack = (ProcessCallBack) supplyHibernateService;
