 ...
 * @since 1.0
 */
public class GuestSuccessActionHandler implements ActionHandler
{
	public void execute(ExecutionContext context) throws Exception
	{
		...
		GuestProcessService guestProcessService = (GuestProcessService) EasyApplicationContextUtils
				.getBeanByName("guestProcessService");
		
		guestProcessService.processBaleLoanSucessful(businessRecordId,
				processId);
