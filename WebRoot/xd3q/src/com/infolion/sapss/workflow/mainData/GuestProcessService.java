 ...
 */
@Service
public class GuestProcessService extends BaseHibernateService
{
	/**
	 * 物料主数据流程审批通过
	 * 
	...
	public void processBaleLoanSucessful(String businessRecordId, long processId)
	{
		...
		GuestHibernateService guestHibernateService = (GuestHibernateService) EasyApplicationContextUtils
			.getBeanByName("guestHibernateService");
		guestHibernateService.updateBusinessRecord(businessRecordId,
	...
	public void processBaleLoanFaile(String businessRecordId, long processId)
	{
		...
		GuestHibernateService guestHibernateService = (GuestHibernateService) EasyApplicationContextUtils
				.getBeanByName("guestHibernateService");
		ProcessCallBack callBack = (ProcessCallBack) guestHibernateService;
