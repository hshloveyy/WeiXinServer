 ...
 * @since 1.0
 */
public class WriteSapOrderActionHandler implements ActionHandler {
	public void execute(ExecutionContext context) throws Exception {
		...
		String result = purchaseProcessService.writeSapOrder(businessRecordId);
		context.getContextInstance().setVariable("_workflow_is_allow", result);
