 ...
 */
@Service     
public class CreditArriveProcessService extends BaseHibernateService
{
	/**
	 * 流程通过
	 * 
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "信用证到证申请通过");
		CreditArriveJdbcService creditArrive = (CreditArriveJdbcService) EasyApplicationContextUtils.getBeanByName("creditArriveJdbcService");
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "信用证到证申请未通过");
		CreditArriveJdbcService creditArrive = (CreditArriveJdbcService) EasyApplicationContextUtils.getBeanByName("creditArriveJdbcService");
		ProcessCallBack callBack = (ProcessCallBack) creditArrive;
