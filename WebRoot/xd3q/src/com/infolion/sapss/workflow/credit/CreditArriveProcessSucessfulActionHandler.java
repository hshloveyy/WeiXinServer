 ...
 * @since 1.0
 */
public class CreditArriveProcessSucessfulActionHandler implements ActionHandler
{
	public void execute(ExecutionContext context) throws Exception
	{
		...
		CreditArriveProcessService creditArriveProcessService = (CreditArriveProcessService) EasyApplicationContextUtils.getBeanByName("creditArriveProcessService");
		creditArriveProcessService.processSucessful(businessRecordId, processId, creditState);
