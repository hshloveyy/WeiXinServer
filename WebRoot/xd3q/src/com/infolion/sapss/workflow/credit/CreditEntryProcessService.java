 ...
 */
@Service
public class CreditEntryProcessService extends BaseHibernateService
{
	/**
	 * 流程通过
	 * 
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "信用证开证申请通过");
		CreditEntryJdbcService creditEntry = (CreditEntryJdbcService) EasyApplicationContextUtils.getBeanByName("creditEntryJdbcService");
	...
	{
		WorkflowService.updateProcessInstanceEndState(processId, "信用证开证申请未通过");
		CreditEntryJdbcService creditEntry = (CreditEntryJdbcService) EasyApplicationContextUtils.getBeanByName("creditEntryJdbcService");
		ProcessCallBack callBack = (ProcessCallBack) creditEntry;
