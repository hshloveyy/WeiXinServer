 ...
 * @since 1.0
 */
public class PledgeShipSucessfulActionHandler implements ActionHandler
{
	...
	public void execute(ExecutionContext context) throws Exception
	{
		...
		PledgeShipProcessService pledgeShipProcessService = (PledgeShipProcessService) EasyApplicationContextUtils
				.getBeanByName("pledgeShipProcessService");
		pledgeShipProcessService.processSucessful(businessRecordId, processId);
