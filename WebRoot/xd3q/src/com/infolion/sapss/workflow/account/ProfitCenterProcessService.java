...
@Service
public class ProfitCenterProcessService extends BaseHibernateService {
	public void processSucessful(String businessRecordId, long processId) {
		...
		ProfitCenterHibernateService service = (ProfitCenterHibernateService) EasyApplicationContextUtils
				.getBeanByName("profitCenterHibernateService");
