 ...
 * @since 1.0
 */
public class BillApplySucessfulActionHandler implements ActionHandler {
	public void execute(ExecutionContext context) throws Exception {
		...
		BillProcessService billProcessService = (BillProcessService) EasyApplicationContextUtils
				.getBeanByName("billProcessService");
		
		billProcessService.processBillApplySucessful(businessRecordId,
				processId);
