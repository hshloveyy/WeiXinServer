/*
 * @(#)ParticularProcessSuccessActionHandler.java
...
public class ParticularProcessSuccessActionHandler implements ActionHandler {
	...
	public void execute(ExecutionContext ctxt) throws Exception {
		...
		if(module!=null && !"".equals(module)){
			if(module.indexOf("销售合同")!=-1){
				...
				cs.updateSaleOrderState(info.getOriginalBizId(), "11");
			}else if(module.indexOf("采购合同")!=-1){
				ContractService cs = (ContractService)EasyApplicationContextUtils.getBeanByType(ContractService.class);
				cs.updatePurchaserOrderState(info.getOriginalBizId(), "11");
				...
				cs.updateStatus(info.getOriginalBizId(), "8");
				...
				cs.updateReceipts(info.getOriginalBizId(),"examine_state", "8");
				...
				cs.updateState(info.getOriginalBizId(), "13");
			}
		}
