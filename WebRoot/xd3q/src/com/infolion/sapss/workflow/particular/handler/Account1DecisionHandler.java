...
public class Account1DecisionHandler implements DecisionHandler {
	...
	public String decide(ExecutionContext ctxt) throws Exception {
		...
		if("CNY".equals(currency) && (account/10000)>1400)
			return "金额大于200万美金或1400万人民币";
		else if("USD".equals(currency) && (account/10000)>200)
			return "金额大于200万美金或1400万人民币";
		else if(account * rate/10000 >1400){
					return "金额大于200万美金或1400万人民币";
		}
