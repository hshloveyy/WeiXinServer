/*
 * @(#)NegotiatingPrice1JudgeDecisionHandler.java
...
public class NegotiatingPrice1JudgeDecisionHandler implements DecisionHandler{
	...
	public String decide(ExecutionContext executionContext) throws Exception {
		...
		if(value==null) return "小于200万USD或1400万CNY";
