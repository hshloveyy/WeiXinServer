/*
 * @(#)LCDPDAProcessSuccessActionHandler.java
...
public class LCDPDAProcessSuccessActionHandler implements ActionHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		WorkflowService.updateProcessInstanceEndState(processId,"LC/DP/DA申请通过");
		...
		servie.updateBusinessRecord(businessRecordId, ProcessCallBack.EXAMINE_SUCCESSFUL, null);
