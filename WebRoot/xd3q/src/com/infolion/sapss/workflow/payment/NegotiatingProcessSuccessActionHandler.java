/*
 * @(#)NegotiatingProcessSuccessActionHandler.java
...
public class NegotiatingProcessSuccessActionHandler implements ActionHandler{
	public void execute(ExecutionContext context) throws Exception {
		...
		WorkflowService.updateProcessInstanceEndState(processId,"押汇申请通过");
