...
public class DemoFrame extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jtextMobile = new javax.swing.JTextArea("15960230210");
    ...
    private void jBtnSendActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if(smType == 1)
        {
                ...
                result = apiClient.sendSM(mobiles, content, smId, srcID, url, sendTime);
                        ...
                        String[] moblieTest = {"13516870834","15960230210"};
        ...
        {       //System.out.println(mobiles[0]+","+content+","+sendTime+","+ smId+","+srcID);
