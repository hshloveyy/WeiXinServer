...
public class TProjectChange extends ProcessObject{
	@Id
...
//		this.workflowProcessName="project_modify_v1";
	...
	public void setWorkflowProcessUrl() {
		...
		this.workflowProcessUrl="changeProjectController.spr?action=workflowSubmit";
	}
