 ...
 */
@Repository
public class CreditArriveHisJdbcDao extends BaseDao
{
	/**
	 ...
	 * @return creditId
	 */
	public void workflowUpdateState(String businessRecordId, String examineResult, String creditState)
	{
		String creditId;
		String sql = "";
		...
		this.getJdbcTemplate().update(sql, new Object[] { creditState, changeState, DateUtils.getCurrTime(DateUtils.DB_STORE_DATE), DateUtils.getCurrTime(DateUtils.DB_STORE_DATE), "1", creditId, businessRecordId }); // 4，变更已经执行

		// 更新信用证主表 状态
		sql = "update T_CREDIT_INFO set credit_state=? where CREDIT_ID=?";
		this.getJdbcTemplate().update(sql, new Object[] { "5", creditId });
		
		//System.out.println("更新creditState:" + creditState);
