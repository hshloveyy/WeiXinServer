 ...
 */
@Entity
@Table(name = "T_CREDIT_HIS_INFO")
public class TCreditHisInfo extends ProcessObject
{

	// Fields
	private String creditHisId;
	private Integer versionNo;
	private String isExecuted;
	private String changeTime;
	private String changeExecTime;
	...
	@ValidateRule(dataType = DataType.STRING, label = "关联合同号", maxLength = 300, required = false)
	...
	private String modifyInfo;//修改事项
	private String availDate;//期效
	private String ymatGroup;
	// Constructors  dataType = DataType.NUMBER

	/** default constructor */
	public TCreditHisInfo()
	{
	}

	/** minimal constructor */
	public TCreditHisInfo(String creditId, String creditHisId,
			String createOrRec)
	{
		this.creditId = creditId;
		this.createOrRec = createOrRec;
		this.creditHisId = creditHisId;
	}

	/** full constructor */
	public TCreditHisInfo(String creditId, String tradeType,
			String creditState, String creditNo, String projectNo,
			String projectName, String sapOrderNo, String contractNo,
			String createOrRec, String customCreateDate, String creditRecDate,
			String createBank, String createDate, String country,
			String request, String benefit, String benefitCertification,
			String paymentType, String amount, String goods,
			String specification, String mark, String invoice,
			...
			String creditHisId, Integer versionNo, String isExecuted,
			String changeTime, String changeExecTime, String creditInfo,
			String applyer, String bailDate,String contractId,String ymatGroup)
	{
		this.creditId = creditId;
		...
		this.changeExecTime = changeExecTime;
	...
	// Property accessors
	@Id
	@Column(name = "CREDIT_HIS_ID", unique = true, nullable = false, length = 36)
	public String getCreditHisId()
	{
		return creditHisId;
	}

	public void setCreditHisId(String creditHisId)
	{
		this.creditHisId = creditHisId;
	}
	...
	@Column(name = "IS_EXECUTED", length = 1)
	...
	@Column(name = "CHANGE_EXEC_TIME", length = 20)
	public String getChangeExecTime()
	{
		return changeExecTime;
	}

	public void setChangeExecTime(String changeExecTime)
	{
		this.changeExecTime = changeExecTime;
	}
	...
	public void setWorkflowModelId()
	{
		...
		this.workflowModelId = "CREDITENTRYHISINFO";
	}

	@Override
	public void setWorkflowModelName()
	{
		//this.workflowModelName = "信用证开证改证申请";
	...
	{
//		this.workflowProcessName = "credit_application_modify_v1";
	}

	@Override
	public void setWorkflowProcessUrl()
	{
		this.workflowProcessUrl = "creditEntryHisController.spr?action=creditEntryExamine";

	}
	@Column(name = "modify_info", length = 2000)
