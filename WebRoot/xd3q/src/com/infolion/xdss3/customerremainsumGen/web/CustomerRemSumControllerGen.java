/*
 * @(#)CustomerRemSumControllerGen.java
 ...
 *  描　述：创建
 */
package com.infolion.xdss3.customerremainsumGen.web;
 ...
 * @since 1.0
 */
public class CustomerRemSumControllerGen extends AbstractGenController
{
	private final String boName = "CustomerRemSum";
	...
	@Autowired
	protected CustomerRemSumService customerRemSumService;
	
	public void setCustomerRemSumService(CustomerRemSumService customerRemSumService)
	{
		this.customerRemSumService = customerRemSumService;
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("customerRemSum",customerRemSum);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000339");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/customerremainsum/customerRemSumAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("cprid");
		CustomerRemSum customerRemSum = this.customerRemSumService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		customerRemSumService._delete(cprid,getBusinessObject());
	...
	{
		String customerRemSumIds = request.getParameter("customerRemSumIds");
		customerRemSumService._deletes(customerRemSumIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
customerRemSum = this.customerRemSumService._get(id);        }
        else
        {
           customerRemSum = this.customerRemSumService._get(id);
        }
		...
		request.setAttribute("customerRemSum", customerRemSum);  
		return new ModelAndView("xdss3/customerremainsum/customerRemSumView");
	}
	...
	{
		// 绑定主对象值
		CustomerRemSum customerRemSum = (CustomerRemSum) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerRemSum.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.customerRemSumService._saveOrUpdate(customerRemSum
,getBusinessObject());
}
this.customerRemSumService._submitProcess(customerRemSum		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		CustomerRemSum customerRemSum  = new CustomerRemSum();
		String cprid = request.getParameter("cprid");
		customerRemSum.setCprid(cprid);
		LockService.unLockBOData(customerRemSum);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		CustomerRemSum customerRemSum = (CustomerRemSum) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerRemSum.class , true , request.getMethod(), true);
this.customerRemSumService._saveOrUpdate(customerRemSum,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(customerRemSum.getCprid());
		...
		{	
		jo.put("cprid", customerRemSum.getCprid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
customerRemSum = this.customerRemSumService._getForEdit(id);        }
        else
        {
           customerRemSum = this.customerRemSumService._getForEdit(id);
        }
		...
		request.setAttribute("customerRemSum", customerRemSum);
		return new ModelAndView("xdss3/customerremainsum/customerRemSumEdit");
	}
}