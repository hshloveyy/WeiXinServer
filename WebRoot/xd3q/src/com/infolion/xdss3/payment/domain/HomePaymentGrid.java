...
public class HomePaymentGrid extends GridTagHandler {
	...
	private String homePaymentColumn[] = {
            ...
            "dept_id_text", "dept_id", "arrivegoodsdate", "accountdate", "voucherdate",
            ...
            "paymenttype", "expiredate", "billbc", "paydate", "documentarydate",
    ...
    private String name[] = { "paymentid", "businessstate", "paymentno", "supplier_text", "supplier", "paymentstate",
            ...
            "dept_id", "arrivegoodsdate", "accountdate", "voucherdate", "factamount",
            ...
            "billbc", "paydate", "documentarydate", "documentarylimit", "payrealdate",
	...
	public HomePaymentGrid() {
		buildGrid();
	}

	public void buildGrid() {
	    // 判断是否在name[]存在
	    List showColumn = Arrays.asList("操作", "付款单号","供应商名称", "付款单状态", "币别名称","付款人","部门名称",
	            "预计到货日","记账日期", "业务状态","银行对外付款日","银承到期日",
	            "凭证日期","实际付款金额","实际币别名称","实际币别","付款类型", "收款银行账号", //"是否贸管预付款",
	            "应收票日","财务编号", "是否海外代付", "创建人","付款方式","创建日期");
...
//			} else if ("dept_id".equalsIgnoreCase(name[i])) {
...
//		          shlpcolumnEditor.setBoName("HomePayment");
//		          shlpcolumnEditor.setPropertyName("dept_id");
//		          shlpcolumnEditor.setShlpName("YHORGANIZATION");
//		          shlpcolumnEditor.setShlpIdColumnName("ORGANIZATIONID");
//		          shlpcolumnEditor.setShlpTextColumnName("ORGANIZATIONNAME");
