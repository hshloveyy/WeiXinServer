/*
 * @(#)InvoiceVerifyItemControllerGen.java
...
/**
 * <pre>
 * 发票校验行项目(InvoiceVerifyItem)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class InvoiceVerifyItemControllerGen extends AbstractGenController
{
	private final String boName = "InvoiceVerifyItem";
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    invoiceVerifyItem = (InvoiceVerifyItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), InvoiceVerifyItem.class , false, request.getMethod(), false);
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("invoiceVerifyItem", invoiceVerifyItem);
		return new ModelAndView("xdss3/tradeMonitoring/invoiceVerifyItemEdit");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("invoiceVerifyItem", invoiceVerifyItem);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000275");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", "");	
		request.setAttribute("workflowNodeDefId", "");
		return new ModelAndView("xdss3/tradeMonitoring/invoiceVerifyItemAdd");
	}
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		invoiceVerifyItemService._delete(code,getBusinessObject());
	...
	{
		String invoiceVerifyItemIds = request.getParameter("invoiceVerifyItemIds");
		invoiceVerifyItemService._deletes(invoiceVerifyItemIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("invoiceVerifyItem", invoiceVerifyItem);  
		return new ModelAndView("xdss3/tradeMonitoring/invoiceVerifyItemView");
	}
	...
	{
		// 绑定主对象值
		InvoiceVerifyItem invoiceVerifyItem = (InvoiceVerifyItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), InvoiceVerifyItem.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!StringUtils.isNullBlank(type) && type.equalsIgnoreCase("view"))
{
this.invoiceVerifyItemService._saveOrUpdate(invoiceVerifyItem
,getBusinessObject());
}
this.invoiceVerifyItemService._submitProcess(invoiceVerifyItem		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/tradeMonitoring/invoiceVerifyItemManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		InvoiceVerifyItem invoiceVerifyItem  = new InvoiceVerifyItem();
		String code = request.getParameter("code");
		invoiceVerifyItem.setCode(code);
		LockService.unLockBOData(invoiceVerifyItem);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		InvoiceVerifyItem invoiceVerifyItem = (InvoiceVerifyItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), InvoiceVerifyItem.class , true , request.getMethod(), true);
this.invoiceVerifyItemService._saveOrUpdate(invoiceVerifyItem,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(invoiceVerifyItem.getCode());
		...
		{	
		jo.put("code", invoiceVerifyItem.getCode());
