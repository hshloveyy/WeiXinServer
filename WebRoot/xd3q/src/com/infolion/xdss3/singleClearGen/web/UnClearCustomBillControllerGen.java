/*
 * @(#)UnClearCustomBillControllerGen.java
 * 版权声明 福建讯盟软件有限公司, 版权所有 违者必究
 *
 *修订记录:
 *1)更改者：java业务平台代码生成工具
 *  时　间：2010年07月19日 11点44分18秒
 *  描　述：创建
 */
...
/**
 * <pre>
 * 未清应收(借方)(UnClearCustomBill)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class UnClearCustomBillControllerGen extends AbstractGenController
{
	private final String boName = "UnClearCustomBill";
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    unClearCustomBill = (UnClearCustomBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearCustomBill.class , false, request.getMethod(), false);
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("unClearCustomBill", unClearCustomBill);
		return new ModelAndView("xdss3/singleClear/unClearCustomBillEdit");
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("unClearCustomBill",unClearCustomBill);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000332");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/singleClear/unClearCustomBillAdd");
	}
	...
	{
		String unclearcusbillid = request.getParameter("unclearcusbillid");
		unClearCustomBillService._delete(unclearcusbillid,getBusinessObject());
	...
	{
		String unClearCustomBillIds = request.getParameter("unClearCustomBillIds");
		unClearCustomBillService._deletes(unClearCustomBillIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("unClearCustomBill", unClearCustomBill);  
		return new ModelAndView("xdss3/singleClear/unClearCustomBillView");
	}
	...
	{
		// 绑定主对象值
		UnClearCustomBill unClearCustomBill = (UnClearCustomBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearCustomBill.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!StringUtils.isNullBlank(type) && type.equalsIgnoreCase("view"))
{
this.unClearCustomBillService._saveOrUpdate(unClearCustomBill
,getBusinessObject());
}
this.unClearCustomBillService._submitProcess(unClearCustomBill		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/singleClear/unClearCustomBillManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		UnClearCustomBill unClearCustomBill  = new UnClearCustomBill();
		String unclearcusbillid = request.getParameter("unclearcusbillid");
		unClearCustomBill.setUnclearcusbillid(unclearcusbillid);
		LockService.unLockBOData(unClearCustomBill);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		UnClearCustomBill unClearCustomBill = (UnClearCustomBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearCustomBill.class , true , request.getMethod(), true);
this.unClearCustomBillService._saveOrUpdate(unClearCustomBill,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(unClearCustomBill.getUnclearcusbillid());
		...
		{	
		jo.put("unclearcusbillid", unClearCustomBill.getUnclearcusbillid());
