/*
 * @(#)UnClearSupplieBillControllerGen.java
 ...
 * @since 1.0
 */
public class UnClearSupplieBillControllerGen extends AbstractGenController
{
	private final String boName = "UnClearSupplieBill";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("unClearSupplieBill",unClearSupplieBill);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000326");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/singleClear/unClearSupplieBillAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		UnClearSupplieBill unClearSupplieBill = new UnClearSupplieBill ();
	    unClearSupplieBill = (UnClearSupplieBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearSupplieBill.class , false , request.getMethod(), false);
		request.setAttribute("unClearSupplieBill", unClearSupplieBill);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000326");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		unClearSupplieBillService._delete(unclearsbillid,getBusinessObject());
	...
	{
		String unClearSupplieBillIds = request.getParameter("unClearSupplieBillIds");
		unClearSupplieBillService._deletes(unClearSupplieBillIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("unClearSupplieBill", unClearSupplieBill);  
		return new ModelAndView("xdss3/singleClear/unClearSupplieBillView");
	}
	...
	{
		// 绑定主对象值
		UnClearSupplieBill unClearSupplieBill = (UnClearSupplieBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearSupplieBill.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!StringUtils.isNullBlank(type) && type.equalsIgnoreCase("view"))
{
this.unClearSupplieBillService._saveOrUpdate(unClearSupplieBill
,getBusinessObject());
}
this.unClearSupplieBillService._submitProcess(unClearSupplieBill		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/singleClear/unClearSupplieBillManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		UnClearSupplieBill unClearSupplieBill  = new UnClearSupplieBill();
		String unclearsbillid = request.getParameter("unclearsbillid");
		unClearSupplieBill.setUnclearsbillid(unclearsbillid);
		LockService.unLockBOData(unClearSupplieBill);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		UnClearSupplieBill unClearSupplieBill = (UnClearSupplieBill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnClearSupplieBill.class , true , request.getMethod(), true);
this.unClearSupplieBillService._saveOrUpdate(unClearSupplieBill,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(unClearSupplieBill.getUnclearsbillid());
		...
		{	
		jo.put("unclearsbillid", unClearSupplieBill.getUnclearsbillid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("unClearSupplieBill", unClearSupplieBill);
		return new ModelAndView("xdss3/singleClear/unClearSupplieBillEdit");
	}
