...
public class CollectSuretyBondContractDetailGrid extends GridTagHandler {
	
    private String collectColumn[] = { 
            "DEPT_NAME", "TRADE_TYPE_TEXT", "PROJECT_NO",
            "CONTRACT_NO", "VBKD_IHREZ", "VBAK_WAERK", "ORDER_TOTAL", "MARGIN_RATIO","ISPROMISE", "SURETYBOND_C", 
            "YMAT_GROUP", "CREATETIME" , "COLLECTNO" , "SURETYBOND" , "REMAINSURETYBOND" , "CURRENCY", "BUSINESSSTATE"
            };
    private String collectColumnTitle[] = { 
            "部门", "业务类型", "立项号", 
            "销售合同号", "外部纸质合同号", "合同币别", "合同金额", "保证金比例%","是否约定跌价保证金", "合同应收保证金金额", 
            "物料组（收款单行项目）",  "创建时间",  "收款单号",  "保证金金额",  "剩余保证金金额",  "收款币别", "收款单审批状态" };
	...
	public CollectSuretyBondContractDetailGrid() {
		buildGrid();
	}
