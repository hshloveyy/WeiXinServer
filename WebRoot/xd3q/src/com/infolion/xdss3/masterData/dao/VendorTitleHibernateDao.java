 ...
 */
@Repository
public class VendorTitleHibernateDao extends BaseHibernateDao<VendorTitle>
{
	/**
	 * 获取未清供应商数据凭证编号列表
	 * @return
	...
	public List<CertificateNo> getUnclearCertificateNo( String vendor)
	{
		...
		List<VendorTitle> vendorTitleList;
		if( vendor == null || vendor.equals(""))
		{
			String hql = "from VendorTitle where iscleared = '0'";
			vendorTitleList = this.find(hql);
		}
		else
		{
			String hql = "from VendorTitle where iscleared = '0' and lifnr = ?";
