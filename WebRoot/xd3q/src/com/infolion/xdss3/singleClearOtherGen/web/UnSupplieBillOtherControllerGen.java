/*
 * @(#)UnSupplieBillOtherControllerGen.java
...
/**
 * <pre>
 * 其他公司未清应付（贷方）(UnSupplieBillOther)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class UnSupplieBillOtherControllerGen extends AbstractGenController
{
	private final String boName = "UnSupplieBillOther";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("unSupplieBillOther",unSupplieBillOther);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000363");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/singleClearOther/unSupplieBillOtherAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("unclearsbillid");
		UnSupplieBillOther unSupplieBillOther = this.unSupplieBillOtherService._getEntityCopy(id);
	...
	{
		String unclearsbillid = request.getParameter("unclearsbillid");
		unSupplieBillOtherService._delete(unclearsbillid,getBusinessObject());
	...
	{
		String unSupplieBillOtherIds = request.getParameter("unSupplieBillOtherIds");
		unSupplieBillOtherService._deletes(unSupplieBillOtherIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
unSupplieBillOther = this.unSupplieBillOtherService._get(id);        }
        else
        {
           unSupplieBillOther = this.unSupplieBillOtherService._get(id);
        }
		...
		request.setAttribute("unSupplieBillOther", unSupplieBillOther);  
		return new ModelAndView("xdss3/singleClearOther/unSupplieBillOtherView");
	}
	...
	{
		// 绑定主对象值
		UnSupplieBillOther unSupplieBillOther = (UnSupplieBillOther) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnSupplieBillOther.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.unSupplieBillOtherService._saveOrUpdate(unSupplieBillOther
,getBusinessObject());
}
this.unSupplieBillOtherService._submitProcess(unSupplieBillOther		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/singleClearOther/unSupplieBillOtherManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		UnSupplieBillOther unSupplieBillOther  = new UnSupplieBillOther();
		String unclearsbillid = request.getParameter("unclearsbillid");
		unSupplieBillOther.setUnclearsbillid(unclearsbillid);
		LockService.unLockBOData(unSupplieBillOther);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		UnSupplieBillOther unSupplieBillOther = (UnSupplieBillOther) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), UnSupplieBillOther.class , true , request.getMethod(), true);
this.unSupplieBillOtherService._saveOrUpdate(unSupplieBillOther,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(unSupplieBillOther.getUnclearsbillid());
		...
		{	
		jo.put("unclearsbillid", unSupplieBillOther.getUnclearsbillid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
unSupplieBillOther = this.unSupplieBillOtherService._getForEdit(id);        }
        else
        {
           unSupplieBillOther = this.unSupplieBillOtherService._getForEdit(id);
        }
		...
		request.setAttribute("unSupplieBillOther", unSupplieBillOther);
		return new ModelAndView("xdss3/singleClearOther/unSupplieBillOtherEdit");
	}
