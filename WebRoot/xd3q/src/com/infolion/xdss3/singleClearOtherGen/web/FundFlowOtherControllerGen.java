/*
 * @(#)FundFlowOtherControllerGen.java
 ...
 * @since 1.0
 */
public class FundFlowOtherControllerGen extends AbstractGenController
{
	private final String boName = "FundFlowOther";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("fundFlowOther",fundFlowOther);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000366");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/singleClearOther/fundFlowOtherAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("fundflowid");
		FundFlowOther fundFlowOther = this.fundFlowOtherService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		fundFlowOtherService._delete(fundflowid,getBusinessObject());
	...
	{
		String fundFlowOtherIds = request.getParameter("fundFlowOtherIds");
		fundFlowOtherService._deletes(fundFlowOtherIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
fundFlowOther = this.fundFlowOtherService._get(id);        }
        else
        {
           fundFlowOther = this.fundFlowOtherService._get(id);
        }
		...
		request.setAttribute("fundFlowOther", fundFlowOther);  
		return new ModelAndView("xdss3/singleClearOther/fundFlowOtherView");
	}
	...
	{
		// 绑定主对象值
		FundFlowOther fundFlowOther = (FundFlowOther) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), FundFlowOther.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.fundFlowOtherService._saveOrUpdate(fundFlowOther
,getBusinessObject());
}
this.fundFlowOtherService._submitProcess(fundFlowOther		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/singleClearOther/fundFlowOtherManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		FundFlowOther fundFlowOther  = new FundFlowOther();
		String fundflowid = request.getParameter("fundflowid");
		fundFlowOther.setFundflowid(fundflowid);
		LockService.unLockBOData(fundFlowOther);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		FundFlowOther fundFlowOther = (FundFlowOther) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), FundFlowOther.class , true , request.getMethod(), true);
this.fundFlowOtherService._saveOrUpdate(fundFlowOther,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(fundFlowOther.getFundflowid());
		...
		{	
		jo.put("fundflowid", fundFlowOther.getFundflowid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
fundFlowOther = this.fundFlowOtherService._getForEdit(id);        }
        else
        {
           fundFlowOther = this.fundFlowOtherService._getForEdit(id);
        }
		...
		request.setAttribute("fundFlowOther", fundFlowOther);
		return new ModelAndView("xdss3/singleClearOther/fundFlowOtherEdit");
	}
