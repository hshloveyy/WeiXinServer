/*
 * @(#)CustomerDbBankItemControllerGen.java
...
/**
 * <pre>
 * 客户退款银行(CustomerDbBankItem)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class CustomerDbBankItemControllerGen extends AbstractGenController
{
	private final String boName = "CustomerDbBankItem";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("customerDbBankItem",customerDbBankItem);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000303");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/customerDrawback/customerDbBankItemAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		CustomerDbBankItem customerDbBankItem = new CustomerDbBankItem ();
	    customerDbBankItem = (CustomerDbBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerDbBankItem.class , false , request.getMethod(), false);
		request.setAttribute("customerDbBankItem", customerDbBankItem);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000303");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	{
		String refundbankitemid = request.getParameter("refundbankitemid");
		customerDbBankItemService._delete(refundbankitemid,getBusinessObject());
	...
	{
		String customerDbBankItemIds = request.getParameter("customerDbBankItemIds");
		customerDbBankItemService._deletes(customerDbBankItemIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("customerDbBankItem", customerDbBankItem);  
		return new ModelAndView("xdss3/customerDrawback/customerDbBankItemView");
	}
	...
	{
		// 绑定主对象值
		CustomerDbBankItem customerDbBankItem = (CustomerDbBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerDbBankItem.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!StringUtils.isNullBlank(type) && type.equalsIgnoreCase("view"))
{
this.customerDbBankItemService._saveOrUpdate(customerDbBankItem
,getBusinessObject());
}
this.customerDbBankItemService._submitProcess(customerDbBankItem		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/customerDrawback/customerDbBankItemManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		CustomerDbBankItem customerDbBankItem  = new CustomerDbBankItem();
		String refundbankitemid = request.getParameter("refundbankitemid");
		customerDbBankItem.setRefundbankitemid(refundbankitemid);
		LockService.unLockBOData(customerDbBankItem);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		CustomerDbBankItem customerDbBankItem = (CustomerDbBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerDbBankItem.class , true , request.getMethod(), true);
this.customerDbBankItemService._saveOrUpdate(customerDbBankItem,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(customerDbBankItem.getRefundbankitemid());
		...
		{	
		jo.put("refundbankitemid", customerDbBankItem.getRefundbankitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("customerDbBankItem", customerDbBankItem);
		return new ModelAndView("xdss3/customerDrawback/customerDbBankItemEdit");
	}
