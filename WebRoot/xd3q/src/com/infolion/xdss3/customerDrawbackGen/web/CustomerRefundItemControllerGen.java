/*
 * @(#)CustomerRefundItemControllerGen.java
...
/**
 * <pre>
 * 客户退款行项目(CustomerRefundItem)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class CustomerRefundItemControllerGen extends AbstractGenController
{
	private final String boName = "CustomerRefundItem";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("customerRefundItem",customerRefundItem);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000292");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/customerDrawback/customerRefundItemAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		CustomerRefundItem customerRefundItem = new CustomerRefundItem ();
	    customerRefundItem = (CustomerRefundItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerRefundItem.class , false , request.getMethod(), false);
		request.setAttribute("customerRefundItem", customerRefundItem);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000292");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		customerRefundItemService._delete(refundmentitemid,getBusinessObject());
	...
	{
		String customerRefundItemIds = request.getParameter("customerRefundItemIds");
		customerRefundItemService._deletes(customerRefundItemIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("customerRefundItem", customerRefundItem);  
		return new ModelAndView("xdss3/customerDrawback/customerRefundItemView");
	}
	...
	{
		// 绑定主对象值
		CustomerRefundItem customerRefundItem = (CustomerRefundItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerRefundItem.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!StringUtils.isNullBlank(type) && type.equalsIgnoreCase("view"))
{
this.customerRefundItemService._saveOrUpdate(customerRefundItem
,getBusinessObject());
}
this.customerRefundItemService._submitProcess(customerRefundItem		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/customerDrawback/customerRefundItemManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		CustomerRefundItem customerRefundItem  = new CustomerRefundItem();
		String refundmentitemid = request.getParameter("refundmentitemid");
		customerRefundItem.setRefundmentitemid(refundmentitemid);
		LockService.unLockBOData(customerRefundItem);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		CustomerRefundItem customerRefundItem = (CustomerRefundItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), CustomerRefundItem.class , true , request.getMethod(), true);
this.customerRefundItemService._saveOrUpdate(customerRefundItem,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(customerRefundItem.getRefundmentitemid());
		...
		{	
		jo.put("refundmentitemid", customerRefundItem.getRefundmentitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("customerRefundItem", customerRefundItem);
		return new ModelAndView("xdss3/customerDrawback/customerRefundItemEdit");
	}
