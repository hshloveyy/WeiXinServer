 ...
 *  描　述：创建
 */
package com.infolion.xdss3.overCollectGen.web;
 ...
 * @since 1.0
 */
public class OverCollectControllerGen extends AbstractGenController
{
	private final String boName = "OverCollect";
	...
	@Autowired
	protected OverCollectService overCollectService;
	
	public void setOverCollectService(OverCollectService overCollectService)
	{
		this.overCollectService = overCollectService;
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    overCollect = (OverCollect) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), OverCollect.class , false , request.getMethod(), false);
		request.setAttribute("vt", getBusinessObject().getViewText());
		
		request.setAttribute("overCollect", overCollect);  
		return new ModelAndView("xdss3/overCollect/overCollectView");
	}
	...
	{
		// 绑定主对象值
		OverCollect overCollect = (OverCollect) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), OverCollect.class , true , request.getMethod(), true);
this.overCollectService._submitProcess(overCollect		,getBusinessObject());
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/overCollect/overCollectManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		// 绑定主对象值
		OverCollect overCollect  = new OverCollect();
		String overcollectid = request.getParameter("overcollectid");
		overCollect.setOvercollectid(overcollectid);
		LockService.unLockBOData(overCollect);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		OverCollect overCollect = (OverCollect) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), OverCollect.class , true , request.getMethod(), true);
this.overCollectService._saveOrUpdate(overCollect,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(overCollect.getOvercollectid());
		...
		{	
		jo.put("overcollectid", overCollect.getOvercollectid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("overCollect", overCollect);
		return new ModelAndView("xdss3/overCollect/overCollectEdit");
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("overCollect",overCollect);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000270");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/overCollect/overCollectAdd");
	}
	...
	{
		String overcollectid = request.getParameter("overcollectid");
		overCollectService._delete(overcollectid,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{
		String overCollectIds = request.getParameter("overCollectIds");
		overCollectService._deletes(overCollectIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
}