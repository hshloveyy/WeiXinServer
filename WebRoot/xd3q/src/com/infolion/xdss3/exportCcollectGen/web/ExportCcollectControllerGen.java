/*
 * @(#)ExportCcollectControllerGen.java
 ...
 *  描　述：创建
 */
package com.infolion.xdss3.exportCcollectGen.web;
 ...
 * @since 1.0
 */
public class ExportCcollectControllerGen extends AbstractGenController
{
	private final String boName = "ExportCcollect";
	...
	@Autowired
	protected ExportCcollectService exportCcollectService;
	
	public void setExportCcollectService(ExportCcollectService exportCcollectService)
	{
		this.exportCcollectService = exportCcollectService;
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("exportCcollect",exportCcollect);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000268");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/exportCcollect/exportCcollectAdd");
	}
	...
	{
		String id = request.getParameter("exportccollectid");
		ExportCcollect exportCcollect = this.exportCcollectService._getEntityCopy(id);
	...
	{
		String exportccollectid = request.getParameter("exportccollectid");
		exportCcollectService._delete(exportccollectid,getBusinessObject());
	...
	{
		String exportCcollectIds = request.getParameter("exportCcollectIds");
		exportCcollectService._deletes(exportCcollectIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
exportCcollect = this.exportCcollectService._get(id);        }
        else
        {
           exportCcollect = this.exportCcollectService._get(id);
        }
		...
		request.setAttribute("exportCcollect", exportCcollect);  
		return new ModelAndView("xdss3/exportCcollect/exportCcollectView");
	}
	...
	{
		// 绑定主对象值
		ExportCcollect exportCcollect = (ExportCcollect) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ExportCcollect.class , true , request.getMethod(), true);
this.exportCcollectService._submitProcess(exportCcollect		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/exportCcollect/exportCcollectManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		ExportCcollect exportCcollect  = new ExportCcollect();
		String exportccollectid = request.getParameter("exportccollectid");
		exportCcollect.setExportccollectid(exportccollectid);
		LockService.unLockBOData(exportCcollect);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		ExportCcollect exportCcollect = (ExportCcollect) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ExportCcollect.class , true , request.getMethod(), true);
this.exportCcollectService._saveOrUpdate(exportCcollect,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(exportCcollect.getExportccollectid());
		...
		{	
		jo.put("exportccollectid", exportCcollect.getExportccollectid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
exportCcollect = this.exportCcollectService._getForEdit(id);        }
        else
        {
           exportCcollect = this.exportCcollectService._getForEdit(id);
        }
		...
		request.setAttribute("exportCcollect", exportCcollect);
		return new ModelAndView("xdss3/exportCcollect/exportCcollectEdit");
	}
