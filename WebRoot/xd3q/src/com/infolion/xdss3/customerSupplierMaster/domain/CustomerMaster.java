 ...
 */
@Entity
@Table(name = "YCUSTOMERMASTER")
public class CustomerMaster extends BaseObject {
	...
	private String createor;
	 @Column(name="GUESTID")
	 @ValidateRule(dataType=9,label="旧的主客户的ID",maxLength= 40,required=false) 
	private String guestId; //旧的主客户的ID
	...
	/** minimal constructor */
	public CustomerMaster(String customerId) {
		this.customerId = customerId;
	}

	/** full constructor */
//	public CustomerMaster(String customerId, String accountGroup, String companyCode,
...
//	}
	...
	// Property accessors
	@Id
	@Column(name = "CUSTOMERMASTER_ID", unique = true, nullable = false, length = 36)
