/*
 * @(#)PrivOtheChanRecoControllerGen.java
 ...
 * @since 1.0
 */
public class PrivOtheChanRecoControllerGen extends AbstractGenController
{
	private final String boName = "PrivOtheChanReco";
	...
	@Autowired
	protected PrivOtheChanRecoService privOtheChanRecoService;
	
	public void setPrivOtheChanRecoService(PrivOtheChanRecoService privOtheChanRecoService)
	{
		this.privOtheChanRecoService = privOtheChanRecoService;
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("privOtheChanReco",privOtheChanReco);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000273");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/ceditValueControl/privOtheChanRecoAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		PrivOtheChanReco privOtheChanReco = this.privOtheChanRecoService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		privOtheChanRecoService._delete(changeid,getBusinessObject());
	...
	{
		String privOtheChanRecoIds = request.getParameter("privOtheChanRecoIds");
		privOtheChanRecoService._deletes(privOtheChanRecoIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
privOtheChanReco = this.privOtheChanRecoService._get(id);        }
        else
        {
           privOtheChanReco = this.privOtheChanRecoService._get(id);
        }
		...
		request.setAttribute("privOtheChanReco", privOtheChanReco);  
		return new ModelAndView("xdss3/ceditValueControl/privOtheChanRecoView");
	}
	...
	{
		// 绑定主对象值
		PrivOtheChanReco privOtheChanReco = (PrivOtheChanReco) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), PrivOtheChanReco.class , true , request.getMethod(), true);
this.privOtheChanRecoService._submitProcess(privOtheChanReco		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		...
		return new ModelAndView("xdss3/ceditValueControl/privOtheChanRecoManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		PrivOtheChanReco privOtheChanReco  = new PrivOtheChanReco();
		String changeid = request.getParameter("changeid");
		privOtheChanReco.setChangeid(changeid);
		LockService.unLockBOData(privOtheChanReco);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		PrivOtheChanReco privOtheChanReco = (PrivOtheChanReco) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), PrivOtheChanReco.class , true , request.getMethod(), true);
this.privOtheChanRecoService._saveOrUpdate(privOtheChanReco,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(privOtheChanReco.getChangeid());
		...
		{	
		jo.put("changeid", privOtheChanReco.getChangeid());
String creator = privOtheChanReco.getCreator();
...
jo.put("createtime", privOtheChanReco.getCreatetime());
String lastmodifyer = privOtheChanReco.getLastmodifyer();
...
jo.put("lastmodifytime", privOtheChanReco.getLastmodifytime());		this.operateSuccessfullyWithString(response,jo.toString());
	   }
	}
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
privOtheChanReco = this.privOtheChanRecoService._getForEdit(id);        }
        else
        {
           privOtheChanReco = this.privOtheChanRecoService._getForEdit(id);
        }
		...
		request.setAttribute("privOtheChanReco", privOtheChanReco);
		return new ModelAndView("xdss3/ceditValueControl/privOtheChanRecoEdit");
	}
