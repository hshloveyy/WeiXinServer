/*
 * @(#)HomePaymentRelatControllerGen.java
 ...
 * @since 1.0
 */
public class HomePaymentRelatControllerGen extends AbstractGenController
{
	private final String boName = "HomePaymentRelat";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homePaymentRelat",homePaymentRelat);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000333");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/payment/homePaymentRelatAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		HomePaymentRelat homePaymentRelat = new HomePaymentRelat ();
	    homePaymentRelat = (HomePaymentRelat) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentRelat.class , false , request.getMethod(), false);
		request.setAttribute("homePaymentRelat", homePaymentRelat);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000333");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		homePaymentRelatService._delete(relatedpaymentid,getBusinessObject());
	...
	{
		String homePaymentRelatIds = request.getParameter("homePaymentRelatIds");
		homePaymentRelatService._deletes(homePaymentRelatIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homePaymentRelat", homePaymentRelat);  
		return new ModelAndView("xdss3/payment/homePaymentRelatView");
	}
	...
	{
		// 绑定主对象值
		HomePaymentRelat homePaymentRelat = (HomePaymentRelat) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentRelat.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.homePaymentRelatService._saveOrUpdate(homePaymentRelat
,getBusinessObject());
}
this.homePaymentRelatService._submitProcess(homePaymentRelat		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/payment/homePaymentRelatManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomePaymentRelat homePaymentRelat  = new HomePaymentRelat();
		String relatedpaymentid = request.getParameter("relatedpaymentid");
		homePaymentRelat.setRelatedpaymentid(relatedpaymentid);
		LockService.unLockBOData(homePaymentRelat);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		HomePaymentRelat homePaymentRelat = (HomePaymentRelat) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentRelat.class , true , request.getMethod(), true);
this.homePaymentRelatService._saveOrUpdate(homePaymentRelat,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(homePaymentRelat.getRelatedpaymentid());
		...
		{	
		jo.put("relatedpaymentid", homePaymentRelat.getRelatedpaymentid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("homePaymentRelat", homePaymentRelat);
		return new ModelAndView("xdss3/payment/homePaymentRelatEdit");
	}
