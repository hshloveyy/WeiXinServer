/*
 * @(#)HomeCreditRebankControllerGen.java
 ...
 * @since 1.0
 */
public class HomeCreditRebankControllerGen extends AbstractGenController
{
	private final String boName = "HomeCreditRebank";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homeCreditRebank",homeCreditRebank);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000375");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/payment/homeCreditRebankAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomeCreditRebank homeCreditRebank = this.homeCreditRebankService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		homeCreditRebankService._delete(bankitemid,getBusinessObject());
	...
	{
		String homeCreditRebankIds = request.getParameter("homeCreditRebankIds");
		homeCreditRebankService._deletes(homeCreditRebankIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
homeCreditRebank = this.homeCreditRebankService._get(id);        }
        else
        {
           homeCreditRebank = this.homeCreditRebankService._get(id);
        }
		...
		request.setAttribute("homeCreditRebank", homeCreditRebank);  
		return new ModelAndView("xdss3/payment/homeCreditRebankView");
	}
	...
	{
		// 绑定主对象值
		HomeCreditRebank homeCreditRebank = (HomeCreditRebank) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeCreditRebank.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.homeCreditRebankService._saveOrUpdate(homeCreditRebank
,getBusinessObject());
}
this.homeCreditRebankService._submitProcess(homeCreditRebank		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/payment/homeCreditRebankManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomeCreditRebank homeCreditRebank  = new HomeCreditRebank();
		String bankitemid = request.getParameter("bankitemid");
		homeCreditRebank.setBankitemid(bankitemid);
		LockService.unLockBOData(homeCreditRebank);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		HomeCreditRebank homeCreditRebank = (HomeCreditRebank) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeCreditRebank.class , true , request.getMethod(), true);
this.homeCreditRebankService._saveOrUpdate(homeCreditRebank,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(homeCreditRebank.getBankitemid());
		...
		{	
		jo.put("bankitemid", homeCreditRebank.getBankitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
homeCreditRebank = this.homeCreditRebankService._getForEdit(id);        }
        else
        {
           homeCreditRebank = this.homeCreditRebankService._getForEdit(id);
        }
		...
		request.setAttribute("homeCreditRebank", homeCreditRebank);
		return new ModelAndView("xdss3/payment/homeCreditRebankEdit");
	}
