/*
 * @(#)HomeDocuBankItemControllerGen.java
...
/**
 * <pre>
 * 押汇/海外代付银行(HomeDocuBankItem)控制器类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 * @since 1.0
 */
public class HomeDocuBankItemControllerGen extends AbstractGenController
{
	private final String boName = "HomeDocuBankItem";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homeDocuBankItem",homeDocuBankItem);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000334");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/payment/homeDocuBankItemAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		HomeDocuBankItem homeDocuBankItem = new HomeDocuBankItem ();
	    homeDocuBankItem = (HomeDocuBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeDocuBankItem.class , false , request.getMethod(), false);
		request.setAttribute("homeDocuBankItem", homeDocuBankItem);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000334");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		homeDocuBankItemService._delete(docuaryitemid,getBusinessObject());
	...
	{
		String homeDocuBankItemIds = request.getParameter("homeDocuBankItemIds");
		homeDocuBankItemService._deletes(homeDocuBankItemIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homeDocuBankItem", homeDocuBankItem);  
		return new ModelAndView("xdss3/payment/homeDocuBankItemView");
	}
	...
	{
		// 绑定主对象值
		HomeDocuBankItem homeDocuBankItem = (HomeDocuBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeDocuBankItem.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.homeDocuBankItemService._saveOrUpdate(homeDocuBankItem
,getBusinessObject());
}
this.homeDocuBankItemService._submitProcess(homeDocuBankItem		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/payment/homeDocuBankItemManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomeDocuBankItem homeDocuBankItem  = new HomeDocuBankItem();
		String docuaryitemid = request.getParameter("docuaryitemid");
		homeDocuBankItem.setDocuaryitemid(docuaryitemid);
		LockService.unLockBOData(homeDocuBankItem);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		HomeDocuBankItem homeDocuBankItem = (HomeDocuBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeDocuBankItem.class , true , request.getMethod(), true);
this.homeDocuBankItemService._saveOrUpdate(homeDocuBankItem,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(homeDocuBankItem.getDocuaryitemid());
		...
		{	
		jo.put("docuaryitemid", homeDocuBankItem.getDocuaryitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("homeDocuBankItem", homeDocuBankItem);
		return new ModelAndView("xdss3/payment/homeDocuBankItemEdit");
	}
