/*
 * @(#)HomeCreditDocuBankControllerGen.java
 ...
 * @since 1.0
 */
public class HomeCreditDocuBankControllerGen extends AbstractGenController
{
	private final String boName = "HomeCreditDocuBank";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homeCreditDocuBank",homeCreditDocuBank);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000374");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/payment/homeCreditDocuBankAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("docuaryitemid");
		HomeCreditDocuBank homeCreditDocuBank = this.homeCreditDocuBankService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		homeCreditDocuBankService._delete(docuaryitemid,getBusinessObject());
	...
	{
		String homeCreditDocuBankIds = request.getParameter("homeCreditDocuBankIds");
		homeCreditDocuBankService._deletes(homeCreditDocuBankIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
homeCreditDocuBank = this.homeCreditDocuBankService._get(id);        }
        else
        {
           homeCreditDocuBank = this.homeCreditDocuBankService._get(id);
        }
		...
		request.setAttribute("homeCreditDocuBank", homeCreditDocuBank);  
		return new ModelAndView("xdss3/payment/homeCreditDocuBankView");
	}
	...
	{
		// 绑定主对象值
		HomeCreditDocuBank homeCreditDocuBank = (HomeCreditDocuBank) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeCreditDocuBank.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.homeCreditDocuBankService._saveOrUpdate(homeCreditDocuBank
,getBusinessObject());
}
this.homeCreditDocuBankService._submitProcess(homeCreditDocuBank		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/payment/homeCreditDocuBankManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomeCreditDocuBank homeCreditDocuBank  = new HomeCreditDocuBank();
		String docuaryitemid = request.getParameter("docuaryitemid");
		homeCreditDocuBank.setDocuaryitemid(docuaryitemid);
		LockService.unLockBOData(homeCreditDocuBank);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		HomeCreditDocuBank homeCreditDocuBank = (HomeCreditDocuBank) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomeCreditDocuBank.class , true , request.getMethod(), true);
this.homeCreditDocuBankService._saveOrUpdate(homeCreditDocuBank,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(homeCreditDocuBank.getDocuaryitemid());
		...
		{	
		jo.put("docuaryitemid", homeCreditDocuBank.getDocuaryitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
homeCreditDocuBank = this.homeCreditDocuBankService._getForEdit(id);        }
        else
        {
           homeCreditDocuBank = this.homeCreditDocuBankService._getForEdit(id);
        }
		...
		request.setAttribute("homeCreditDocuBank", homeCreditDocuBank);
		return new ModelAndView("xdss3/payment/homeCreditDocuBankEdit");
	}
