/*
 * @(#)HomePaymentCbillControllerGen.java
 ...
 * @since 1.0
 */
public class HomePaymentCbillControllerGen extends AbstractGenController
{
	private final String boName = "HomePaymentCbill";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homePaymentCbill",homePaymentCbill);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000317");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/payment/homePaymentCbillAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		HomePaymentCbill homePaymentCbill = new HomePaymentCbill ();
	    homePaymentCbill = (HomePaymentCbill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentCbill.class , false , request.getMethod(), false);
		request.setAttribute("homePaymentCbill", homePaymentCbill);
		request.setAttribute("vt", getBusinessObject().getViewText());
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000317");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		homePaymentCbillService._delete(paymentcbillid,getBusinessObject());
	...
	{
		String homePaymentCbillIds = request.getParameter("homePaymentCbillIds");
		homePaymentCbillService._deletes(homePaymentCbillIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("homePaymentCbill", homePaymentCbill);  
		return new ModelAndView("xdss3/payment/homePaymentCbillView");
	}
	...
	{
		// 绑定主对象值
		HomePaymentCbill homePaymentCbill = (HomePaymentCbill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentCbill.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.homePaymentCbillService._saveOrUpdate(homePaymentCbill
,getBusinessObject());
}
this.homePaymentCbillService._submitProcess(homePaymentCbill		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/payment/homePaymentCbillManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		HomePaymentCbill homePaymentCbill  = new HomePaymentCbill();
		String paymentcbillid = request.getParameter("paymentcbillid");
		homePaymentCbill.setPaymentcbillid(paymentcbillid);
		LockService.unLockBOData(homePaymentCbill);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		HomePaymentCbill homePaymentCbill = (HomePaymentCbill) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), HomePaymentCbill.class , true , request.getMethod(), true);
this.homePaymentCbillService._saveOrUpdate(homePaymentCbill,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(homePaymentCbill.getPaymentcbillid());
		...
		{	
		jo.put("paymentcbillid", homePaymentCbill.getPaymentcbillid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("homePaymentCbill", homePaymentCbill);
		return new ModelAndView("xdss3/payment/homePaymentCbillEdit");
	}
