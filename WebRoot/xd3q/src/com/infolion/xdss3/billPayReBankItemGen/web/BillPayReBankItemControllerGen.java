/*
 * @(#)BillPayReBankItemControllerGen.java
 ...
 *  描　述：创建
 */
package com.infolion.xdss3.billPayReBankItemGen.web;
 ...
 * @since 1.0
 */
public class BillPayReBankItemControllerGen extends AbstractGenController
{
	private final String boName = "BillPayReBankItem";
	...
	public void setBillPayReBankItemService(BillPayReBankItemService billPayReBankItemService)
	{
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("billPayReBankItem",billPayReBankItem);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000369");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/billPayReBankItem/billPayReBankItemAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("bankitemid");
		BillPayReBankItem billPayReBankItem = this.billPayReBankItemService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		billPayReBankItemService._delete(bankitemid,getBusinessObject());
	...
	{
		String billPayReBankItemIds = request.getParameter("billPayReBankItemIds");
		billPayReBankItemService._deletes(billPayReBankItemIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
billPayReBankItem = this.billPayReBankItemService._get(id);        }
        else
        {
           billPayReBankItem = this.billPayReBankItemService._get(id);
        }
		...
		request.setAttribute("billPayReBankItem", billPayReBankItem);  
		return new ModelAndView("xdss3/billPayReBankItem/billPayReBankItemView");
	}
	...
	{
		// 绑定主对象值
		BillPayReBankItem billPayReBankItem = (BillPayReBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), BillPayReBankItem.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.billPayReBankItemService._saveOrUpdate(billPayReBankItem
,getBusinessObject());
}
this.billPayReBankItemService._submitProcess(billPayReBankItem		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/billPayReBankItem/billPayReBankItemManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		BillPayReBankItem billPayReBankItem  = new BillPayReBankItem();
		String bankitemid = request.getParameter("bankitemid");
		billPayReBankItem.setBankitemid(bankitemid);
		LockService.unLockBOData(billPayReBankItem);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		BillPayReBankItem billPayReBankItem = (BillPayReBankItem) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), BillPayReBankItem.class , true , request.getMethod(), true);
this.billPayReBankItemService._saveOrUpdate(billPayReBankItem,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(billPayReBankItem.getBankitemid());
		...
		{	
		jo.put("bankitemid", billPayReBankItem.getBankitemid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
billPayReBankItem = this.billPayReBankItemService._getForEdit(id);        }
        else
        {
           billPayReBankItem = this.billPayReBankItemService._getForEdit(id);
        }
		...
		request.setAttribute("billPayReBankItem", billPayReBankItem);
		return new ModelAndView("xdss3/billPayReBankItem/billPayReBankItemEdit");
	}
