 ...
 * @since 1.0
 */
public class CommonDataAuthSql implements AuthSql
{
	private static Log log = LogFactory.getFactory().getLog(CommonDataAuthSql.class);
	/**
	 * 取得数据权限SQL语句
	 * 
	 ...
	 * @return
	 */
	public String getAuthSql(BusinessObject businessObject)
	{
		String strWhereSql = "";
