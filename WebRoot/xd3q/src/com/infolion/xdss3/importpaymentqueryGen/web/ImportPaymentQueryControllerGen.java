/*
 * @(#)ImportPaymentQueryControllerGen.java
 ...
 *  描　述：创建
 */
package com.infolion.xdss3.importpaymentqueryGen.web;
 ...
 * @since 1.0
 */
public class ImportPaymentQueryControllerGen extends AbstractGenController
{
	private final String boName = "ImportPaymentQuery";
	...
	@Autowired
	protected ImportPaymentQueryService importPaymentQueryService;
	
	public void setImportPaymentQueryService(ImportPaymentQueryService importPaymentQueryService)
	{
		this.importPaymentQueryService = importPaymentQueryService;
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("importPaymentQuery",importPaymentQuery);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000344");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/importpaymentquery/importPaymentQueryAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		ImportPaymentQuery importPaymentQuery = this.importPaymentQueryService._getEntityCopy(id);
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		importPaymentQueryService._delete(paymentid,getBusinessObject());
	...
	{
		String importPaymentQueryIds = request.getParameter("importPaymentQueryIds");
		importPaymentQueryService._deletes(importPaymentQueryIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
importPaymentQuery = this.importPaymentQueryService._get(id);        }
        else
        {
           importPaymentQuery = this.importPaymentQueryService._get(id);
        }
		...
		request.setAttribute("importPaymentQuery", importPaymentQuery);  
		return new ModelAndView("xdss3/importpaymentquery/importPaymentQueryView");
	}
	...
	{
		// 绑定主对象值
		ImportPaymentQuery importPaymentQuery = (ImportPaymentQuery) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ImportPaymentQuery.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.importPaymentQueryService._saveOrUpdate(importPaymentQuery
,getBusinessObject());
}
this.importPaymentQueryService._submitProcess(importPaymentQuery		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		ImportPaymentQuery importPaymentQuery  = new ImportPaymentQuery();
		String paymentid = request.getParameter("paymentid");
		importPaymentQuery.setPaymentid(paymentid);
		LockService.unLockBOData(importPaymentQuery);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		ImportPaymentQuery importPaymentQuery = (ImportPaymentQuery) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ImportPaymentQuery.class , true , request.getMethod(), true);
this.importPaymentQueryService._saveOrUpdate(importPaymentQuery,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(importPaymentQuery.getPaymentid());
		...
		{	
		jo.put("paymentid", importPaymentQuery.getPaymentid());
String creator = importPaymentQuery.getCreator();
...
jo.put("createtime", importPaymentQuery.getCreatetime());
String lastmodifyer = importPaymentQuery.getLastmodifyer();
...
jo.put("lastmodifytime", importPaymentQuery.getLastmodifytime());		this.operateSuccessfullyWithString(response,jo.toString());
	   }
	}
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
importPaymentQuery = this.importPaymentQueryService._getForEdit(id);        }
        else
        {
           importPaymentQuery = this.importPaymentQueryService._getForEdit(id);
        }
		...
		request.setAttribute("importPaymentQuery", importPaymentQuery);
		return new ModelAndView("xdss3/importpaymentquery/importPaymentQueryEdit");
	}
