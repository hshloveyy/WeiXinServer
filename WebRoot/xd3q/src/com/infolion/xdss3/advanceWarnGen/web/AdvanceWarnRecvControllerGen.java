/*
 * @(#)AdvanceWarnRecvControllerGen.java
 ...
 * @since 1.0
 */
public class AdvanceWarnRecvControllerGen extends AbstractGenController
{
	private final String boName = "AdvanceWarnRecv";
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("advanceWarnRecv",advanceWarnRecv);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000246");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/advanceWarn/advanceWarnRecvAdd");
	}
	...
	{
		AdvanceWarnRecv advanceWarnRecv = new AdvanceWarnRecv ();
	    advanceWarnRecv = (AdvanceWarnRecv) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AdvanceWarnRecv.class , false , request.getMethod(), false);
		request.setAttribute("advanceWarnRecv", advanceWarnRecv);
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/advanceWarn/advanceWarnRecvAdd");
	}
	...
	public void _delete(HttpServletRequest request, HttpServletResponse response)
	{
		...
		advanceWarnRecvService._delete(receiveid,getBusinessObject());
	...
	{
		String advanceWarnRecvIds = request.getParameter("advanceWarnRecvIds");
		advanceWarnRecvService._deletes(advanceWarnRecvIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("advanceWarnRecv", advanceWarnRecv);  
		return new ModelAndView("xdss3/advanceWarn/advanceWarnRecvView");
	}
	...
	{
		// 绑定主对象值
		AdvanceWarnRecv advanceWarnRecv = (AdvanceWarnRecv) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AdvanceWarnRecv.class , true , request.getMethod(), true);
this.advanceWarnRecvService._submitProcess(advanceWarnRecv		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/advanceWarn/advanceWarnRecvManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		AdvanceWarnRecv advanceWarnRecv  = new AdvanceWarnRecv();
		String receiveid = request.getParameter("receiveid");
		advanceWarnRecv.setReceiveid(receiveid);
		LockService.unLockBOData(advanceWarnRecv);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		AdvanceWarnRecv advanceWarnRecv = (AdvanceWarnRecv) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AdvanceWarnRecv.class , true , request.getMethod(), true);
this.advanceWarnRecvService._saveOrUpdate(advanceWarnRecv,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(advanceWarnRecv.getReceiveid());
		...
		{	
		jo.put("receiveid", advanceWarnRecv.getReceiveid());
String creator = advanceWarnRecv.getCreator();
...
jo.put("createtime", advanceWarnRecv.getCreatetime());
String lastmodifyer = advanceWarnRecv.getLastmodifyer();
...
jo.put("lastmodifytime", advanceWarnRecv.getLastmodifytime());		this.operateSuccessfullyWithString(response,jo.toString());
	   }
	}
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("advanceWarnRecv", advanceWarnRecv);
		return new ModelAndView("xdss3/advanceWarn/advanceWarnRecvEdit");
	}
