/*
 * @(#)ImpDeclarationControllerGen.java
 ...
 *  描　述：创建
 */
package com.infolion.xdss3.declarationGen.web;
 ...
 * @since 1.0
 */
public class ImpDeclarationControllerGen extends AbstractGenController
{
	private final String boName = "ImpDeclaration";
	...
	@Autowired
	protected ImpDeclarationService impDeclarationService;
	
	public void setImpDeclarationService(ImpDeclarationService impDeclarationService)
	{
		this.impDeclarationService = impDeclarationService;
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("impDeclaration",impDeclaration);
      	boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000357");
		request.setAttribute("haveBindWorkFlow", haveBindWorkFlow);
		request.setAttribute("workflowTaskId", workflowTaskId);	
		request.setAttribute("workflowNodeDefId", workflowNodeDefId);
	    return new ModelAndView("xdss3/declaration/impDeclarationAdd");
	}
	...
	public ModelAndView _copyCreate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNotBlank(calActivityId))
			request.setAttribute("calActivityId", calActivityId);
		String id = request.getParameter("declarationsid");
		ImpDeclaration impDeclaration = this.impDeclarationService._getEntityCopy(id);
	...
	{
		String declarationsid = request.getParameter("declarationsid");
		impDeclarationService._delete(declarationsid,getBusinessObject());
	...
	{
		String impDeclarationIds = request.getParameter("impDeclarationIds");
		impDeclarationService._deletes(impDeclarationIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
impDeclaration = this.impDeclarationService._get(id);        }
        else
        {
           impDeclaration = this.impDeclarationService._get(id);
        }
		...
		request.setAttribute("impDeclaration", impDeclaration);  
		return new ModelAndView("xdss3/declaration/impDeclarationView");
	}
	...
	{
		// 绑定主对象值
		ImpDeclaration impDeclaration = (ImpDeclaration) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ImpDeclaration.class , true , request.getMethod(), true);
        //类型标识是从那个页面提交，view 表示从view页面提交流程。
        String type = request.getParameter("type");
if (!"view".equalsIgnoreCase(type))
{
this.impDeclarationService._saveOrUpdate(impDeclaration
,getBusinessObject());
}
this.impDeclarationService._submitProcess(impDeclaration		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("xdss3/declaration/impDeclarationManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		ImpDeclaration impDeclaration  = new ImpDeclaration();
		String declarationsid = request.getParameter("declarationsid");
		impDeclaration.setDeclarationsid(declarationsid);
		LockService.unLockBOData(impDeclaration);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		ImpDeclaration impDeclaration = (ImpDeclaration) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), ImpDeclaration.class , true , request.getMethod(), true);
this.impDeclarationService._saveOrUpdate(impDeclaration,getBusinessObject());
		...
		if (StringUtils.isNotBlank(calActivityId))
		{
			...
			if (calActivity != null)
			{
				...
				calActivity.setBusid(impDeclaration.getDeclarationsid());
		...
		{	
		jo.put("declarationsid", impDeclaration.getDeclarationsid());
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (StringUtils.isNullBlank(id))
		{	
impDeclaration = this.impDeclarationService._getForEdit(id);        }
        else
        {
           impDeclaration = this.impDeclarationService._getForEdit(id);
        }
		...
		request.setAttribute("impDeclaration", impDeclaration);
		return new ModelAndView("xdss3/declaration/impDeclarationEdit");
	}
