/*
 * @(#)BudgetOrganizationAdvanceService.java
 ...
 *  描　述：创建
 */
package com.infolion.XDSS.budget.maindata.BudgetOrganization.exservice;
 ...
 */
@Service
public class BudgetOrganizationAdvanceService implements AdvanceService
{
