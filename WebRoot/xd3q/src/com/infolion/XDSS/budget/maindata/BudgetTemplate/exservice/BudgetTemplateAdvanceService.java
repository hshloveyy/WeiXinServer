/*
 * @(#)BudgetTemplateAdvanceService.java
 ...
 *  描　述：创建
 */
package com.infolion.XDSS.budget.maindata.BudgetTemplate.exservice;
 ...
 */
@Service
public class BudgetTemplateAdvanceService implements AdvanceService
{
