 ...
 */
@Embeddable 
public class ExpiredShippingKey implements java.io.Serializable 
{
	/*
	 * 客户端
	 */
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		ExpiredShippingKey other = (ExpiredShippingKey) obj;
		if (client == null)
		{
	 ...
	 * @param vbeln
	 */
	public ExpiredShippingKey(String client, String posnr, String vbeln)
	{
		super();
		this.client = client;
		this.posnr = posnr;
