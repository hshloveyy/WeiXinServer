 ...
 * @since 1.0
 */
public class AuthInfoControllerGen extends AbstractGenController
{
	private final String boName = "AuthInfo";
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    authInfo = (AuthInfo) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AuthInfo.class , false, request.getMethod(), false);
		request.setAttribute("vt", getBusinessObject().getViewText());
		request.setAttribute("authInfo", authInfo);
		return new ModelAndView("sample/auth/authInfoEdit");
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    return new ModelAndView("sample/auth/authInfoAdd");
	}
	...
	{
		String authInfoIds = request.getParameter("authInfoIds");
		authInfoService._deletes(authInfoIds,getBusinessObject());
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
		...
		request.setAttribute("authInfo", authInfo);  
		return new ModelAndView("sample/auth/authInfoView");
	}
	...
	{
		// 绑定主对象值
		AuthInfo authInfo = (AuthInfo) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AuthInfo.class , true , request.getMethod(), true);
this.authInfoService._submitProcess(authInfo		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("sample/auth/authInfoManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		authInfo.setAuthinfoid(authinfoid);
		LockService.unLockBOData(authInfo);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		AuthInfo authInfo = (AuthInfo) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), AuthInfo.class , true , request.getMethod(), true);
this.authInfoService._saveOrUpdate(authInfo,getBusinessObject());
		jo.put("authinfoid", authInfo.getAuthinfoid());
	...
	{
		String authinfoid = request.getParameter("authinfoid");
		authInfoService._delete(authinfoid,getBusinessObject());
		this.operateSuccessfully(response);
	}
}