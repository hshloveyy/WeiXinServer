 ...
 *  描　述：创建
 */
package com.infolion.sample.b1.ordrGen.web;
 ...
 * @since 1.0
 */
public class OrdrRepControllerGen extends AbstractGenController
{
	private final String boName = "OrdrRep";
	...
	@Autowired
	protected OrdrRepService ordrRepService;
	
	public void setOrdrRepService(OrdrRepService ordrRepService)
	{
		this.ordrRepService = ordrRepService;
	}
	...
	public ModelAndView _edit(HttpServletRequest request, HttpServletResponse response)
	{
		...
		String id = request.getParameter("docentry");
		String workflowTaskId = request.getParameter("workflowTaskId");
		String businessId = request.getParameter("businessId");	
		if (null == id)
			id = businessId ;
		ordrRep = this.ordrRepService._getForEdit(id);
		boolean haveBindWorkFlow = WorkflowService.getHaveBindWorkFlow("000000000215");
		...
		request.setAttribute("ordrRep", ordrRep);
		return new ModelAndView("sample/b1/ordr/ordrRepEdit");
	}
	...
	public ModelAndView _create(HttpServletRequest request, HttpServletResponse response)
	{
	    ...
	    return new ModelAndView("sample/b1/ordr/ordrRepAdd");
	}
	...
	{
		String id = request.getParameter("docentry");
		OrdrRep ordrRep = this.ordrRepService._getEntityCopy(id);
	...
	{
		String docentry = request.getParameter("docentry");
		ordrRepService._delete(docentry,getBusinessObject());
	...
	{
		String ordrRepIds = request.getParameter("ordrRepIds");
		ordrRepService._deletes(ordrRepIds,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	public ModelAndView _view(HttpServletRequest request, HttpServletResponse response)
	{
        ...
        {	
		   ordrRep = this.ordrRepService._get(id);
	}
        else
        {
           ordrRep = this.ordrRepService._get(id);
		...
		request.setAttribute("ordrRep", ordrRep);  
		return new ModelAndView("sample/b1/ordr/ordrRepView");
	}
	...
	{
		// 绑定主对象值
		OrdrRep ordrRep = (OrdrRep) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), OrdrRep.class , true , request.getMethod(), true);
this.ordrRepService._submitProcess(ordrRep		,getBusinessObject());
		this.operateSuccessfully(response);
	}
	...
	{ 
		request.setAttribute("vt", getBusinessObject().getViewText());
		return new ModelAndView("sample/b1/ordr/ordrRepManage");
	}
	...
	public void _cancel(HttpServletRequest request, HttpServletResponse response)
	{
		...
		OrdrRep ordrRep  = new OrdrRep();
		String docentry = request.getParameter("docentry");
		ordrRep.setDocentry(docentry);
		LockService.unLockBOData(ordrRep);
	...
	public void _saveOrUpdate(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 绑定主对象值
		OrdrRep ordrRep = (OrdrRep) ExBeanUtils.bindBusinessObjectData(request.getParameterMap(), OrdrRep.class , true , request.getMethod(), true);
this.ordrRepService._saveOrUpdate(ordrRep,getBusinessObject());
		jo.put("docentry", ordrRep.getDocentry());
