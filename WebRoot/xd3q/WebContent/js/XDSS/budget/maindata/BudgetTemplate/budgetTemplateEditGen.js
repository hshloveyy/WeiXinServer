/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象预算模版(BudgetTemplate)编辑页面JS文件
 */
 ...
 * 保存 
 */
function _saveOrUpdateBudgetTemplate()
{
if(_presaveOrUpdateBudgetTemplate()){
   ...
   _postsaveOrUpdateBudgetTemplate();
}
...
function customCallBackHandle(transport)
{
	...
	//document.getElementById("BudgetTemplate.budtemid").value = id;
 ...
 * 取消
 */
function _cancelBudgetTemplate()
{
  if(_precancelBudgetTemplate()){
	new AjaxEngine(contextPath + '/XDSS/budget/maindata/BudgetTemplate/budgetTemplateController.spr?action=_cancel&budtemid='+budtemid, 
			   {method:"post", parameters: '', onComplete: callBackHandle,callback:_cancelBudgetTemplateCallBack});
   }
   _postcancelBudgetTemplate();
}
function _cancelBudgetTemplateCallBack()
{
