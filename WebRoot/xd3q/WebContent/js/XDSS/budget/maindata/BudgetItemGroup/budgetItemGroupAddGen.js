/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象预算项分组(BudgetItemGroup)增加页面JS文件
 */
...
{
	//if(isCreateCopy){
	//	document.getElementById("BudgetItemGroup.budgroupid").value = "";
	//}
	if(_presave()){
		...
		if(isCreateCopy)
		{
			param = param + ""+ getAllBudgetItemGridData();
		}
		else
		{
...
function customCallBackHandle(transport)
{
	...
	document.getElementById("BudgetItemGroup.budgroupid").value = budgroupid;
