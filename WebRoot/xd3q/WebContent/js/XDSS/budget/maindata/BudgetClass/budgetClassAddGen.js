/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象预算分类(BudgetClass)增加页面JS文件
 */
 ...
 *批量删除
 */
function _deletesBudgetTemplate()
{
}
...
{
	//if(isCreateCopy){
	//	document.getElementById("BudgetClass.budclassid").value = "";
	//}
	if(_presave()){
		...
		else
		{
			param = param + ""+ getBudgetTemplateGridData(); 
			        		    ...
			        		    new AjaxEngine(contextPath + '/XDSS/budget/maindata/BudgetClass/budgetClassController.spr?action=_saveOrUpdate', 
...
function customCallBackHandle(transport)
{
	...
	var budclassid=result.budclassid;
	document.getElementById("BudgetClass.budclassid").value = budclassid;
	document.getElementById("BudgetClass.creator_text").value = result.creator_text;
	document.getElementById("BudgetClass.creator").value = result.creator;
	document.getElementById("BudgetClass.createtime").value = result.createtime;
	document.getElementById("BudgetClass.lastmodifyer_text").value = result.lastmodifyer_text;
	document.getElementById("BudgetClass.lastmodifyer").value = result.lastmodifyer;
	document.getElementById("BudgetClass.lastmodifytime").value = result.lastmodifytime;
	isCreateCopy = false;	
