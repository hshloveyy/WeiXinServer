/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象部门预算编制(DeptBudgetting)查看页面JS文件
 */


function _viewSummaryDeptBudgetting(){
	_getMainFrame().maintabs.addPanel(Txt.deptBudgetting_CopyCreate,'',contextPath + '/XDSS/sample/deptBudgetting/deptBudgettingController.spr?action=_viewSummary&deptbudgettingid='+deptbudgettingid);
}
 ...
 * 提交
 */
function _submitProcessDeptBudgetting(id)
{
