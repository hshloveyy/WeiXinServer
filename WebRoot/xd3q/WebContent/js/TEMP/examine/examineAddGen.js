...
{
	//if(isCreateCopy){
	//	document.getElementById("Examine.vi").value = "";
	//}
	if(_presave()){
		...
		if(isCreateCopy)
		{
			param = param + ""+ getAllExamineItemGridData();
		}
		else
		{
		...
		if(isCreateCopy)
		{
			param = param + ""+ getAllExamineUserGridData();
		}
		else
		{
...
function customCallBackHandle(transport)
{
	...
	var vi=result.vi;
	document.getElementById("Examine.vi").value = vi;
	isCreateCopy = false;	
