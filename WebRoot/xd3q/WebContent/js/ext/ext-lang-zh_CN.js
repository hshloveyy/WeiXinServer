...
if (Ext.PagingToolbar) {
	Ext.apply(Ext.PagingToolbar.prototype, {
				...
				lastText : "最后页",
				refreshText : "刷新",
				displayMsg : "显示数据 {0} - {1}，共 {2} 条",
				emptyMsg : '没有数据需要显示'
			});
}

if (Ext.form.SearchHelpField) {
	Ext.apply(Ext.form.SearchHelpField.prototype, {
		about : "搜索帮助业务控件\n"
				+ "(c) 2009 Fujian Fujitsu. 福富软件 版权所有 \n Author: 黄虎. Mail: huanghu@ffcs.cn \n"
				+ "\n\n" + "数据选择:\n" + "- 点击【查询】按钮得到查询条件数据\n"
				+ "- 点击【清空】按钮清空查询条件数据\n" + "- 双击表格行选中数据,并返回数据.",
		txtQuery : '查询',
		txtClean : '清空',
...
if (Ext.PrintButton) {
	Ext.apply(Ext.PrintButton.prototype, {
				txtPrint : "打印"
			});
	Ext.PrintButton.txtSelectPrntTemp = "选择打印模板";
	Ext.PrintButton.txtExcelTempNotAppoint = "所选择的业务对象未指定Excel模板！";
}
