...
function _export()
{
	...
	var paraUrl = encodeURI(encodeURI( context +"/xdss3/collect/collectController.spr?action=_exportSurety")+"&"+urlParmeters);
...
function reload_Collect_grid2(urlParmeters) {
	var paraUrl = encodeURI(context + "/xdss3/collect/collectController.spr?action=suretyBondqueryGrid")+"&"+urlParmeters;
