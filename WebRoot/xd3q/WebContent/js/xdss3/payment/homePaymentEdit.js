...
Ext.onReady(function(){
	...
	*/
	/**
	HomePaymentCbill_grid.on('afteredit', calcClearAmount, HomePaymentCbill_grid);
	...
	function calcClearAmount(e){
		...
		for (var i = 0; i < HomePaymentCbill_grid.getStore().getCount(); i++)
		{
			var rec = HomePaymentCbill_grid.getStore().getAt(i);
			sumclearamount += parseFloat(rec.get('clearamount2'));			
		}
		HomePaymentCbill_grid.setTitle('清账金额合计：'+ round(sumclearamount,2));
	}
	HomePaymentCbill_grid.getStore().on('load', calcClearAmount2, HomePaymentCbill_grid);
	...
	function calcClearAmount2(e,recs,o){
		...
		HomePaymentCbill_grid.setTitle('清账金额合计：'+ round(sumclearamount2,2));
	}
	**/
...
function mainInit(){
	...
	if(isReassign!='Y'){
		...
		if(ps.trim()=='' || ps=='外贸货款申请' || ps=='修改申请单'){
			...
			tb.hideTabStripItem('homeSettSubjTab');			// 隐藏（页签）付款结算科目	
			tb.hideTabStripItem('homeFundFlowTab');			// 隐藏（页签）付款纯资金	
		...
		if(ps!='出纳审核' && ps!='出纳确认'&& ps!='上海信达诺财务付款'){
		...
		if (ps == '资金部确认银行承兑汇票或国内信用证到期付款' ||ps == '确认银行承兑汇票或国内信用证到期付款' ||
				ps == '出纳付款' ||
				ps == '出纳背书'){
...
function _dealPrepayamount(){
	...
	//处理结算科目和纯资金往来
	if (Utils.isNumber(document.getElementById('HomeSettSubj.amount1').value) == true &&
		dict_div_HomeSettSubjdebtcredit1_dict.getValue() != ''){
		if (dict_div_HomeSettSubjdebtcredit1_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeSettSubj.amount1').value);
		}
		
		if (dict_div_HomeSettSubjdebtcredit1_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeSettSubj.amount1').value);
		}
	}
	
	if (Utils.isNumber(document.getElementById('HomeSettSubj.amount2').value) == true &&
		dict_div_HomeSettSubjdebtcredit2_dict.getValue() != ''){
		if (dict_div_HomeSettSubjdebtcredit2_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeSettSubj.amount2').value);
		}
		
		if (dict_div_HomeSettSubjdebtcredit2_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeSettSubj.amount2').value);
		}
	}
	
	if (Utils.isNumber(document.getElementById('HomeSettSubj.amount3').value) == true &&
			dict_div_HomeSettSubjdebtcredit3_dict.getValue() != ''){
		if (dict_div_HomeSettSubjdebtcredit3_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeSettSubj.amount3').value);
		}
		
		if (dict_div_HomeSettSubjdebtcredit3_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeSettSubj.amount3').value);
		}
	}
	
	if (Utils.isNumber(document.getElementById('HomeSettSubj.amount4').value) == true &&
		dict_div_HomeSettSubjdebtcredit4_dict.getValue() != ''){
		if (dict_div_HomeSettSubjdebtcredit4_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeSettSubj.amount4').value);
		}
		
		if (dict_div_HomeSettSubjdebtcredit4_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeSettSubj.amount4').value);
		}
	}

	if (Utils.isNumber(document.getElementById('HomeFundFlow.amount1').value) == true &&
		dict_div_HomeFundFlowdebtcredit1_dict.getValue() != ''){
		if (dict_div_HomeFundFlowdebtcredit1_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeFundFlow.amount1').value);
		}
		
		if (dict_div_HomeFundFlowdebtcredit1_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeFundFlow.amount1').value);
		}
	}
	
	if (Utils.isNumber(document.getElementById('HomeFundFlow.amount2').value) == true &&
			dict_div_HomeFundFlowdebtcredit2_dict.getValue() != ''){
		if (dict_div_HomeFundFlowdebtcredit2_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeFundFlow.amount2').value);
		}
		
		if (dict_div_HomeFundFlowdebtcredit2_dict.getValue() == 'H'){
			allItemAssignValue = allItemAssignValue - parseFloat(document.getElementById('HomeFundFlow.amount2').value);
		}
	}
	
	if (Utils.isNumber(document.getElementById('HomeFundFlow.amount3').value) == true &&
			dict_div_HomeFundFlowdebtcredit3_dict.getValue() != ''){
		if (dict_div_HomeFundFlowdebtcredit2_dict.getValue() == 'S'){
			allItemAssignValue = allItemAssignValue + parseFloat(document.getElementById('HomeFundFlow.amount3').value);
		}
...
function _setPayer(){
	...
	if(cs=='出纳审核' || cs=='资金部确认银行承兑汇票或国内信用证到期付款'|| cs=='确认银行承兑汇票或国内信用证到期付款' || cs=='上海信达诺财务付款'){
