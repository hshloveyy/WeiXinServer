 ...
 * Author : huanghu
 */  
Ext.form.GridField = Ext.extend(Ext.form.TriggerField,  {   
    /**  
    ...
    handleHeight : 8,
    /**  
     * @cfg {Object} store  gird的数据源
     */     
    store: null,
    /**  
     * @cfg {Object} cm  gird的cm
     */     
    cm: null,
    /**  
     * @cfg {Object} sm  gird的sm
     */     
    sm: null,
    ...
    initComponent : function(){   
        Ext.form.GridField.superclass.initComponent.call(this);   
    ...
    onRender : function(ct, position){   
        Ext.form.GridField.superclass.onRender.call(this, ct, position);   
        if(this.hiddenName){   
            ...
            Ext.form.GridField.superclass.setValue.call(this, this.displayValue ? this.displayValue : '');
    ...
    // private
    initEvents : function(){
        Ext.form.GridField.superclass.initEvents.call(this);
    ...
    restrictHeight : function(){
        ...
        this.list.endUpdate();
        this.grid.setHeight(this.maxHeight);
    },
    ...
    getValue : function(){   
        if(this.valueField){   
            ...
            return Ext.form.GridField.superclass.getValue.call(this);   
        }   
    },   
    setValue : function(node){   
        ...
        Ext.form.GridField.superclass.setValue.call(this, text);   
        this.value = value; 
        this.lastSelectionText = text;
    },   
    onResize: function(w, h){ 
        Ext.form.GridField.superclass.onResize.apply(this, arguments);   
    ...
    onDestroy : function(){   
        ...
        Ext.form.GridField.superclass.onDestroy.call(this);   
    },
...
Ext.reg('gridField', Ext.form.GridField);