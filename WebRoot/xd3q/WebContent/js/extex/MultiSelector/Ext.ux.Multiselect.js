...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		if (this.imagePath!="" && this.imagePath.charAt(this.imagePath.length-1)!="/")
			this.imagePath+="/";
		this.iconUp = this.imagePath + (this.iconUp || 'images/up2.gif');
		this.iconDown = this.imagePath + (this.iconDown || 'images/down2.gif');
		this.iconLeft = this.imagePath + (this.iconLeft || 'images/left2.gif');
		this.iconRight = this.imagePath + (this.iconRight || 'images/right2.gif');
		this.iconTop = this.imagePath + (this.iconTop || 'images/top2.gif');
		this.iconBottom = this.imagePath + (this.iconBottom || 'images/bottom2.gif');
		var el=icons.getEl();
		if (!this.toSortField) {
