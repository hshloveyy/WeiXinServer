...
{
	//if(isCreateCopy){
	//	document.getElementById("Community.communityid").value = "";
	//}
	...
	if(isCreateCopy)
	{
		param = param + ""+ getAllPortletGridData();
	}
	else
	{
...
function customCallBackHandle(transport)
{
	...
	document.getElementById("Community.communityid").value = communityid;
