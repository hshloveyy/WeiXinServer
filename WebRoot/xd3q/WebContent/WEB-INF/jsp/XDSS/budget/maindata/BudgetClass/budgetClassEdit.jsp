...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetClass/budgetClassEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetClass/budgetClassEditGen.js"></script>
</head>
<body>
<fisc:grid divId="div_budgetTemplate" boName="BudgetTemplate" needCheckBox="true" editable="true" defaultCondition=" YBUDTEM.BUDCLASSID='${budgetClass.budclassid}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		<td align="right" width="15%" ><font color="red">★</font>${vt.property.boid}：</td>
		<td width="30%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetClass.createtime" name="BudgetClass.createtime" value="${budgetClass.createtime}"  readonly="readonly" <fisc:authentication sourceName="BudgetClass.createtime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetClass.lastmodifytime" name="BudgetClass.lastmodifytime" value="${budgetClass.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="BudgetClass.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deleteBudgetClass,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createBudgetClass,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBudgetClass,iconCls:'icon-table-save'},'-',
