<%-- 
  ...
  - Date: 2010年03月26日 10点10分27秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>子业务对象预算组织模版(BudgetOrgTemp)查看页面
--%>
...
<title>预算组织模版查看页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrgTemp/budgetOrgTempView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrgTemp/budgetOrgTempViewGen.js"></script>
</head>
<body>
