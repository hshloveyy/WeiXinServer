...
<div id="div_chart_container" class="chart">
	<div id="BudgetSortChart_div"></div>
</div>

<div id="BudgetSortChartDetail_div" style="width: 100%"></div>
</body>
</html>
...
Ext.onReady(function(){
			...
			items:[{
				...
				items:[{
					...
					items:[{
						...
						id:'BudgetSortChart_div_ext'
					},{
						title:'${vt.chartDetail}',
						contentEl:"BudgetSortChartDetail_div"
					}]
				}]
			}]
		});
		Ext.getDom('BudgetSortChart_div_ext').align='center';
	});
	...
	**/
	function _queryChart()
	{
		...
		BudgetSortChart_div_reload_chart({queryParameters:queryParam,title:chartTitle});
	}
	//清空操作
	function _resetForm()
	{
...
<fisc:chart divId="BudgetSortChart_div" divDetailId="BudgetSortChartDetail_div" width="400" height="300" boName="BudgetSort" defaultCondition=""></fisc:chart>