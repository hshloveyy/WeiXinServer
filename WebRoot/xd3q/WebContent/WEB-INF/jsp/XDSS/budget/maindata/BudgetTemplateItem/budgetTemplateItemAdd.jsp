<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象模版预算项(BudgetTemplateItem)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplateItem/budgetTemplateItemAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplateItem/budgetTemplateItemAddGen.js"></script>
</head>
<body>
