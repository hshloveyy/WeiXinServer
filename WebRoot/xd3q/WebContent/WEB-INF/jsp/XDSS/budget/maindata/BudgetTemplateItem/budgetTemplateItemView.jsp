<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象模版预算项(BudgetTemplateItem)查看页面
--%>
...
<title>模版预算项查看页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplateItem/budgetTemplateItemView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplateItem/budgetTemplateItemViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%" >
			<input type="text" class="inputText" id="BudgetTemplateItem.seq" name="BudgetTemplateItem.seq" value="${budgetTemplateItem.seq}" <fisc:authentication sourceName="BudgetTemplateItem.seq" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
