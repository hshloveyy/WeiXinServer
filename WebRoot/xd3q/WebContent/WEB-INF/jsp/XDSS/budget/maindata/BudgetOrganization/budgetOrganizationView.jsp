<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象预算组织(BudgetOrganization)查看页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrganization/budgetOrganizationView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrganization/budgetOrganizationViewGen.js"></script>
</head>
<body>
<fisc:grid divId="div_budgetOrgTemp" boName="BudgetOrgTemp" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YBUDORGTEM.BUDORGID='${budgetOrganization.budorgid}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right" >${vt.property.budorgname}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.budorgtype}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.budcontype}：</td>
		<td width="30%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetOrganization.createtime" name="BudgetOrganization.createtime" value="${budgetOrganization.createtime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetOrganization.lastmodifytime" name="BudgetOrganization.lastmodifytime" value="${budgetOrganization.lastmodifytime}"  readonly="readonly">
		</td>
	</tr>
