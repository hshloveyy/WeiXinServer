<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象预算组织模版(BudgetOrgTemp)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrgTemp/budgetOrgTempAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetOrgTemp/budgetOrgTempAddGen.js"></script>
</head>
<body>
