<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象预算项分组(BudgetItemGroup)查看页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetItemGroup/budgetItemGroupView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetItemGroup/budgetItemGroupViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right" >${vt.property.budgroupname}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.budgroupdesc}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetItemGroup.createtime" name="BudgetItemGroup.createtime" value="${budgetItemGroup.createtime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetItemGroup.lastmodifytime" name="BudgetItemGroup.lastmodifytime" value="${budgetItemGroup.lastmodifytime}"  readonly="readonly">
		</td>
	</tr>
