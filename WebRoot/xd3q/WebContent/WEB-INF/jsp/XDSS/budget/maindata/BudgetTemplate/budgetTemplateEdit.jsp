...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplate/budgetTemplateEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetTemplate/budgetTemplateEditGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right" width="15%" ><font color="red">★</font>${vt.property.budtemname}：</td>
		<td width="30%">
		...
		<td align="right" width="15%" ><font color="red">★</font>${vt.property.budtemtype}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td align="right" width="15%" ><font color="red">★</font>${vt.property.budconcycle}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetTemplate.createtime" name="BudgetTemplate.createtime" value="${budgetTemplate.createtime}"  readonly="readonly" <fisc:authentication sourceName="BudgetTemplate.createtime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetTemplate.lastmodifytime" name="BudgetTemplate.lastmodifytime" value="${budgetTemplate.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="BudgetTemplate.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBudgetTemplate,iconCls:'icon-table-save'},'-',
