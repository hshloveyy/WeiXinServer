...
<title>预算项查看页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetItem/budgetItemView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetItem/budgetItemViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%" >
			<input type="text" class="inputText" id="BudgetItem.buditemname" name="BudgetItem.buditemname" value="${budgetItem.buditemname}" <fisc:authentication sourceName="BudgetItem.buditemname" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%" >
			<input type="text" class="inputText" id="BudgetItem.budfareguide" name="BudgetItem.budfareguide" value="${budgetItem.budfareguide}" <fisc:authentication sourceName="BudgetItem.budfareguide" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%"  colspan="3" >
			<textarea rows="4" cols="54" id="BudgetItem.weadesc" name="BudgetItem.weadesc"  <fisc:authentication sourceName="BudgetItem.weadesc" taskId="${workflowTaskId}"/>>${budgetItem.weadesc}</textarea>
		</td>
	</tr>
	<tr>
