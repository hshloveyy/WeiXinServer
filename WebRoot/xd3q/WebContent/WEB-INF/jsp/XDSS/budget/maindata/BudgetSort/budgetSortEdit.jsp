...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetSort/budgetSortEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/budget/maindata/BudgetSort/budgetSortEditGen.js"></script>
</head>
<body>
<fisc:grid divId="div_budgetTemplate" boName="BudgetTemplate" needCheckBox="true" editable="true" defaultCondition=" YBUDTEM.BUDSORTID='${budgetSort.budsortid}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetSort.createtime" name="BudgetSort.createtime" value="${budgetSort.createtime}"  readonly="readonly" <fisc:authentication sourceName="BudgetSort.createtime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="BudgetSort.lastmodifytime" name="BudgetSort.lastmodifytime" value="${budgetSort.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="BudgetSort.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deleteBudgetSort,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createBudgetSort,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBudgetSort,iconCls:'icon-table-save'},'-',
