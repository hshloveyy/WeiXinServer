<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象费用明细(DeptCharDetail)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/sample/deptcharge/deptCharDetailEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/sample/deptcharge/deptCharDetailEditGen.js"></script>
</head>
<body>
