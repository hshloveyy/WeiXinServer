<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象部门预算编制(DeptBudgetting)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/sample/deptBudgetting/deptBudgettingEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/XDSS/sample/deptBudgetting/deptBudgettingEditGen.js"></script>
</head>
<body>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deleteDeptBudgetting,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createDeptBudgetting,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateDeptBudgetting,iconCls:'icon-table-save'},'-',
