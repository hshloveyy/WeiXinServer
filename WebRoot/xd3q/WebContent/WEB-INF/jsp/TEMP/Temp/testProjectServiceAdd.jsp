<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象项目服务（测试）(TestProjectService)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectServiceAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectServiceAddGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td   width="40%" >
			<input type="text" class="inputText" id="TestProjectService.tsname" name="TestProjectService.tsname" value="${testProjectService.tsname}" <fisc:authentication sourceName="TestProjectService.tsname" taskId=""/> >
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProjectService.createtime" name="TestProjectService.createtime" value="${testProjectService.createtime}"  readonly="readonly" <fisc:authentication sourceName="TestProjectService.createtime" taskId=""/>>
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProjectService.lastmodifytime" name="TestProjectService.lastmodifytime" value="${testProjectService.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="TestProjectService.lastmodifytime" taskId=""/>>
		</td>
	</tr>
	<tr>
		<td align="right"  width="15%" >${vt.property.processstate}：</td>
		<td  width="30%" >
			<input type="text" class="inputText" id="TestProjectService.processstate" name="TestProjectService.processstate" value="${testProjectService.processstate}" <fisc:authentication sourceName="TestProjectService.processstate" taskId=""/> >
		</td>
        <td></td>
        <td></td>
	</tr>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateTestProjectService',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateTestProjectService,iconCls:'icon-table-save'},'-',
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessTestProjectService,disabled:true,iconCls:'task'},'-',					
<%}%>		
					' '],  
