<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象项目管理（测试）(TestProjectManage)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectManageAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectManageAddGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProjectManage.createtime" name="TestProjectManage.createtime" value="${testProjectManage.createtime}"  readonly="readonly" <fisc:authentication sourceName="TestProjectManage.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProjectManage.lastmodifytime" name="TestProjectManage.lastmodifytime" value="${testProjectManage.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="TestProjectManage.lastmodifytime" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateTestProjectManage',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateTestProjectManage,iconCls:'icon-table-save'},'-',
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessTestProjectManage,disabled:true,iconCls:'task'},'-',					
<%}%>		
					' '],  
