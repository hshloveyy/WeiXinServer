<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象项目管理（测试）(TestProjectManage)查看页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectManageView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectManageViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.projectname" nodeId="${workflowNodeDefId}"/> >${vt.property.projectname}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.processstate" nodeId="${workflowNodeDefId}"/> >${vt.property.processstate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="TestProjectManage" userId="${testProjectManage.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.lastmodifyer" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifyer}：</td>
		<td width="30%">
			<fisc:user boProperty="lastmodifyer" boName="TestProjectManage" userId="${testProjectManage.lastmodifyer}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="TestProjectManage.lastmodifytime" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifytime}：</td>
		<td  width="40%">
