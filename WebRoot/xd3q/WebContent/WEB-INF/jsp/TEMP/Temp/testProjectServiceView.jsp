<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象项目服务（测试）(TestProjectService)查看页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectServiceView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectServiceViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="15%" align="right" >${vt.property.tsname}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="TestProjectService.createtime" name="TestProjectService.createtime" value="${testProjectService.createtime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="TestProjectService.lastmodifytime" name="TestProjectService.lastmodifytime" value="${testProjectService.lastmodifytime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
