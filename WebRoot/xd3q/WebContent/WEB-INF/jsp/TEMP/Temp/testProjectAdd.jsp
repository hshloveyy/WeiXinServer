...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/TEMP/Temp/testProjectAddGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="TestProject.projectname" name="TestProject.projectname" value="${testProject.projectname}" <fisc:authentication sourceName="TestProject.projectname" taskId=""/> >
		</td>
		<td align="right"  width="15%" >${vt.property.processstate}：</td>
		<td   width="40%" >
			<input type="text" class="inputText" id="TestProject.processstate" name="TestProject.processstate" value="${testProject.processstate}" <fisc:authentication sourceName="TestProject.processstate" taskId=""/> >
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProject.createtime" name="TestProject.createtime" value="${testProject.createtime}"  readonly="readonly" <fisc:authentication sourceName="TestProject.createtime" taskId=""/>>
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="TestProject.lastmodifytime" name="TestProject.lastmodifytime" value="${testProject.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="TestProject.lastmodifytime" taskId=""/>>
		</td>
	</tr>
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessTestProject,disabled:true,iconCls:'task'},'-',					
<%}%>		
					...
					{id:'_saveOrUpdateTestProject',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateTestProject,iconCls:'icon-table-save'},
					' '],  
