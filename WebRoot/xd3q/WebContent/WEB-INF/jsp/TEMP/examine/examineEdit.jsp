...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/TEMP/examine/examineEdit.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/TEMP/examine/examineEditGen.js"></script>
</head>
<body>
...
<fisc:attachement businessId="${examine.vi}" allowDelete="true" divId="div_attachement" boName="Examine" gridPageSize="10" gridHeight="285"></fisc:attachement>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateExamine,iconCls:'icon-table-save'},'-',
