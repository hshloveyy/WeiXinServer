<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象检查信息明细(ExamineItem)增加页面
--%>
...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/TEMP/examineItem/examineItemAdd.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/TEMP/examineItem/examineItemAddGen.js"></script>
</head>
<body>
