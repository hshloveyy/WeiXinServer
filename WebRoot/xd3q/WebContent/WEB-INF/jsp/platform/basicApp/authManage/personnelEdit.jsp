...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/personnelEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/personnelEditGen.js"></script>
</head>
<body>
<fisc:grid divId="div_orgPersonnel" boName="OrgPersonnel" needCheckBox="true" editable="false" defaultCondition=" YORGPERSONNEL.PERSONNELID='${personnel.personnelid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td width="30%">
			<input type="text" class="inputText" id="Personnel.personnelno" name="Personnel.personnelno" value="${personnel.personnelno}"   readonly="readonly" <fisc:authentication sourceName="Personnel.personnelno" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Personnel.createtime" name="Personnel.createtime" value="${personnel.createtime}"  readonly="readonly" <fisc:authentication sourceName="Personnel.createtime" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Personnel.lastmodifytime" name="Personnel.lastmodifytime" value="${personnel.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="Personnel.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
        <td></td>
        <td></td>
	</tr>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
<tr>
<td width="15%" align="right" ><font color="red">★</font>${addressVt.property.country}：</td>
<td width="30%">
...
<td width="40%">
<input type="text" class="inputText" id="Address.mobilephone" name="Address.mobilephone" value="${personnel.address.mobilephone}" >
</td>
</tr>
<tr>
<td width="15%" align="right" ><font color="red">★</font>${addressVt.property.area}：</td>
<td width="30%">
...
<td width="40%">
<input type="text" class="inputText" id="Address.fax" name="Address.fax" value="${personnel.address.fax}" >
</td>
</tr>
<tr>
<td width="15%" align="right" ><font color="red">★</font>${addressVt.property.city}：</td>
<td width="30%">
<input type="text" class="inputText" id="Address.city" name="Address.city" value="${personnel.address.city}" >
</td>
<td width="15%" align="right" >${addressVt.property.website}：</td>
<td width="40%">
<input type="text" class="inputText" id="Address.website" name="Address.website" value="${personnel.address.website}" >
</td>
</tr>
<tr>
<td width="15%" align="right" ><font color="red">★</font>${addressVt.property.zipcode}：</td>
<td width="30%">
<input type="text" class="inputText" id="Address.zipcode" name="Address.zipcode" value="${personnel.address.zipcode}" >
</td>
<td width="15%" align="right" >${addressVt.property.qq_msn}：</td>
<td width="40%">
<input type="text" class="inputText" id="Address.qq_msn" name="Address.qq_msn" value="${personnel.address.qq_msn}" >
</td>
</tr>
<tr>
<td width="15%" align="right" >${addressVt.property.email}：</td>
<td width="30%">
<input type="text" class="inputText" id="Address.email" name="Address.email" value="${personnel.address.email}" >
</td>
<td width="15%" align="right" >${addressVt.property.homephone}：</td>
<td width="40%">
<input type="text" class="inputText" id="Address.homephone" name="Address.homephone" value="${personnel.address.homephone}" >
</td>
</tr>
<tr>
<td width="15%" align="right" ><font color="red">★</font>${addressVt.property.phone}：</td>
<td width="30%">
<input type="text" class="inputText" id="Address.phone" name="Address.phone" value="${personnel.address.phone}" >
</td>
...
<td width="30%">
<input type="text" class="inputText" id="Address.extnumber" name="Address.extnumber" value="${personnel.address.extnumber}" >
</td>
<td></td><td></td>
</tr>
<tr>
<td width="15%" align="right" valign="top"><font color="red">★</font>${addressVt.property.address}：</td>
<td width="30%" colspan="3" >
<textarea rows="4" cols="54" id="Address.address" name="Address.address" <fisc:authentication sourceName="Address.address" taskId="${workflowTaskId}"/>>${personnel.address.address}</textarea>
</td>
</tr>
</table>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deletePersonnel,iconCls:'icon-delete'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdatePersonnel,iconCls:'icon-table-save'},'-',
