...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/organizationView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/organizationViewGen.js"></script>
</head>
<body>
<fisc:grid divId="div_orgPersonnel" boName="OrgPersonnel" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YORGPERSONNEL.ORGANIZATIONID='${organization.organizationId}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right" >${vt.property.organizationName}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.organizationDesc}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.organizationCode}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.orderNo}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.busineseArea}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.costCenter}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.companyCode}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.controllingArea}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.profitCenter}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.purchasingOrganization}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.saleOrganization}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.budgetOrganization}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="Organization.createTime" name="Organization.createTime" value="${organization.createTime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="Organization.lastmodifytime" name="Organization.lastmodifytime" value="${organization.lastmodifytime}"  readonly="readonly">
		</td>
	</tr>
