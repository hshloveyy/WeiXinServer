...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/addressView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/addressViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right" >${vt.property.country}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.mobilephone}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.area}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.fax}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.city}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.website}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.zipcode}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.qq_msn}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.email}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.homephone}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.phone}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.addresstype}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.extnumber}：</td>
		<td width="30%">
