...
<title>职位编辑页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/positionEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/authManage/positionEditGen.js"></script>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="40%">
			<input type="text" class="inputText" id="Position.positionno" name="Position.positionno" value="${position.positionno}"   readonly="readonly" <fisc:authentication sourceName="Position.positionno" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
...
{id:'_delete',text:'删除',handler:_deletePosition,iconCls:'icon-delete'},'-',
'->','-',
{id:'_saveOrUpdate',text:'保存',handler:_saveOrUpdatePosition,iconCls:'icon-table-save'},'-',
