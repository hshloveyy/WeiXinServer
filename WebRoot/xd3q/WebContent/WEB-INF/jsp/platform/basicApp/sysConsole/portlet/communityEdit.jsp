...
<title>社区管理编辑页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/platform/basicApp/sysConsole/portlet/communityEdit.js"></script>
<style type="text/css">
  .x-grid3-header-offset {width: auto;}
</style>
</head>
<body>
<fisc:grid divId="div_portlet" boName="Portlet" needCheckBox="true" editable="false" defaultCondition=" YPORTLET.COMMUNITYID='${community.communityid}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Community.createtime" name="Community.createtime" value="${community.createtime}"  readonly="readonly" <fisc:authentication sourceName="Community.createtime" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Community.lastmodifytime" name="Community.lastmodifytime" value="${community.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="Community.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
        <td></td>
        <td></td>
	</tr>
...
{id:'_delete',text:'删除',handler:_deleteCommunity,iconCls:'icon-delete'},'-',
'->','-',
{id:'_saveOrUpdate',text:'保存',handler:_saveOrUpdateCommunity,iconCls:'icon-table-save'},'-',
