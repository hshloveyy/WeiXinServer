<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象票清付款(BillClearPayment)编辑页面
--%>
...
<body>
<fisc:grid divId="div_billClearItemPay"  pageSize="10000"   boName="BillClearItemPay" needCheckBox="true" editable="true" defaultCondition=" YBILLCLEARITEM.BILLCLEARID='${billClearPayment.billclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
<fisc:grid divId="div_billInPayment"  pageSize="10000"   boName="BillInPayment" needCheckBox="true" editable="true" defaultCondition=" YBILLINPAYMENT.BILLCLEARID='${billClearPayment.billclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.billclearno" nodeId="${workflowNodeDefId}"/> >${vt.property.billclearno}：</td>
		<td width="30%">
			<input type="text" class="inputText" id="BillClearPayment.billclearno" name="BillClearPayment.billclearno" value="${billClearPayment.billclearno}"   readonly="readonly" <fisc:authentication sourceName="BillClearPayment.billclearno" nodeId="${workflowNodeDefId}"/>>
		</td>
       <td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.supplier" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.supplier}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.deptid" nodeId="${workflowNodeDefId}"/> >${vt.property.deptid}：</td>
		<td width="30%">
			<div id="div_deptid_sh"></div>
			<fisc:searchHelp divId="div_deptid_sh" boName="BillClearPayment" boProperty="deptid"  value="${billClearPayment.deptid}"></fisc:searchHelp>
		</td>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td  width="40%">
			<fisc:user boProperty="creator" boName="BillClearPayment" userId="${billClearPayment.creator}"></fisc:user>
		</td>
	</tr>
	
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		    <input type="text" class="inputText" id="BillClearPayment.createtime" name="BillClearPayment.createtime" value="${billClearPayment.createtime}"  readonly="readonly">
		</td>
        <td></td>
        <td></td>
	</tr>
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillClearPayment.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount1" name="FundFlow.amount1" value="${billClearPayment.fundFlow.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount1" name="FundFlow.standardamount1" value="${billClearPayment.fundFlow.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount3" name="FundFlow.amount3" value="${billClearPayment.fundFlow.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount3" name="FundFlow.standardamount3" value="${billClearPayment.fundFlow.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${billClearPayment.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${billClearPayment.settleSubject.standardamount1}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno1_sh" boName="SettleSubject" boProperty="orderno1" value="${billClearPayment.settleSubject.orderno1}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${billClearPayment.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${billClearPayment.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${billClearPayment.settleSubject.standardamount2}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno2_sh" boName="SettleSubject" boProperty="orderno2" value="${billClearPayment.settleSubject.orderno2}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${billClearPayment.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${billClearPayment.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${billClearPayment.settleSubject.standardamount3}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno3_sh" boName="SettleSubject" boProperty="orderno3" value="${billClearPayment.settleSubject.orderno3}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${billClearPayment.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${billClearPayment.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${billClearPayment.settleSubject.standardamount4}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno4_sh" boName="SettleSubject" boProperty="orderno4" value="${billClearPayment.settleSubject.orderno4}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${billClearPayment.settleSubject.rowno4}" >
</td>
</tr>
</table>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billClear/billClearPaymentEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billClear/billClearPaymentEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBillClearPayment,iconCls:'icon-table-save'},'-',
<%
...
{id:'_voucherPreview2',text:'模拟凭证2',handler:_voucherPreviewBillClearPayment2,iconCls:'icon-view'},'-',
