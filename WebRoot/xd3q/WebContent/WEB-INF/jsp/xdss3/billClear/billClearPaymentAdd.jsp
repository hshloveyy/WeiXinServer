<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象票清付款(BillClearPayment)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billClear/billClearPaymentAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billClear/billClearPaymentAddGen.js"></script>
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessBillClearPayment,disabled:true,iconCls:'task'},'-',					
<%}%>		
					...
					{id:'_submitForReassign',text:'重分配提交',handler:_submitForReassignBillClearPayment,disabled:true,iconCls:'task'},'-',
					' '],  
