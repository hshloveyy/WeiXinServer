<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象预警对像条件(AdvanceWarnCond)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnCondAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnCondAddGen.js"></script>
</head>
<body>
