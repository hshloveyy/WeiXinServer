<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象预警对像配置(AdvanceWarnObject)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnObjectAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnObjectAddGen.js"></script>
</head>
<body>
...
<fisc:grid divId="div_advanceWarnCond" boName="AdvanceWarnCond" needCheckBox="true" editable="true" defaultCondition=" YADVAWARNCOND.WARNID='${advanceWarnObject.warnid}'" needAutoLoad="true" height="285" nameSapceSupport="true" orderBySql=" YADVAWARNCOND.CONDNO "></fisc:grid><div id="div_toolbar" class="x-hide-display"></div>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateAdvanceWarnObject',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateAdvanceWarnObject,iconCls:'icon-table-save'},'-',
