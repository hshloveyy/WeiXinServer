<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象预警对像配置(AdvanceWarnObject)查看页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnObjectView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnObjectViewGen.js"></script>
</head>
<body>
<fisc:grid divId="div_advanceWarnRecv" boName="AdvanceWarnRecv" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YADVAWARNRECE.WARNID='${advanceWarnObject.warnid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_advanceWarnCond" boName="AdvanceWarnCond" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YADVAWARNCOND.WARNID='${advanceWarnObject.warnid}'" needAutoLoad="true" height="285" nameSapceSupport="true" orderBySql=" YADVAWARNCOND.CONDNO "></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.boid" nodeId="${workflowNodeDefId}"/> >${vt.property.boid}：</td>
		<td width="30%">
			<div id="div_boid_sh"></div>
			<fisc:searchHelp divId="div_boid_sh" boName="AdvanceWarnObject" boProperty="boid"  value="${advanceWarnObject.boid}"></fisc:searchHelp>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.fieldcode" nodeId="${workflowNodeDefId}"/> >${vt.property.fieldcode}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.warnrole" nodeId="${workflowNodeDefId}"/> >${vt.property.warnrole}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.warnvalue" nodeId="${workflowNodeDefId}"/> >${vt.property.warnvalue}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.primarykey" nodeId="${workflowNodeDefId}"/> >${vt.property.primarykey}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.viewurl" nodeId="${workflowNodeDefId}"/> >${vt.property.viewurl}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.dealfunc" nodeId="${workflowNodeDefId}"/> >${vt.property.dealfunc}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.state" nodeId="${workflowNodeDefId}"/> >${vt.property.state}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.cleartype" nodeId="${workflowNodeDefId}"/> >${vt.property.cleartype}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.clearuser" nodeId="${workflowNodeDefId}"/> >${vt.property.clearuser}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="AdvanceWarnObject.warninfo" nodeId="${workflowNodeDefId}"/> >${vt.property.warninfo}：</td>
		<td width="30%">
