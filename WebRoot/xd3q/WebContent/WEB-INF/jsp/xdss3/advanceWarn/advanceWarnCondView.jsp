<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象预警对像条件(AdvanceWarnCond)查看页面
--%>
...
<title>预警对像条件查看页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnCondView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/advanceWarn/advanceWarnCondViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%" >
			<input type="text" class="inputText" id="AdvanceWarnCond.condno" name="AdvanceWarnCond.condno" value="${advanceWarnCond.condno}" <fisc:authentication sourceName="AdvanceWarnCond.condno" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%" >
			<input type="text" class="inputText" id="AdvanceWarnCond.condvalue" name="AdvanceWarnCond.condvalue" value="${advanceWarnCond.condvalue}" <fisc:authentication sourceName="AdvanceWarnCond.condvalue" taskId="${workflowTaskId}"/>>
		</td>
