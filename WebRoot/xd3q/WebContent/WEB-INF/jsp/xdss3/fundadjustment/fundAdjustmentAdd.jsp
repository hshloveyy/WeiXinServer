<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象资金占用调整(FundAdjustment)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.fundno" nodeId="${workflowNodeDefId}"/> >${vt.property.fundno}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.customer" nodeId="${workflowNodeDefId}"/> >${vt.property.customer}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.supplier" nodeId="${workflowNodeDefId}"/> >${vt.property.supplier}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.deptid" nodeId="${workflowNodeDefId}"/> >${vt.property.deptid}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.projectid" nodeId="${workflowNodeDefId}"/> >${vt.property.projectid}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.trade_type" nodeId="${workflowNodeDefId}"/> >${vt.property.trade_type}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.mat_group" nodeId="${workflowNodeDefId}"/> >${vt.property.mat_group}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.locktime" nodeId="${workflowNodeDefId}"/> >${vt.property.locktime}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.amount" nodeId="${workflowNodeDefId}"/> >${vt.property.amount}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.currency" nodeId="${workflowNodeDefId}"/> >${vt.property.currency}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.amount2" nodeId="${workflowNodeDefId}"/> >${vt.property.amount2}：</td>
		<td  width="30%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.cmd" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.cmd}：</td>
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td  width="30%" >
			<fisc:user boProperty="creator" boName="FundAdjustment" userId="${fundAdjustment.creator}"></fisc:user>
		</td>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td   width="40%" >
		    <input type="text" class="inputText" id="FundAdjustment.createtime" name="FundAdjustment.createtime" value="${fundAdjustment.createtime}"  readonly="readonly" <fisc:authentication sourceName="FundAdjustment.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.lastmodifytime" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifytime}：</td>
		<td  width="30%" >
		    <input type="text" class="inputText" id="FundAdjustment.lastmodifytime" name="FundAdjustment.lastmodifytime" value="${fundAdjustment.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="FundAdjustment.lastmodifytime" nodeId="${workflowNodeDefId}"/>>
		</td>
		<td align="right"  width="15%" <fisc:authentication sourceName="FundAdjustment.lastmodifyer" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifyer}：</td>
		<td   width="40%" >
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/fundadjustment/fundAdjustmentAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/fundadjustment/fundAdjustmentAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateFundAdjustment',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateFundAdjustment,iconCls:'icon-table-save'},'-',
