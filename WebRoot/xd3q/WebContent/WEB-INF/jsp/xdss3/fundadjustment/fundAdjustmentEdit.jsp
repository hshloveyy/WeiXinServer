<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象资金占用调整(FundAdjustment)编辑页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%">
			<input type="text" class="inputText" id="FundAdjustment.fundno" name="FundAdjustment.fundno" value="${fundAdjustment.fundno}"   readonly="readonly" <fisc:authentication sourceName="FundAdjustment.fundno" nodeId="${workflowNodeDefId}"/>>
		</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/fundadjustment/fundAdjustmentEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/fundadjustment/fundAdjustmentEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
{id:'_delete',text:'${vt.mDelete}',handler:_deleteFundAdjustment,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createFundAdjustment,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateFundAdjustment,iconCls:'icon-table-save'},'-',
