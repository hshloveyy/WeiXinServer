...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="Reassign.reassigntype" nodeId="${workflowNodeDefId}"/> >${vt.property.reassigntype}：</td>
		<td   width="40%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="Reassign.reassignboid" nodeId="${workflowNodeDefId}"/> >${vt.property.reassignboid}：</td>
		<td  width="30%"> 
			<div id="div_reassignboid_sh"></div>
			<fisc:searchHelp divId="div_reassignboid_sh" boName="" boProperty="" searchHelpName="YHCOLLECTNO" searchType="field" valueField = "COLLECTID"  displayField = "COLLECTNO" hiddenName="Reassign.reassignboid"  value="${reassign.reassignboid}"></fisc:searchHelp>
		</td>
	</tr>
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="Reassign.reassigntmethod" nodeId="${workflowNodeDefId}"/> >${vt.property.reassigntmethod}：</td>
		<td  width="30%" >
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/reassign/reassignAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/reassign/reassignAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateReassign',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateReassign,iconCls:'icon-table-save'},'-',
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessReassign,disabled:true,iconCls:'task'},'-',					
<%}%>		
					' '],  
