<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象票清收款(BillClearCollect)编辑页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%">
			<input type="text" class="inputText" id="BillClearCollect.billclearno" name="BillClearCollect.billclearno" value="${billClearCollect.billclearno}"   readonly="readonly" <fisc:authentication sourceName="BillClearCollect.billclearno" nodeId="${workflowNodeDefId}"/>>
		</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.amount1" name="SettleSubjectBcc.amount1" value="${billClearCollect.settleSubjectBcc.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubjectBcc.standardamount1" name="SettleSubjectBcc.standardamount1" value="${billClearCollect.settleSubjectBcc.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.rowno1" name="SettleSubjectBcc.rowno1" value="${billClearCollect.settleSubjectBcc.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.amount2" name="SettleSubjectBcc.amount2" value="${billClearCollect.settleSubjectBcc.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubjectBcc.standardamount2" name="SettleSubjectBcc.standardamount2" value="${billClearCollect.settleSubjectBcc.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.rowno2" name="SettleSubjectBcc.rowno2" value="${billClearCollect.settleSubjectBcc.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.amount3" name="SettleSubjectBcc.amount3" value="${billClearCollect.settleSubjectBcc.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubjectBcc.standardamount3" name="SettleSubjectBcc.standardamount3" value="${billClearCollect.settleSubjectBcc.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.rowno3" name="SettleSubjectBcc.rowno3" value="${billClearCollect.settleSubjectBcc.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.amount4" name="SettleSubjectBcc.amount4" value="${billClearCollect.settleSubjectBcc.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubjectBcc.standardamount4" name="SettleSubjectBcc.standardamount4" value="${billClearCollect.settleSubjectBcc.standardamount4}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubjectBcc.rowno4" name="SettleSubjectBcc.rowno4" value="${billClearCollect.settleSubjectBcc.rowno4}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlowBcc.amount1" name="FundFlowBcc.amount1" value="${billClearCollect.fundFlowBcc.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlowBcc.standardamount1" name="FundFlowBcc.standardamount1" value="${billClearCollect.fundFlowBcc.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlowBcc.amount2" name="FundFlowBcc.amount2" value="${billClearCollect.fundFlowBcc.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlowBcc.standardamount2" name="FundFlowBcc.standardamount2" value="${billClearCollect.fundFlowBcc.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlowBcc.amount3" name="FundFlowBcc.amount3" value="${billClearCollect.fundFlowBcc.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlowBcc.standardamount3" name="FundFlowBcc.standardamount3" value="${billClearCollect.fundFlowBcc.standardamount3}" >
</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billclearcollect/billClearCollectEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billclearcollect/billClearCollectEditGen.js"></script>
...
var sumclearamount = '${sumclearamount}';
var sumadjustamount = '${sumadjustamount}';
var sumnowclearamount = '${sumnowclearamount}';
//页面文本
var Txt={
	//票清收款
...
{id:'_delete',text:'${vt.mDelete}',handler:_deleteBillClearCollect,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createBillClearCollect,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBillClearCollect,iconCls:'icon-table-save'},'-',
<%
