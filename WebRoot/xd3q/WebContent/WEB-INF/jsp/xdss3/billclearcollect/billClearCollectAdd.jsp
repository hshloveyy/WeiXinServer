<%-- 
  ...
  - Date: 2010年10月12日 09点30分39秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象票清收款(BillClearCollect)增加页面
--%>
...
<body>
<fisc:grid divId="div_billClearItem"   pageSize="10000"   boName="BillClearItem" needCheckBox="true" editable="true" defaultCondition=" YBILLCLEARITEM.BILLCLEARID='${billClearCollect.billclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
<fisc:grid divId="div_billInCollect"   pageSize="10000"   boName="BillInCollect" needCheckBox="true" editable="true" defaultCondition=" YBILLINCOLLECT.BILLCLEARID='${billClearCollect.billclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.billclearno" nodeId="${workflowNodeDefId}"/> >${vt.property.billclearno}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.customer" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.customer}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td  width="30%"  colspan="3" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.deptid" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.deptid}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td   width="40%" >
			<fisc:user boProperty="creator" boName="BillClearCollect" userId="${billClearCollect.creator}"></fisc:user>
		</td>
	</tr>
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="BillClearCollect.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="30%" >
		    <input type="text" class="inputText" id="BillClearCollect.createtime" name="BillClearCollect.createtime" value="${billClearCollect.createtime}"  readonly="readonly" <fisc:authentication sourceName="BillClearCollect.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
        <td></td>
        <td></td>
	</tr>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.debtcredit1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.debtcredit1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.amount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.amount1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.standardamount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.standardamount1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.settlesubject1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.settlesubject1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.costcenter1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.costcenter1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.depid1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.depid1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.orderno1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.orderno1}：</td>
<td width="30%" >
<div id="div_SettleSubjectBccorderno1_sh"></div>
<fisc:searchHelp divId="div_SettleSubjectBccorderno1_sh" boName="SettleSubjectBcc" boProperty="orderno1" value="${billClearCollect.settleSubjectBcc.orderno1}"></fisc:searchHelp>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.rowno1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.rowno1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.antiaccount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.antiaccount1}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.debtcredit2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.debtcredit2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.amount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.amount2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.standardamount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.standardamount2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.settlesubject2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.settlesubject2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.costcenter2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.costcenter2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.depid2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.depid2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.orderno2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.orderno2}：</td>
<td width="30%" >
<div id="div_SettleSubjectBccorderno2_sh"></div>
<fisc:searchHelp divId="div_SettleSubjectBccorderno2_sh" boName="SettleSubjectBcc" boProperty="orderno2" value="${billClearCollect.settleSubjectBcc.orderno2}"></fisc:searchHelp>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.rowno2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.rowno2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.antiaccount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.antiaccount2}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.debtcredit3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.debtcredit3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.amount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.amount3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.standardamount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.standardamount3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.settlesubject3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.settlesubject3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.costcenter3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.costcenter3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.depid3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.depid3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.orderno3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.orderno3}：</td>
<td width="30%" >
<div id="div_SettleSubjectBccorderno3_sh"></div>
<fisc:searchHelp divId="div_SettleSubjectBccorderno3_sh" boName="SettleSubjectBcc" boProperty="orderno3" value="${billClearCollect.settleSubjectBcc.orderno3}"></fisc:searchHelp>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.rowno3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.rowno3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.antiaccount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.antiaccount3}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.debtcredit4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.debtcredit4}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.amount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.amount4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.standardamount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.standardamount4}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.settlesubject4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.settlesubject4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.profitcenter" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.profitcenter}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.depid4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.depid4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.orderno4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.orderno4}：</td>
<td width="30%" >
<div id="div_SettleSubjectBccorderno4_sh"></div>
<fisc:searchHelp divId="div_SettleSubjectBccorderno4_sh" boName="SettleSubjectBcc" boProperty="orderno4" value="${billClearCollect.settleSubjectBcc.orderno4}"></fisc:searchHelp>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.rowno4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.rowno4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectBcc.antiaccount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectBccVt.property.antiaccount4}：</td>
<td width="30%" >
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.debtcredit1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.debtcredit1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.amount1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.amount1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.standardamount1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.standardamount1}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.customer1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.customer1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.depid1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.depid1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.antiaccount1" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.antiaccount1}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.debtcredit2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.debtcredit2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.amount2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.amount2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.standardamount2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.standardamount2}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.customer2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.customer2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.depid2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.depid2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.antiaccount2" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.antiaccount2}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.debtcredit3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.debtcredit3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.amount3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.amount3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.standardamount3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.standardamount3}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.customer3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.customer3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.depid3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.depid3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowBcc.antiaccount3" nodeId="${workflowNodeDefId}"/> >${fundFlowBccVt.property.antiaccount3}：</td>
<td width="30%" >
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billclearcollect/billClearCollectAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billclearcollect/billClearCollectAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateBillClearCollect',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBillClearCollect,iconCls:'icon-table-save'},'-',
          
<%
Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessBillClearCollect,disabled:true,iconCls:'task'},'-',					
<%}%>		
					...
					{id:'_voucherPreview2',text:'模拟凭证2',handler:_voucherPreviewBillClearCollect2,iconCls:'icon-view'},'-',
					...
					{id:'_clearAssign',text:'清除分配',handler:_clearAssignBillClearCollect,iconCls:' '},'-',
          			{id:'_submitForReassign',text:'重分配提交',handler:_submitForReassignBillClearCollect,disabled:true,hidden:true,iconCls:'task'},'-',
					' '],  
