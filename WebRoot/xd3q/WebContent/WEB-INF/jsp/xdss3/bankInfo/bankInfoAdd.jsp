<%-- 
  ...
  - Date: 2010年06月29日 11点38分27秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象银行信息(BankInfo)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/bankInfo/bankInfoAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/bankInfo/bankInfoAddGen.js"></script>
</head>
<body>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateBankInfo',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBankInfo,iconCls:'icon-table-save'},'-',
