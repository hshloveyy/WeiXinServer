...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/bankInfo/bankInfoView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/bankInfo/bankInfoViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="BankInfo.bank_code" nodeId="${workflowNodeDefId}"/> >${vt.property.bank_code}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="BankInfo.bank_name" nodeId="${workflowNodeDefId}"/> >${vt.property.bank_name}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="BankInfo.bank_account" nodeId="${workflowNodeDefId}"/> >${vt.property.bank_account}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="BankInfo.bank_hkont" nodeId="${workflowNodeDefId}"/> >${vt.property.bank_hkont}：</td>
		<td  width="40%">
