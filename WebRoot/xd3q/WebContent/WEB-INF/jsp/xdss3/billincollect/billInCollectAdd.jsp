<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象未清预收款(BillInCollect)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billincollect/billInCollectAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billincollect/billInCollectAddGen.js"></script>
</head>
<body>
