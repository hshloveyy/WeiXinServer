...
<body>
	<fisc:grid 
		   ...
		   pageSize="10" 
		   tableName="ycollect "
		   handlerClass="com.infolion.xdss3.collect.domain.CollectSuretyBondContractDetailGrid"
 		   whereSql="" 
 		   needCheckBox="true"
	...
	<form id="mainForm" name="mainForm">
		<table width="100%" border="0" cellpadding="4" cellspacing="1">
			...
			<tr>
				...
				<td></td>
				<td width="" align="right">收款创建时间：</td>
				<td width="92px" >
			...
			<td></td>
			<td width="" align="right">收款单审批状态：</td>
			<td  width="" colspan="3">
				<input type="text" class="inputText" id="t_bsMultiselect" name="t_bsMultiselect" value="" />
			</td>
			<td></td>
			</tr>
		</table>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/collect/suretyBondContractDetail.js"></script>
