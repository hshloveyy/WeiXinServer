...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.collectno" nodeId="${workflowNodeDefId}"/> >${vt.property.collectno}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.customer" nodeId="${workflowNodeDefId}"/> >${vt.property.customer}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.oldcollectno" nodeId="${workflowNodeDefId}"/> >${vt.property.oldcollectno}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.incsuretybond" nodeId="${workflowNodeDefId}"/> >${vt.property.incsuretybond}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.collecttype" nodeId="${workflowNodeDefId}"/> >${vt.property.collecttype}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.applyamount" nodeId="${workflowNodeDefId}"/> >${vt.property.applyamount}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.currency" nodeId="${workflowNodeDefId}"/> >${vt.property.currency}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.draft" nodeId="${workflowNodeDefId}"/> >${vt.property.draft}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.export_apply_no" nodeId="${workflowNodeDefId}"/> >${vt.property.export_apply_no}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.billcurrency" nodeId="${workflowNodeDefId}"/> >${vt.property.billcurrency}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.convertamount" nodeId="${workflowNodeDefId}"/> >${vt.property.convertamount}：</td>
		<td width="30%">
		...
		<!--  
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.expiredate" nodeId="${workflowNodeDefId}"/> >${vt.property.expiredate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.billbc" nodeId="${workflowNodeDefId}"/> >${vt.property.billbc}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.draftdate" nodeId="${workflowNodeDefId}"/> >${vt.property.draftdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.sendgoodsdate" nodeId="${workflowNodeDefId}"/> >${vt.property.sendgoodsdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.billcheckdate" nodeId="${workflowNodeDefId}"/> >${vt.property.billcheckdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.goodsamount" nodeId="${workflowNodeDefId}"/> >${vt.property.goodsamount}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.replaceamount" nodeId="${workflowNodeDefId}"/> >${vt.property.replaceamount}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.supplieramount" nodeId="${workflowNodeDefId}"/> >${vt.property.supplieramount}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.text" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.text}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.collectrate" nodeId="${workflowNodeDefId}"/> >${vt.property.collectrate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.settlerate" nodeId="${workflowNodeDefId}"/> >${vt.property.settlerate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.actamount" nodeId="${workflowNodeDefId}"/> >${vt.property.actamount}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.actcurrency" nodeId="${workflowNodeDefId}"/> >${vt.property.actcurrency}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="Collect" userId="${collect.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
		    <input type="text" class="inputText" id="Collect.createtime" name="Collect.createtime" value="${collect.createtime}"  readonly="readonly">
		</td>
	</tr>
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.lastmodifyer" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifyer}：</td>
		<td width="30%">
			<fisc:user boProperty="lastmodifyer" boName="Collect" userId="${collect.lastmodifyer}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="Collect.lastmodifytime" nodeId="${workflowNodeDefId}"/> >${vt.property.lastmodifytime}：</td>
		<td  width="40%">
			<input type="text" class="inputText" id="Collect.lastmodifytime" name="Collect.lastmodifytime" value="${collect.lastmodifytime}" <fisc:authentication sourceName="Collect.lastmodifytime" nodeId="${workflowNodeDefId}"/>  >
		</td>
	</tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${collect.settleSubject.amount1}" <fisc:authentication sourceName="SettleSubject.amount1" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${collect.settleSubject.standardamount1}" <fisc:authentication sourceName="SettleSubject.standardamount1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno1" name="SettleSubject.orderno1" value="${collect.settleSubject.orderno1}" <fisc:authentication sourceName="SettleSubject.orderno1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${collect.settleSubject.rowno1}" <fisc:authentication sourceName="SettleSubject.rowno1" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${collect.settleSubject.amount2}" <fisc:authentication sourceName="SettleSubject.amount2" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${collect.settleSubject.standardamount2}" <fisc:authentication sourceName="SettleSubject.standardamount2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno2" name="SettleSubject.orderno2" value="${collect.settleSubject.orderno2}" <fisc:authentication sourceName="SettleSubject.orderno2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${collect.settleSubject.rowno2}" <fisc:authentication sourceName="SettleSubject.rowno2" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${collect.settleSubject.amount3}" <fisc:authentication sourceName="SettleSubject.amount3" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${collect.settleSubject.standardamount3}" <fisc:authentication sourceName="SettleSubject.standardamount3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno3" name="SettleSubject.orderno3" value="${collect.settleSubject.orderno3}" <fisc:authentication sourceName="SettleSubject.orderno3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${collect.settleSubject.rowno3}" <fisc:authentication sourceName="SettleSubject.rowno3" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${collect.settleSubject.amount4}" <fisc:authentication sourceName="SettleSubject.amount4" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${collect.settleSubject.standardamount4}" <fisc:authentication sourceName="SettleSubject.standardamount4" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno4" name="SettleSubject.orderno4" value="${collect.settleSubject.orderno4}" <fisc:authentication sourceName="SettleSubject.orderno4" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${collect.settleSubject.rowno4}" <fisc:authentication sourceName="SettleSubject.rowno4" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlow.amount1" name="FundFlow.amount1" value="${collect.fundFlow.amount1}" <fisc:authentication sourceName="FundFlow.amount1" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlow.standardamount1" name="FundFlow.standardamount1" value="${collect.fundFlow.standardamount1}" <fisc:authentication sourceName="FundFlow.standardamount1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlow.amount2" name="FundFlow.amount2" value="${collect.fundFlow.amount2}" <fisc:authentication sourceName="FundFlow.amount2" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlow.standardamount2" name="FundFlow.standardamount2" value="${collect.fundFlow.standardamount2}" <fisc:authentication sourceName="FundFlow.standardamount2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlow.amount3" name="FundFlow.amount3" value="${collect.fundFlow.amount3}" <fisc:authentication sourceName="FundFlow.amount3" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlow.standardamount3" name="FundFlow.standardamount3" value="${collect.fundFlow.standardamount3}" <fisc:authentication sourceName="FundFlow.standardamount3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<fisc:grid divId="div_collectItem" boName="CollectItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YCOLLECTITEM.COLLECTID='${collect.collectid}'" needAutoLoad="true" height="285" nameSapceSupport="true" pageSize="10000"></fisc:grid>
<fisc:grid divId="div_collectCbill" boName="CollectCbill" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YCOLLECTCBILL.COLLECTID='${collect.collectid}'" needAutoLoad="true" height="285" nameSapceSupport="true"  pageSize="10000"></fisc:grid>
<fisc:grid divId="div_collectRelated" boName="CollectRelated" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YCOLLECTRELATED.COLLECTID='${collect.collectid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_collectBankItem" boName="CollectBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YCOLLECTBANKITEM.COLLECTID='${collect.collectid}'" needAutoLoad="true" height="285" nameSapceSupport="true" pageSize="10000"></fisc:grid>
<fisc:attachement businessId="${businessId}" allowDelete="false" allowUpload="false" divId="div_attachement" boName="Collect" boProperty="attachement" gridPageSize="10" gridHeight="285" ></fisc:attachement>

</body>
</html>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/collect/collectViewGen.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/collect/collectView.js"></script>
 ...
 * 提交
 */
function _submitProcessCollect1(id)
{
...
function _saveDate(){
	var param='?action=_saveDate&collectid='+collectid+'&sendgoodsdate='+$('Collect.sendgoodsdate').value+'&billcheckdate='+$('Collect.billcheckdate').value;
	new AjaxEngine(contextPath + '/xdss3/collect/collectController.spr', 
...
function _cancelCollectCallBack()
{
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'->','-',
					<%
					String isReassign = (String)request.getAttribute("isReassign");
					Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
					if((isReassign!=null && isReassign.equals("Y"))||Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessCollect1,iconCls:'task'},'-',
					<%}%>
