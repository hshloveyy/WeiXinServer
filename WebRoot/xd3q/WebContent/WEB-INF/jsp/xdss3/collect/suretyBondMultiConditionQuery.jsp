...
<body>
	<fisc:grid 
		   ...
		   pageSize="10" 
		   tableName="ycollect "
		   handlerClass="com.infolion.xdss3.collect.domain.CollectSuretyBondGrid"
 		   whereSql="" 
 		   needCheckBox="true"
	...
	<form id="mainForm" name="mainForm">
		<table width="100%" border="0" cellpadding="4" cellspacing="1">
			...
			<tr>
				...
				<td width="" colspan="3">
					<input type="text" class="inputText" id="project_no" name="project_no" value="" style="width: 60px;">
					立项是否关闭<select name="isProjectClose" id="isProjectClose"><option value="0">否</option><option value="1">是</option><option value="">全部</option></select>
				</td>
				<td></td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/collect/suretyBondMultiConditionQuery.js"></script>
