...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="BillPurchased.billpur_no" name="BillPurchased.billpur_no" value="${billPurchased.billpur_no}" <fisc:authentication sourceName="BillPurchased.billpur_no" nodeId="${workflowNodeDefId}" /> readonly="readonly">
		</td>
	...
	<tr>
		...
		<td  width="30%" >
		    <input type="text" class="inputText" id="BillPurchased.createtime" name="BillPurchased.createtime" value="${billPurchased.createtime}"  readonly="readonly" <fisc:authentication sourceName="BillPurchased.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billpurchased/billPurchasedAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billpurchased/billPurchasedAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateBillPurchased',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBillPurchased,iconCls:'icon-table-save'},'-',
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessBillPurchased,disabled:true,iconCls:'task'},'-',					
<%}%>		
