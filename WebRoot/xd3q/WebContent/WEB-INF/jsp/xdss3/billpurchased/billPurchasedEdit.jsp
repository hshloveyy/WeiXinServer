...
<body>
<fisc:grid divId="div_billPurBillItem" boName="BillPurBillItem" needCheckBox="true" editable="true" defaultCondition=" YBILLPURBILLITEM.BILLPURID='${billPurchased.billpurid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_billPurBankItem" boName="BillPurBankItem" needCheckBox="true" editable="true" defaultCondition=" YBILLPURBANKITEM.BILLPURID='${billPurchased.billpurid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_billPurReBankItem" boName="BillPurReBankItem" needCheckBox="true" editable="true" defaultCondition=" YBILLPURREBANK.BILLPURID='${billPurchased.billpurid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_billPurReBankTwo" boName="BillPurReBankTwo" needCheckBox="true" editable="true" defaultCondition=" YBILLPURREBANK.BILLPURID='${billPurchased.billpurid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.billpur_no" nodeId="${workflowNodeDefId}"/> >${vt.property.billpur_no}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.applyamount" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.applyamount}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.currency" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.currency}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.billpurrate" nodeId="${workflowNodeDefId}"/> >${vt.property.billpurrate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.payrealdate" nodeId="${workflowNodeDefId}"/> >${vt.property.payrealdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.maturity" nodeId="${workflowNodeDefId}"/> >${vt.property.maturity}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.text" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.text}：</td>
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.revoucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.revoucherdate}：</td>
		<td  width="40%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.reaccountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.reaccountdate}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.retext" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.retext}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td  width="40%">
			<fisc:user boProperty="creator" boName="BillPurchased" userId="${billPurchased.creator}"></fisc:user>
		</td>
	</tr>
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="BillPurchased.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td  width="40%">
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${billPurchased.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${billPurchased.settleSubject.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${billPurchased.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${billPurchased.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${billPurchased.settleSubject.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${billPurchased.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${billPurchased.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${billPurchased.settleSubject.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${billPurchased.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${billPurchased.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${billPurchased.settleSubject.standardamount4}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${billPurchased.settleSubject.rowno4}" >
</td>
</tr>
</table>
...
<fisc:searchHelp divId="div_FundFlowsupplier1_sh" boName="FundFlow" boProperty="supplier1" value="${billPurchased.fundFlow.supplier1}"></fisc:searchHelp>
</td>
</tr>
<tr>
...
<fisc:searchHelp divId="div_FundFlowsupplier2_sh" boName="FundFlow" boProperty="supplier2" value="${billPurchased.fundFlow.supplier2}"></fisc:searchHelp>
</td>
</tr>
<tr>
...
<fisc:searchHelp divId="div_FundFlowsupplier3_sh" boName="FundFlow" boProperty="supplier3" value="${billPurchased.fundFlow.supplier3}"></fisc:searchHelp>
</td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billpurchased/billPurchasedEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/billpurchased/billPurchasedEditGen.js"></script>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deleteBillPurchased,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createBillPurchased,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateBillPurchased,iconCls:'icon-table-save'},'-',
...
{id:'_prepConfirm',text:'预确认',handler:_prepConfirmBillPurchased,iconCls:'task'},'-',
' '
],
