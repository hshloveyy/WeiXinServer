<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象供应商单清帐(SupplierSinglClear)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateSupplierSinglClear',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateSupplierSinglClear,iconCls:'icon-table-save'},'-',
