<%-- 
  ...
  - Date: 2010年09月19日 09点52分30秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象客户单清帐(CustomSingleClear)查看页面
--%>
...
<body>
<fisc:grid divId="div_unClearCustomBill"  pageSize="10000"   boName="UnClearCustomBill" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNCLEARCUSTBILL.CUSTOMSCLEARID='${customSingleClear.customsclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷"></fisc:grid>
<fisc:grid divId="div_unClearCollect"  pageSize="10000"   boName="UnClearCollect" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNCLEARCOLLECT.CUSTOMSCLEARID='${customSingleClear.customsclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.custom" nodeId="${workflowNodeDefId}"/> >${vt.property.custom}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.subject" nodeId="${workflowNodeDefId}"/> >${vt.property.subject}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.depid" nodeId="${workflowNodeDefId}"/> >${vt.property.depid}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.companyno" nodeId="${workflowNodeDefId}"/> >${vt.property.companyno}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.currencytext" nodeId="${workflowNodeDefId}"/> >${vt.property.currencytext}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.text" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.text}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleClear.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno1" name="SettleSubject.orderno1" value="${customSingleClear.settleSubject.orderno1}" <fisc:authentication sourceName="SettleSubject.orderno1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno2" name="SettleSubject.orderno2" value="${customSingleClear.settleSubject.orderno2}" <fisc:authentication sourceName="SettleSubject.orderno2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno3" name="SettleSubject.orderno3" value="${customSingleClear.settleSubject.orderno3}" <fisc:authentication sourceName="SettleSubject.orderno3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubject.orderno4" name="SettleSubject.orderno4" value="${customSingleClear.settleSubject.orderno4}" <fisc:authentication sourceName="SettleSubject.orderno4" nodeId="${workflowNodeDefId}"/> >
</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/customSingleClearView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/customSingleClearViewGen.js"></script>
...
//当前对象主键ID
var customsclearid = '${customSingleClear.customsclearid}';	
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_cancel',text:'${vt.mCancel}',handler:_cancelCustomSingleClear,iconCls:'icon-undo'},'-',
...
{id:'_showVoucher',text:'查看凭证',handler:_showVoucherCustomSingleClear,iconCls:'icon-view'},'-',
' '
],
