<%-- 
  ...
  - Date: 2010年09月19日 09点52分29秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象客户单清帐(CustomSingleClear)编辑页面
--%>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${customSingleClear.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${customSingleClear.settleSubject.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${customSingleClear.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${customSingleClear.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${customSingleClear.settleSubject.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${customSingleClear.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${customSingleClear.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${customSingleClear.settleSubject.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${customSingleClear.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${customSingleClear.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${customSingleClear.settleSubject.standardamount4}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${customSingleClear.settleSubject.rowno4}" >
</td>
</tr>
</table>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount1" name="FundFlow.amount1" value="${customSingleClear.fundFlow.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount1" name="FundFlow.standardamount1" value="${customSingleClear.fundFlow.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount3" name="FundFlow.amount3" value="${customSingleClear.fundFlow.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount3" name="FundFlow.standardamount3" value="${customSingleClear.fundFlow.standardamount3}" >
</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/customSingleClearEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/customSingleClearEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateCustomSingleClear,iconCls:'icon-table-save'},'-',
...
{id:'_voucherPreview2',text:'模拟凭证',handler:_voucherPreviewCustomSingleClear2,iconCls:'icon-view'},'-',
' '
],
