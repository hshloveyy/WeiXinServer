<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象供应商单清帐(SupplierSinglClear)管理页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearManage.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearManageGen.js"></script>
</head>
<body>
<fisc:grid divId="div_southForm" needAuthentication="true" boName="SupplierSinglClear"  url="/xdss3/singleClear/supplierSinglClearController.spr?action=queryGrid" defaultCondition="BUSINESSSTATE!='4' and BUSINESSSTATE!='-1'" editable="false" needCheckBox="true" needToolbar="true" needAutoLoad="true"   orderBySql=" YSUPPLIERSICLEAR.LASTMODIFYTIME desc"></fisc:grid>
<!-- dpPageFtlLib.ftl -->
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			...
			<input type="hidden" id="supplier.fieldName" name="supplier.fieldName" value="YSUPPLIERSICLEAR.SUPPLIER"> 
			...
			<fisc:searchHelp divId="div_supplier_sh" boName="SupplierSinglClear" boProperty="supplier" searchType="field" hiddenName="supplier.fieldValue" valueField="LIFNR" displayField="NAME1"></fisc:searchHelp>
		</td>
		...
		<td  width="40%" >
			...
			<input type="hidden" id="accountdate.fieldName" name="accountdate.fieldName" value="YSUPPLIERSICLEAR.ACCOUNTDATE"> 
	...
	<tr>
		...
		<td  width="30%" >
			...
			<input type="hidden" id="voucherdate.fieldName" name="voucherdate.fieldName" value="YSUPPLIERSICLEAR.VOUCHERDATE"> 
		...
		<td  width="40%" >
			...
			<input type="hidden" id="subject.fieldName" name="subject.fieldName" value="YSUPPLIERSICLEAR.SUBJECT"> 
			...
			<fisc:searchHelp divId="div_subject_sh" boName="SupplierSinglClear" boProperty="subject" searchType="field" hiddenName="subject.fieldValue" valueField="SAKNR" displayField="TXT20"></fisc:searchHelp>
		</td>
</tr>
<tr>
