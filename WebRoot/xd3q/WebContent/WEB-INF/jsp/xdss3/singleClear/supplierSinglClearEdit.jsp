<%-- 
  ...
  - Date: 2010年09月14日 10点01分07秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象供应商单清帐(SupplierSinglClear)编辑页面
--%>
...
<body>
<fisc:grid divId="div_unClearSupplieBill" pageSize="10000"  boName="UnClearSupplieBill" needCheckBox="true" editable="true" defaultCondition=" YUNCLEARSUPPBILL.SUPPLIERSCLEARID='${supplierSinglClear.suppliersclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
<fisc:grid divId="div_unClearPayment" pageSize="10000"  boName="UnClearPayment" needCheckBox="true" editable="true" defaultCondition=" YUNCLEARPAYMENT.SUPPLIERSCLEARID='${supplierSinglClear.suppliersclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.supplier" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.supplier}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.subject" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.subject}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.depid" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.depid}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.currencytext" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.currencytext}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.companyno" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.companyno}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.accountdate" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.voucherdate" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierSinglClear.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount1" name="FundFlow.amount1" value="${supplierSinglClear.fundFlow.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount1" name="FundFlow.standardamount1" value="${supplierSinglClear.fundFlow.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="FundFlow.amount3" name="FundFlow.amount3" value="${supplierSinglClear.fundFlow.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="FundFlow.standardamount3" name="FundFlow.standardamount3" value="${supplierSinglClear.fundFlow.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${supplierSinglClear.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${supplierSinglClear.settleSubject.standardamount1}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno1_sh" boName="SettleSubject" boProperty="orderno1" value="${supplierSinglClear.settleSubject.orderno1}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${supplierSinglClear.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${supplierSinglClear.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${supplierSinglClear.settleSubject.standardamount2}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno2_sh" boName="SettleSubject" boProperty="orderno2" value="${supplierSinglClear.settleSubject.orderno2}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${supplierSinglClear.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${supplierSinglClear.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${supplierSinglClear.settleSubject.standardamount3}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno3_sh" boName="SettleSubject" boProperty="orderno3" value="${supplierSinglClear.settleSubject.orderno3}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${supplierSinglClear.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${supplierSinglClear.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${supplierSinglClear.settleSubject.standardamount4}" >
</td>
...
<fisc:searchHelp divId="div_SettleSubjectorderno4_sh" boName="SettleSubject" boProperty="orderno4" value="${supplierSinglClear.settleSubject.orderno4}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${supplierSinglClear.settleSubject.rowno4}" >
</td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClear/supplierSinglClearEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateSupplierSinglClear,iconCls:'icon-table-save'},'-',
...
{id:'_voucherPreview2',text:'模拟凭证2',handler:_voucherPreviewSupplierSinglClear2,iconCls:'icon-view'},'-',
' '
],
