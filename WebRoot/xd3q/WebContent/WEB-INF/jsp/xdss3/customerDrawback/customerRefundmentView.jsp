<%-- 
  ...
  - Date: 2010年07月05日 16点15分59秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象客户退款(CustomerRefundment)查看页面
--%>
...
<body>
<fisc:grid divId="div_customerDbBankItem" boName="CustomerDbBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YREFUNDBANKITEM.REFUNDMENTID='${customerRefundment.refundmentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_customerRefundItem" boName="CustomerRefundItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YREFUNDMENTITEM.REFUNDMENTID='${customerRefundment.refundmentid}'" needAutoLoad="true" height="285" nameSapceSupport="true"  pageSize="10000"></fisc:grid>
<fisc:attachement businessId="${businessId}" allowDelete="false" allowUpload="false" divId="div_attachement" boName="CustomerRefundment" boProperty="attachement" gridPageSize="10" gridHeight="285" ></fisc:attachement>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.customer" nodeId="${workflowNodeDefId}"/> >${vt.property.customer}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.text" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.text}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td  width="40%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.cashflowitem" nodeId="${workflowNodeDefId}"/> >${vt.property.cashflowitem}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomerRefundment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/xdss3/customerDrawback/customerRefundmentView.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/xdss3/customerDrawback/customerRefundmentViewGen.js"></script>
...
Ext.onReady(function(){
	...
	//2010-10-11 HONGJJ 隐藏"重分配提交"按钮
	//2010-10-12 HONGJJ 隐藏"预览凭证"按钮
