<%-- 
  ...
  - Date: 2010年07月05日 16点15分57秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象客户退款(CustomerRefundment)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="CustomerRefundment.exchangerate" nodeId="${workflowNodeDefId}"/> >${vt.property.exchangerate}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td   width="40%" >
			...
			<fisc:searchHelp divId="div_dept_id_sh" boName="CustomerRefundment" boProperty="dept_id" value="${userDeptid}"></fisc:searchHelp>
		</td>
		...
		<td   width="40%" >
			...
			<fisc:searchHelp divId="div_cashflowitem_sh" boName="CustomerRefundment" boProperty="cashflowitem" value="${cashFlowItem}"></fisc:searchHelp>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td  width="30%" >
		    <input type="text" class="inputText" id="CustomerRefundment.createtime" name="CustomerRefundment.createtime" value="${customerRefundment.createtime}"  readonly="readonly" <fisc:authentication sourceName="CustomerRefundment.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
	...
	<input type="hidden" id="CustomerRefundment.businessstate" name="CustomerRefundment.businessstate" value="0">
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/customerDrawback/customerRefundmentAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/customerDrawback/customerRefundmentAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateCustomerRefundment',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateCustomerRefundment,iconCls:'icon-table-save'},'-',
<%
Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessCustomerRefundment,disabled:true,iconCls:'task'},'-',					
<%}%>	
					{id:'_cancel',text:'${vt.mCancel}',handler:_cancel,iconCls:'icon-undo'},'-',
					{id:'_submitForReassign',text:'重分配提交 ',handler:_submitForReassignCustomerRefundment,disabled:true,iconCls:'task'},'-',
					' '],  
