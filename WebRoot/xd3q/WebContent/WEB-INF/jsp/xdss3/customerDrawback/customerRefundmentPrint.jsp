...
<TR><TD></TD><TD><DIV id="page1">
     <table border="0" cellpadding="4" cellspacing="1" class="datatable" align="center">
       ...
       <tr><td align="center" colspan="2"><font size="6">信达股份有限公司退款审批单</font></td></tr>
       <tr><td>申请时间：&nbsp;&nbsp;${main.createtime}</td><td align="right">退款单号：${main.refundmentno}&nbsp;&nbsp;</td></tr>
       <tr><td colspan="2">
		<table width="700" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable" align="center">
			<tr>
				...
				<td align="center" width="60">退款形式</td>
				...
				<%--end 
				     ...
				     yanghancai 2010-09-25 收款形式转换--%>
				     </font>
				</td>
			</tr>
			<tr>
				<td align="center" width="60" height="100">退<br>款<br>用<br>途</td>
				<td colspan="7" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;
					${main.text}<br>&nbsp;&nbsp;&nbsp;&nbsp;${main.remark}
				</td>
			</tr>
			<tr>
				<td align="center" width="60" height="25">退款单位及名称</td>
				<td align="left" width="200" colspan="3">
					&nbsp;&nbsp;${customerName}
				</td>
				<td align="center" width="60">开户银行及帐号</td>
				<td align="left" width="200" colspan="3">
					&nbsp;&nbsp;${main.collectbankname}<br>
					&nbsp;&nbsp;${main.collectbankacc}
				</td>
			</tr>
			<tr>
				<td align="center" width="60" height="25">退款金额</td>
