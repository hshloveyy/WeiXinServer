...
<body>
<fisc:grid divId="div_voucherItem" boName="VoucherItem" needCheckBox="true" editable="true" defaultCondition=" YVOUCHERITEM.VOUCHERID='${voucher.voucherid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
{id:'_genVoucher',text:'生成凭证',handler:_genVoucherVoucher,iconCls:'icon-method'},'-',
' '
],
