<%-- 
  ...
  - Date: 2010年05月28日 11点05分02秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象客户代垫额度和发货额度配置(CustomerCreditConf)增加页面
--%>
...
<body>
<fisc:grid divId="div_customerCreditProj" boName="CustomerCreditProj" needCheckBox="true" editable="true" defaultCondition=" YCUSTCREDPROJ.CONFIGID='${customerCreditConf.configid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid><div id="div_toolbar" class="x-hide-display"></div>
<div id="div_center" class="x-hide-display"> 
<form id="mainForm" name="mainForm" class="search">
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.customerid" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.customerid}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.credittype" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.credittype}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.prepayvalue" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.prepayvalue}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.sendvalue" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.sendvalue}：</td>
		<td   width="40%" >
	...
	<tr>
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.startingtime" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.startingtime}：</td>
		<td  width="30%" >
		...
		<td align="right"  width="15%" <fisc:authentication sourceName="CustomerCreditConf.endtime" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.endtime}：</td>
		<td   width="40%" >
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditConfAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditConfAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateCustomerCreditConf',text:'${vt.mSaveOrUpdate}',handler:_check_save,iconCls:'icon-table-save'},'-',
