<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象客户代垫额度和发货额度配置(CustomerCreditConf)编辑页面
--%>
...
<body>
<fisc:grid divId="div_customerCreditProj" boName="CustomerCreditProj" needCheckBox="true" editable="true" defaultCondition=" YCUSTCREDPROJ.CONFIGID='${customerCreditConf.configid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditConfEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditConfEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_check_save,iconCls:'icon-table-save'},'-',
