<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象供应商授限立项配置(ProviderCreditProj)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditProjEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditProjEditGen.js"></script>
</head>
<body>
