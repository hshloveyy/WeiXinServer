<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象供应商授限立项配置(ProviderCreditProj)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditProjAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditProjAddGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%" >
			...
			<fisc:searchHelp divId="div_projectid_sh" boName="ProviderCreditProj" boProperty="projectid" 
				value="${providerCreditProj.projectid}" defaultCondition=" DEPT_ID in (SELECT dept_id FROM t_sys_dept_user WHERE user_id = '${userId}' UNION SELECT DEPT_ID FROM T_SYS_USER_MANAGER_DEPT WHERE USER_ID = '${userId}')  "></fisc:searchHelp>
		</td>
	      <td></td><td></td>
		</tr>
<input type="hidden" id="ProviderCreditProj.configprojectid" name="ProviderCreditProj.configprojectid" value="">
<input type="hidden" id="ProviderCreditProj.projectno" name="ProviderCreditProj.projectno" value="">
