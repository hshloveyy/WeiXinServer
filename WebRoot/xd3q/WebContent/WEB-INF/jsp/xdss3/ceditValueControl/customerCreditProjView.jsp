<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象客户信用额度下挂立项配置表(CustomerCreditProj)查看页面
--%>
...
<title>客户信用额度下挂立项配置表查看页面</title>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditProjView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditProjViewGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
		...
		<td width="30%" >
			...
			<fisc:searchHelp divId="div_projectid_sh" boName="CustomerCreditProj" boProperty="projectid" value="${customerCreditProj.projectid}"></fisc:searchHelp>
		</td>
	</tr>
