<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象供应商信用额度配置(ProviderCreditConf)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditConfEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/providerCreditConfEditGen.js"></script>
</head>
<body>
<fisc:grid divId="div_providerCreditProj" boName="ProviderCreditProj" needCheckBox="true" editable="true" defaultCondition=" YPROVCREDPROJ.CONFIGID='${providerCreditConf.configid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
