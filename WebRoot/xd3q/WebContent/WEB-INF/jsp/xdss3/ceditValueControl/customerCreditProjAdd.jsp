<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象客户信用额度下挂立项配置表(CustomerCreditProj)增加页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditProjAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/ceditValueControl/customerCreditProjAddGen.js"></script>
</head>
<body>
