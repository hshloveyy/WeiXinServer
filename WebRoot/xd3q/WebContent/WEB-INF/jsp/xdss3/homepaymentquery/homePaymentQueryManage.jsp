<%-- 
  ...
  - Date: 2010年10月01日 06点51分14秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象内贸付款查询(HomePaymentQuery)管理页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/homepaymentquery/homePaymentQueryManage.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/homepaymentquery/homePaymentQueryManageGen.js"></script>
</head>
<body>
<fisc:grid divId="div_southForm" 
		   boName="HomePaymentQuery"  
		   editable="false" 
		   needCheckBox="true" 
		   needToolbar="true" 
		   needAutoLoad="true" 
		   needAuthentication="true"  
		   defaultCondition=" TRADE_TYPE='01'"></fisc:grid>
<!-- dpPageFtlLib.ftl -->
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			...
			<fisc:dictionary hiddenName="paymenttype.fieldValue" dictionaryName="YDHOMEPAYMENTTYPE" divId="div_paymenttype_dict" isNeedAuth="false"  ></fisc:dictionary>
		</td>
	...
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="paymentno.fieldValue" name="paymentno.fieldValue" value="" <fisc:authentication sourceName="HomePaymentQuery.paymentno" taskId=""/>>
	...
	<tr>
		...
		<td  width="30%" >
			...
			<fisc:searchHelp divId="div_dept_id_sh" boName="HomePaymentQuery" boProperty="dept_id" searchType="field" hiddenName="dept_id.fieldValue" valueField="ORGANIZATIONID" displayField="ORGANIZATIONNAME"></fisc:searchHelp>
		</td>
		...
		<td  width="40%" >
			...
			<fisc:searchHelp divId="div_supplier_sh" boName="HomePaymentQuery" boProperty="supplier" searchType="field" hiddenName="supplier.fieldValue" valueField="LIFNR" displayField="NAME1"></fisc:searchHelp>
		</td>
</tr>
	<tr>
