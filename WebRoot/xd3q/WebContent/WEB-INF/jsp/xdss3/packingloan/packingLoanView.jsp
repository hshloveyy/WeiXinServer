...
<body>
<fisc:grid divId="div_packingBankItem" boName="PackingBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPACKINGBANKITEM.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_packingReBankItem" boName="PackingReBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" yPackingReBank.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_packingReBankTwo" boName="PackingReBankTwo" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPACKINGREBANK.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.packing_no" nodeId="${workflowNodeDefId}"/> >${vt.property.packing_no}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.creditrecdate" nodeId="${workflowNodeDefId}"/> >${vt.property.creditrecdate}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td  width="30%" >
			...
			<fisc:searchHelp divId="div_creditno_sh" boName="PackingLoan" boProperty="creditno"  value="${packingLoan.creditno}"></fisc:searchHelp>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.contractno" nodeId="${workflowNodeDefId}"/> >${vt.property.contractno}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.createbank" nodeId="${workflowNodeDefId}"/> >${vt.property.createbank}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.currency" nodeId="${workflowNodeDefId}"/> >${vt.property.currency}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.applyamount" nodeId="${workflowNodeDefId}"/> >${vt.property.applyamount}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.dealine" nodeId="${workflowNodeDefId}"/> >${vt.property.dealine}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.mature" nodeId="${workflowNodeDefId}"/> >${vt.property.mature}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.dealdate" nodeId="${workflowNodeDefId}"/> >${vt.property.dealdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.interestrate" nodeId="${workflowNodeDefId}"/> >${vt.property.interestrate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.packingreate" nodeId="${workflowNodeDefId}"/> >${vt.property.packingreate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.clearvendorvalue" nodeId="${workflowNodeDefId}"/> >${vt.property.clearvendorvalue}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.repackingreate" nodeId="${workflowNodeDefId}"/> >${vt.property.repackingreate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.text" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.text}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.revoucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.revoucherdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.reaccountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.reaccountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.retext" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.retext}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		    <input type="text" class="inputText" id="PackingLoan.createtime" name="PackingLoan.createtime" value="${packingLoan.createtime}"  readonly="readonly">
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td  width="40%">
			<fisc:user boProperty="creator" boName="PackingLoan" userId="${packingLoan.creator}"></fisc:user>
		</td>
	</tr>
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="PackingLoan.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td width="30%">
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/packingloan/packingLoanView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/packingloan/packingLoanViewGen.js"></script>
...
//当前对象主键ID
var packingid = '${packingLoan.packingid}';	
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
{id:'_copyCreate',text:'${vt.mCopyCreate}',handler:_copyCreatePackingLoan,iconCls:'icon-copyCreate'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createPackingLoan,iconCls:'icon-add'},'-',
'->','-',
{id:'_cancel',text:'${vt.mCancel}',handler:_cancelPackingLoan,iconCls:'icon-undo'},'-',
<%
Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessPackingLoan,iconCls:'task'},'-',
<%}%>
