...
<body>
<fisc:grid divId="div_packingBankItem" boName="PackingBankItem" needCheckBox="true" editable="true" defaultCondition=" YPACKINGBANKITEM.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_packingReBankItem" boName="PackingReBankItem" needCheckBox="true" editable="true" defaultCondition=" yPackingReBank.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_packingReBankTwo" boName="PackingReBankTwo" needCheckBox="true" editable="true" defaultCondition=" YPACKINGREBANK.PACKINGID='${packingLoan.packingid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%">
			<input type="text" class="inputText" id="PackingLoan.packing_no" name="PackingLoan.packing_no" value="${packingLoan.packing_no}"   readonly="readonly" <fisc:authentication sourceName="PackingLoan.packing_no" nodeId="${workflowNodeDefId}"/>>
		</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${packingLoan.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${packingLoan.settleSubject.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${packingLoan.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${packingLoan.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${packingLoan.settleSubject.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${packingLoan.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${packingLoan.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${packingLoan.settleSubject.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${packingLoan.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${packingLoan.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${packingLoan.settleSubject.standardamount4}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${packingLoan.settleSubject.rowno4}" >
</td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/packingloan/packingLoanEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/packingloan/packingLoanEditGen.js"></script>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deletePackingLoan,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createPackingLoan,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdatePackingLoan,iconCls:'icon-table-save'},'-',
...
<%}%>
{id:'_cashJournal',text:'现金日记帐',handler:_cashJournalPackingLoan,iconCls:' '},'-',
{id:'_voucherPreview',text:'模拟凭证',handler:_voucherPreviewPackingLoan,iconCls:' '},'-',
' '
],
