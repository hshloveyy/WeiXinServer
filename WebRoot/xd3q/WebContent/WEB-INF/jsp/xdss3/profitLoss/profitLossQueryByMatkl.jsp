...
<fisc:grid divId="div_southForm" 
		   ...
		   handlerClass="com.infolion.xdss3.profitLoss.web.ProfitLossMatklGrid"
 		   whereSql="" 
 		   needCheckBox="true"
 		   needAutoLoad="false"
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/profitLoss/profitLossQueryByMatkl.js"></script>
