<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象其他公司客户单清帐(CustomSingleOther)查看页面
--%>
...
<body>
<fisc:grid divId="div_unCustomBillOther" boName="UnCustomBillOther" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNCUSTBILLOTHER.CUSTOMSCLEARID='${customSingleOther.customsclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" orderBySql=" YUNCUSTBILLOTHER.BWBJE ,YUNCUSTBILLOTHER.UNBWBJE " title="借贷" ></fisc:grid>
<fisc:grid divId="div_unCleaCollectOther" boName="UnCleaCollectOther" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNCOLLECTOTHER.CUSTOMSCLEARID='${customSingleOther.customsclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.custom" nodeId="${workflowNodeDefId}"/> >${vt.property.custom}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.subject" nodeId="${workflowNodeDefId}"/> >${vt.property.subject}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.currencytext" nodeId="${workflowNodeDefId}"/> >${vt.property.currencytext}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.companyno" nodeId="${workflowNodeDefId}"/> >${vt.property.companyno}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.text" nodeId="${workflowNodeDefId}"/> >${vt.property.text}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.remark" nodeId="${workflowNodeDefId}"/> >${vt.property.remark}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="CustomSingleOther" userId="${customSingleOther.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
			<input type="text" id="CustomSingleOther.createtime" name="CustomSingleOther.createtime" value="">
				<fisc:calendar applyTo="CustomSingleOther.createtime"  divId="" fieldName="" defaultValue="${customSingleOther.createtime}"></fisc:calendar>
		</td>
	</tr>
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="CustomSingleOther.customclearno" nodeId="${workflowNodeDefId}"/> >${vt.property.customclearno}：</td>
		<td width="30%">
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherViewGen.js"></script>
...
{id:'_viewVoucher',text:'查看凭证',handler:_viewVoucherCustomSingleOther,iconCls:' '},'-',
' '
],
