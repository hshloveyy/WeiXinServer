<%-- 
  ...
  - Date: 2012年06月11日 09点32分21秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象其他公司供应商单清帐(SupplierSinglOther)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="SupplierSinglOther.supplierclearno" name="SupplierSinglOther.supplierclearno" value="${supplierSinglOther.supplierclearno}" <fisc:authentication sourceName="SupplierSinglOther.supplierclearno" nodeId="${workflowNodeDefId}"/>  readonly="readonly">
		</td>
        <td></td>
        <td></td>
	</tr>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.debtcredit1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.debtcredit1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.amount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.amount1}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount1" name="SettleSubjectOther.amount1" value="${supplierSinglOther.settleSubjectOther.amount1}" <fisc:authentication sourceName="SettleSubjectOther.amount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.standardamount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.standardamount1}：</td>
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount1" name="SettleSubjectOther.standardamount1" value="${supplierSinglOther.settleSubjectOther.standardamount1}" <fisc:authentication sourceName="SettleSubjectOther.standardamount1" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.settlesubject1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.settlesubject1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.costcenter1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.costcenter1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.depid1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.depid1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.orderno1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.orderno1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.rowno1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.rowno1}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno1" name="SettleSubjectOther.rowno1" value="${supplierSinglOther.settleSubjectOther.rowno1}" <fisc:authentication sourceName="SettleSubjectOther.rowno1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.antiaccount1" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.antiaccount1}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.debtcredit2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.debtcredit2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.amount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.amount2}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount2" name="SettleSubjectOther.amount2" value="${supplierSinglOther.settleSubjectOther.amount2}" <fisc:authentication sourceName="SettleSubjectOther.amount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.standardamount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.standardamount2}：</td>
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount2" name="SettleSubjectOther.standardamount2" value="${supplierSinglOther.settleSubjectOther.standardamount2}" <fisc:authentication sourceName="SettleSubjectOther.standardamount2" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.settlesubject2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.settlesubject2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.costcenter2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.costcenter2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.depid2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.depid2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.orderno2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.orderno2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.rowno2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.rowno2}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno2" name="SettleSubjectOther.rowno2" value="${supplierSinglOther.settleSubjectOther.rowno2}" <fisc:authentication sourceName="SettleSubjectOther.rowno2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.antiaccount2" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.antiaccount2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.amount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.amount3}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount3" name="SettleSubjectOther.amount3" value="${supplierSinglOther.settleSubjectOther.amount3}" <fisc:authentication sourceName="SettleSubjectOther.amount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.debtcredit3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.debtcredit3}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.standardamount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.standardamount3}：</td>
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount3" name="SettleSubjectOther.standardamount3" value="${supplierSinglOther.settleSubjectOther.standardamount3}" <fisc:authentication sourceName="SettleSubjectOther.standardamount3" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.settlesubject3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.settlesubject3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.costcenter3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.costcenter3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.depid3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.depid3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.orderno3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.orderno3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.rowno3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.rowno3}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno3" name="SettleSubjectOther.rowno3" value="${supplierSinglOther.settleSubjectOther.rowno3}" <fisc:authentication sourceName="SettleSubjectOther.rowno3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.antiaccount3" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.antiaccount3}：</td>
<td width="30%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.debtcredit4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.debtcredit4}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.amount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.amount4}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount4" name="SettleSubjectOther.amount4" value="${supplierSinglOther.settleSubjectOther.amount4}" <fisc:authentication sourceName="SettleSubjectOther.amount4" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.standardamount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.standardamount4}：</td>
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount4" name="SettleSubjectOther.standardamount4" value="${supplierSinglOther.settleSubjectOther.standardamount4}" <fisc:authentication sourceName="SettleSubjectOther.standardamount4" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.settlesubject4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.settlesubject4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.profitcenter" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.profitcenter}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.depid4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.depid4}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.orderno4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.orderno4}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.rowno4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.rowno4}：</td>
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno4" name="SettleSubjectOther.rowno4" value="${supplierSinglOther.settleSubjectOther.rowno4}" <fisc:authentication sourceName="SettleSubjectOther.rowno4" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="SettleSubjectOther.antiaccount4" nodeId="${workflowNodeDefId}"/> >${settleSubjectOtherVt.property.antiaccount4}：</td>
<td width="30%" >
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.debtcredit1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.debtcredit1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.amount1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.amount1}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount1" name="FundFlowOther.amount1" value="${supplierSinglOther.fundFlowOther.amount1}" <fisc:authentication sourceName="FundFlowOther.amount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.standardamount1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.standardamount1}：</td>
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount1" name="FundFlowOther.standardamount1" value="${supplierSinglOther.fundFlowOther.standardamount1}" <fisc:authentication sourceName="FundFlowOther.standardamount1" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.specialaccount1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.specialaccount1}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount1" name="FundFlowOther.specialaccount1" value="${supplierSinglOther.fundFlowOther.specialaccount1}" <fisc:authentication sourceName="FundFlowOther.specialaccount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.customer1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.customer1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.depid1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.depid1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.antiaccount1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.antiaccount1}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.supplier1" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.supplier1}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.debtcredit2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.debtcredit2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.amount2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.amount2}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount2" name="FundFlowOther.amount2" value="${supplierSinglOther.fundFlowOther.amount2}" <fisc:authentication sourceName="FundFlowOther.amount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.standardamount2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.standardamount2}：</td>
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount2" name="FundFlowOther.standardamount2" value="${supplierSinglOther.fundFlowOther.standardamount2}" <fisc:authentication sourceName="FundFlowOther.standardamount2" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.specialaccount2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.specialaccount2}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount2" name="FundFlowOther.specialaccount2" value="${supplierSinglOther.fundFlowOther.specialaccount2}" <fisc:authentication sourceName="FundFlowOther.specialaccount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.customer2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.customer2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.depid2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.depid2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.antiaccount2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.antiaccount2}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.supplier2" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.supplier2}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.debtcredit3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.debtcredit3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.amount3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.amount3}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount3" name="FundFlowOther.amount3" value="${supplierSinglOther.fundFlowOther.amount3}" <fisc:authentication sourceName="FundFlowOther.amount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.standardamount3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.standardamount3}：</td>
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount3" name="FundFlowOther.standardamount3" value="${supplierSinglOther.fundFlowOther.standardamount3}" <fisc:authentication sourceName="FundFlowOther.standardamount3" nodeId="${workflowNodeDefId}"/>>
</td>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.specialaccount3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.specialaccount3}：</td>
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount3" name="FundFlowOther.specialaccount3" value="${supplierSinglOther.fundFlowOther.specialaccount3}" <fisc:authentication sourceName="FundFlowOther.specialaccount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.customer3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.customer3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.depid3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.depid3}：</td>
<td width="40%" >
...
<tr>
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.antiaccount3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.antiaccount3}：</td>
<td width="30%" >
...
<td align="right" width="15%" <fisc:authentication sourceName="FundFlowOther.supplier3" nodeId="${workflowNodeDefId}"/> >${fundFlowOtherVt.property.supplier3}：</td>
<td width="40%" >
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/supplierSinglOtherAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/supplierSinglOtherAddGen.js"></script>
