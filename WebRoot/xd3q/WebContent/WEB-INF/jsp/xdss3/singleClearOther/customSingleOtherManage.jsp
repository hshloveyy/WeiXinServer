<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象其他公司客户单清帐(CustomSingleOther)管理页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherManage.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherManageGen.js"></script>
</head>
<body>
<fisc:grid divId="div_southForm" boName="CustomSingleOther"  url="/xdss3/singleClearOther/customSingleOtherController.spr?action=queryGrid"  editable="false" needCheckBox="true" needToolbar="true" needAutoLoad="true" defaultCondition="YCUSTOMCLEAROTHE.BUSINESSSTATE!='3' and YCUSTOMCLEAROTHE.BUSINESSSTATE!='-1'"  orderBySql=" YCUSTOMCLEAROTHE.LASTMODIFYTIME desc" ></fisc:grid>
<!-- dpPageFtlLib.ftl -->
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			...
			<input type="hidden" id="custom.fieldName" name="custom.fieldName" value="YCUSTOMCLEAROTHE.CUSTOM"> 
			...
			<fisc:searchHelp divId="div_custom_sh" boName="CustomSingleOther" boProperty="custom" searchType="field" hiddenName="custom.fieldValue" valueField="KUNNR" displayField="NAME1"></fisc:searchHelp>
		</td>
		...
		<td  width="40%" >
			...
			<input type="hidden" id="accountdate.fieldName" name="accountdate.fieldName" value="YCUSTOMCLEAROTHE.ACCOUNTDATE"> 
	...
	<tr>
		...
		<td  width="30%" >
			...
			<input type="hidden" id="voucherdate.fieldName" name="voucherdate.fieldName" value="YCUSTOMCLEAROTHE.VOUCHERDATE"> 
		...
		<td  width="40%" >
			...
			<input type="hidden" id="subject.fieldName" name="subject.fieldName" value="YCUSTOMCLEAROTHE.SUBJECT"> 
			...
			<fisc:searchHelp divId="div_subject_sh" boName="CustomSingleOther" boProperty="subject" searchType="field" hiddenName="subject.fieldValue" valueField="SAKNR" displayField="TXT20"></fisc:searchHelp>
		</td>
</tr>
<tr>
