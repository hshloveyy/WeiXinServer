<%-- 
  ...
  - Date: 2012年06月11日 09点24分57秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象其他公司客户单清帐(CustomSingleOther)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="CustomSingleOther.customclearno" name="CustomSingleOther.customclearno" value="${customSingleOther.customclearno}" <fisc:authentication sourceName="CustomSingleOther.customclearno" nodeId="${workflowNodeDefId}"/>  readonly="readonly">
		</td>
        <td></td>
        <td></td>
	</tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount1" name="SettleSubjectOther.amount1" value="${customSingleOther.settleSubjectOther.amount1}" <fisc:authentication sourceName="SettleSubjectOther.amount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount1" name="SettleSubjectOther.standardamount1" value="${customSingleOther.settleSubjectOther.standardamount1}" <fisc:authentication sourceName="SettleSubjectOther.standardamount1" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno1" name="SettleSubjectOther.rowno1" value="${customSingleOther.settleSubjectOther.rowno1}" <fisc:authentication sourceName="SettleSubjectOther.rowno1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount2" name="SettleSubjectOther.amount2" value="${customSingleOther.settleSubjectOther.amount2}" <fisc:authentication sourceName="SettleSubjectOther.amount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount2" name="SettleSubjectOther.standardamount2" value="${customSingleOther.settleSubjectOther.standardamount2}" <fisc:authentication sourceName="SettleSubjectOther.standardamount2" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno2" name="SettleSubjectOther.rowno2" value="${customSingleOther.settleSubjectOther.rowno2}" <fisc:authentication sourceName="SettleSubjectOther.rowno2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount3" name="SettleSubjectOther.amount3" value="${customSingleOther.settleSubjectOther.amount3}" <fisc:authentication sourceName="SettleSubjectOther.amount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount3" name="SettleSubjectOther.standardamount3" value="${customSingleOther.settleSubjectOther.standardamount3}" <fisc:authentication sourceName="SettleSubjectOther.standardamount3" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno3" name="SettleSubjectOther.rowno3" value="${customSingleOther.settleSubjectOther.rowno3}" <fisc:authentication sourceName="SettleSubjectOther.rowno3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.amount4" name="SettleSubjectOther.amount4" value="${customSingleOther.settleSubjectOther.amount4}" <fisc:authentication sourceName="SettleSubjectOther.amount4" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="SettleSubjectOther.standardamount4" name="SettleSubjectOther.standardamount4" value="${customSingleOther.settleSubjectOther.standardamount4}" <fisc:authentication sourceName="SettleSubjectOther.standardamount4" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="SettleSubjectOther.rowno4" name="SettleSubjectOther.rowno4" value="${customSingleOther.settleSubjectOther.rowno4}" <fisc:authentication sourceName="SettleSubjectOther.rowno4" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount1" name="FundFlowOther.amount1" value="${customSingleOther.fundFlowOther.amount1}" <fisc:authentication sourceName="FundFlowOther.amount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount1" name="FundFlowOther.standardamount1" value="${customSingleOther.fundFlowOther.standardamount1}" <fisc:authentication sourceName="FundFlowOther.standardamount1" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount1" name="FundFlowOther.specialaccount1" value="${customSingleOther.fundFlowOther.specialaccount1}" <fisc:authentication sourceName="FundFlowOther.specialaccount1" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount2" name="FundFlowOther.amount2" value="${customSingleOther.fundFlowOther.amount2}" <fisc:authentication sourceName="FundFlowOther.amount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount2" name="FundFlowOther.standardamount2" value="${customSingleOther.fundFlowOther.standardamount2}" <fisc:authentication sourceName="FundFlowOther.standardamount2" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount2" name="FundFlowOther.specialaccount2" value="${customSingleOther.fundFlowOther.specialaccount2}" <fisc:authentication sourceName="FundFlowOther.specialaccount2" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.amount3" name="FundFlowOther.amount3" value="${customSingleOther.fundFlowOther.amount3}" <fisc:authentication sourceName="FundFlowOther.amount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="FundFlowOther.standardamount3" name="FundFlowOther.standardamount3" value="${customSingleOther.fundFlowOther.standardamount3}" <fisc:authentication sourceName="FundFlowOther.standardamount3" nodeId="${workflowNodeDefId}"/>>
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="FundFlowOther.specialaccount3" name="FundFlowOther.specialaccount3" value="${customSingleOther.fundFlowOther.specialaccount3}" <fisc:authentication sourceName="FundFlowOther.specialaccount3" nodeId="${workflowNodeDefId}"/>>
</td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/customSingleOtherAddGen.js"></script>
