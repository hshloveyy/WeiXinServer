<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象其他公司供应商单清帐(SupplierSinglOther)查看页面
--%>
...
<body>
<fisc:grid divId="div_unSupplieBillOther" boName="UnSupplieBillOther" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNSUPPBILLOTHER.SUPPLIERSCLEARID='${supplierSinglOther.suppliersclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
<fisc:grid divId="div_unCleaPaymentOther" boName="UnCleaPaymentOther" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YUNPAYMENTOTHER.SUPPLIERSCLEARID='${supplierSinglOther.suppliersclearid}'" needAutoLoad="true" height="285" nameSapceSupport="true" title="借贷" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.supplier" nodeId="${workflowNodeDefId}"/> >${vt.property.supplier}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.subject" nodeId="${workflowNodeDefId}"/> >${vt.property.subject}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.currencytext" nodeId="${workflowNodeDefId}"/> >${vt.property.currencytext}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.companyno" nodeId="${workflowNodeDefId}"/> >${vt.property.companyno}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.depid" nodeId="${workflowNodeDefId}"/> >${vt.property.depid}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.text" nodeId="${workflowNodeDefId}"/> >${vt.property.text}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.remark" nodeId="${workflowNodeDefId}"/> >${vt.property.remark}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.supplierclearno" nodeId="${workflowNodeDefId}"/> >${vt.property.supplierclearno}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="SupplierSinglOther" userId="${supplierSinglOther.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierSinglOther.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/supplierSinglOtherView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/singleClearOther/supplierSinglOtherViewGen.js"></script>
...
{id:'_viewVoucher',text:'查看凭证',handler:_viewVoucherSupplierSinglOther,iconCls:' '},'-',
' '
],
