...
<html>
<head>
<title>客户清账明细查询</title>
</head>
<body>

	<fisc:grid 
		   divId="UnClearCustomBill" 
		   pageSize="10000" 
		   tableName="YUNCLEARCUSTBILL "
		   handlerClass="com.infolion.xdss3.unclearQuery.domain.UnClearCustomBillQueryGrid"
 		   whereSql="" 
 		   needCheckBox="false"
 		   height="400"
	...
	<form id="mainForm" name="mainForm">
		<table border="0">
			...
			<tr>
				...
				<td>
					...
					<fisc:searchHelp divId="div_custom_sh" searchHelpName="YHGETKUNNR" boName="" boProperty="" searchType="field" hiddenName="KUNNR" valueField="KUNNR" displayField="NAME1"></fisc:searchHelp>
				</td>
				<td width="20%" align="left"></td>
  	...
  	<div id="UnClearCustomBill" ></div>
</body>
</html>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unclearquery/unClearCustomBillQuery.js"></script>
