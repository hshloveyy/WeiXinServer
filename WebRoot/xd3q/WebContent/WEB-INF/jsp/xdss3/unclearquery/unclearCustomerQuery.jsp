...
<body>
	...
	<fisc:grid 
		   divId="UnclearCustomer" 
		   pageSize="10" 
		   tableName="YCUSTOMERTITLE "
		   handlerClass="com.infolion.xdss3.unclearQuery.domain.UnclearCustomerQueryGrid"
 		   whereSql="" 
 		   needCheckBox="false"
 		   height="400"
	...
	<form id="mainForm" name="mainForm">
		<table border="0">
			...
			<tr>
				...
				<td>
					...
					-->
					<fisc:searchHelp divId="div_custom_sh" searchHelpName="YHGETKUNNR" boName="" boProperty="" searchType="field" hiddenName="KUNNR.fieldValue" valueField="KUNNR" displayField="NAME1"></fisc:searchHelp>
				</td>
				<td width="20%" align="left"></td>
  	...
  	<div id="UnclearCustomer" ></div>
</body>
</html>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unclearquery/unclearCustomerQuery.js"></script>
