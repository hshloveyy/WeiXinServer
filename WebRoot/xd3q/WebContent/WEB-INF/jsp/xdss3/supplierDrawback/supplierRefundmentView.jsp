<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象供应商退款(SupplierRefundment)查看页面
--%>
...
<body>
<fisc:grid divId="div_supplierDbBankItem" boName="SupplierDbBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YREFUNDBANKITEM.REFUNDMENTID='${supplierRefundment.refundmentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_supplierRefundItem" boName="SupplierRefundItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YREFUNDMENTITEM.REFUNDMENTID='${supplierRefundment.refundmentid}'" needAutoLoad="true" height="285" nameSapceSupport="true"  pageSize="10000"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.supplier" nodeId="${workflowNodeDefId}"/> >${vt.property.supplier}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="SupplierRefundment.exchangerate" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.exchangerate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td  width="40%">
			<div id="div_dept_id_sh"></div>
			<fisc:searchHelp divId="div_dept_id_sh" boName="SupplierRefundment" boProperty="dept_id"  value="${supplierRefundment.dept_id}"></fisc:searchHelp>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.cashflowitem" nodeId="${workflowNodeDefId}"/> >${vt.property.cashflowitem}：</td>
		<td  width="40%">
			<div id="div_cashflowitem_sh"></div>
			<fisc:searchHelp divId="div_cashflowitem_sh" boName="SupplierRefundment" boProperty="cashflowitem"  value="${supplierRefundment.cashflowitem}"></fisc:searchHelp>
		</td>
	</tr>
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		    <input type="text" class="inputText" id="SupplierRefundment.createtime" name="SupplierRefundment.createtime" value="${supplierRefundment.createtime}"  readonly="readonly">
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="SupplierRefundment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
	...
	<input type="hidden" id="SupplierRefundment.businessstate" name="SupplierRefundment.businessstate" value="${supplierRefundment.businessstate}">	
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/supplierDrawback/supplierRefundmentView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/supplierDrawback/supplierRefundmentViewGen.js"></script>
...
//当前对象主键ID
var refundmentid = '${supplierRefundment.refundmentid}';	
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_cancel',text:'${vt.mCancel}',handler:_cancelSupplierRefundment,iconCls:'icon-undo'},'-',
<%
Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessSupplierRefundment,iconCls:'task'},'-',
<%}%>
],
