<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象供应商退款(SupplierRefundment)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/supplierDrawback/supplierRefundmentEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/supplierDrawback/supplierRefundmentEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateSupplierRefundment,iconCls:'icon-table-save'},'-',
...
<%}%>
{id:'_cashJournal',text:'现金日记账',handler:_cashJournalSupplierRefundment,iconCls:' '},'-',
{id:'_preview',text:'模拟凭证',handler:_previewSupplierRefundment,iconCls:'icon-view'},'-',
{id:'_submitForReassign',text:'重分配提交 ',handler:_submitForReassignSupplierRefundment,iconCls:'task'},'-',
{id:'_prepConfirm',text:'预确认',handler:_prepConfirmSupplierRefundment,iconCls:'task'},'-',
