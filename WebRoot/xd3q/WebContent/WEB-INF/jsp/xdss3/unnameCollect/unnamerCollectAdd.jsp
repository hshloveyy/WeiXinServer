<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象未明户收款(UnnamerCollect)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td  width="30%" >
		    <input type="text" class="inputText" id="UnnamerCollect.createtime" name="UnnamerCollect.createtime" value="${unnamerCollect.createtime}"  readonly="readonly" <fisc:authentication sourceName="UnnamerCollect.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
		...
		<td   width="40%" >
			...
			<fisc:searchHelp divId="div_deptid_sh" boName="UnnamerCollect" boProperty="deptid" value="FEDEF1AE-F8DD-483D-8260-971A46CF0389" editable="false"></fisc:searchHelp>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td   width="40%" >
			...
			<fisc:searchHelp divId="div_cashflowitem_sh" boName="UnnamerCollect" boProperty="cashflowitem" value="101"></fisc:searchHelp>
		</td>
	</tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unnameCollect/unnamerCollectAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unnameCollect/unnamerCollectAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateUnnamerCollect',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateUnnamerCollect,iconCls:'icon-table-save'},'-',
          
<%
Object haveBindWorkFlow = request.getAttribute("haveBindWorkFlow");
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessUnnamerCollect,disabled:true,iconCls:'task'},'-',
					{id:'_cashJournal',text:'现金日记账',handler:_cashJournalUnnamerCollect,disabled:true,iconCls:'icon-view'},'-',				
<%}%>		
