<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象未明户收款(UnnamerCollect)查看页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.applyamount" nodeId="${workflowNodeDefId}"/> >${vt.property.applyamount}：</td>
		<td width="30%">
			<input type="text" onchange="setApplyamount(this)" class="inputText" id="UnnamerCollect.applyamount" name="UnnamerCollect.applyamount" value="${unnamerCollect.applyamount}" <fisc:authentication sourceName="UnnamerCollect.applyamount" nodeId="${workflowNodeDefId}"/>  >
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.currency" nodeId="${workflowNodeDefId}"/> >${vt.property.currency}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.collcetbankacc" nodeId="${workflowNodeDefId}"/> >${vt.property.collcetbankacc}：</td>
		<td  width="40%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.collectbankname" nodeId="${workflowNodeDefId}"/> >${vt.property.collectbankname}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.deptid" nodeId="${workflowNodeDefId}"/> >${vt.property.deptid}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="UnnamerCollect" userId="${unnamerCollect.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.applyamount2" nodeId="${workflowNodeDefId}"/> >${vt.property.applyamount2}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.collectrate" nodeId="${workflowNodeDefId}"/> >${vt.property.collectrate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="UnnamerCollect.cashflowitem" nodeId="${workflowNodeDefId}"/> >${vt.property.cashflowitem}：</td>
		<td  width="40%">
			<div id="div_cashflowitem_sh"></div>
			<fisc:searchHelp divId="div_cashflowitem_sh" boName="UnnamerCollect" boProperty="cashflowitem" defaultCondition="BUKRS='${companyCode}'" value="${unnamerCollect.cashflowitem}"></fisc:searchHelp>
		</td>
	</tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unnameCollect/unnamerCollectView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/unnameCollect/unnamerCollectViewGen.js"></script>
