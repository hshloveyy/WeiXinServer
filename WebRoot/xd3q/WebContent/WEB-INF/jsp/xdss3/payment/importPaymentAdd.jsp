...
<fisc:attachement businessId="${businessId}" boIdField="ImportPayment.paymentid" allowDelete="true" allowUpload="true" divId="div_attachement" boName="ImportPayment" boProperty="attachement" gridPageSize="10" gridHeight="285" ></fisc:attachement>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<table><tr>
		...
		<td><nobr><font color="red">请选择完供应商后，再选下面的到单信息，</font><nobr></td>
	...
	<table><tr>
		...
		<td><nobr><font color="red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系统会带出相应信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><nobr></td>
	...
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="ImportPayment.documentaryrate" name="ImportPayment.documentaryrate" value="" <fisc:authentication sourceName="ImportPayment.documentaryrate" nodeId="${workflowNodeDefId}"/> >
		</td>
		...
		<td width="30%">
			<input type="text" class="inputText" id="ImportPayment.doctaryinterest" name="ImportPayment.doctaryinterest" value=""   <fisc:authentication sourceName="ImportPayment.doctaryinterest" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="ImportPayment.redocaryamount" name="ImportPayment.redocaryamount" value="" <fisc:authentication sourceName="ImportPayment.redocaryamount" nodeId="${workflowNodeDefId}"/> >
		</td>
	</tr>
	<tr>
		...
		<td   width="40%" >
			<input type="text" class="inputText" id="ImportPayment.redocaryrate" name="ImportPayment.redocaryrate" value="" <fisc:authentication sourceName="ImportPayment.redocaryrate" nodeId="${workflowNodeDefId}"/> >
		</td>
		...
		<td  width="30%" >
		    <input type="text" class="inputText" id="ImportPayment.createtime" name="ImportPayment.createtime" value="${importPayment.createtime}"  readonly="readonly" <fisc:authentication sourceName="ImportPayment.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
	<tr>
	...
	<!--  <input type="hidden" id="ImportPayment.ticketbankid" name="ImportPayment.ticketbankid" value="${importPayment.ticketbankid}">-->
	...
	<!-- <input type="hidden" id="ImportPayment.billbc" name="ImportPayment.billbc" value="${importPayment.billbc}"> -->
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/importPaymentAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/importPaymentAddGen.js"></script>
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessImportPayment,disabled:true,iconCls:'task'},'-',	
				     {id:'_submitForReassign',text:'重分配提交',handler:_submitForReassignImportPayment,disabled:true,iconCls:'task'},'-',   				
<%}%>		
          
					{id:'_saveOrUpdateImportPayment',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateImportPayment,iconCls:'icon-table-save'},'-',
