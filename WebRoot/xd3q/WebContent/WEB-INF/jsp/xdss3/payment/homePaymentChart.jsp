<%-- 
  ...
  - Date: 2010年07月25日 09点58分39秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:   chartPageTemplate
  - <功能>内贸付款(HomePayment)图表页面
--%>
...
<table width="210" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
		<!-- UITYPE:01 -->
			<input type="text" id="supplier.fieldValue" name="supplier.fieldValue" value="">
...
<div id="div_chart_container" class="chart">
	<div id="HomePaymentChart_div"></div>
</div>

<div id="HomePaymentChartDetail_div" style="width: 100%"></div>
</body>
</html>
...
Ext.onReady(function(){
			...
			items:[{
				...
				items:[{
					...
					items:[{
						...
						id:'HomePaymentChart_div_ext'
					},{
						title:'${vt.chartDetail}',
						contentEl:"HomePaymentChartDetail_div"
					}]
				}]
			}]
		});
		Ext.getDom('HomePaymentChart_div_ext').align='center';
	});
	...
	**/
	function _queryChart()
	{
        ...
        var applyamount = $("applyamount.fieldValue").value + " 申请金额" ;
		...
		HomePaymentChart_div_reload_chart({queryParameters:queryParam,title:chartTitle});
	}
	//清空操作
	function _resetForm()
	{
...
<fisc:chart divId="HomePaymentChart_div" divDetailId="HomePaymentChartDetail_div" width="400" height="300" boName="HomePayment" defaultCondition=""></fisc:chart>