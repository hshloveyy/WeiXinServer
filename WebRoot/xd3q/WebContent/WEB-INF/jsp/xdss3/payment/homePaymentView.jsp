<%-- 
  ...
  - Date: 2010年08月02日 13点55分30秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象内贸付款(HomePayment)查看页面
--%>
...
<body>
<fisc:grid divId="div_homePaymentItem" boName="HomePaymentItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPAYMENTITEM.PAYMENTID='${homePayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" pageSize="10000"></fisc:grid>
<fisc:grid divId="div_homePaymentCbill" boName="HomePaymentCbill" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPAYMENTCBILL.PAYMENTID='${homePayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" pageSize="10000" ></fisc:grid>
<fisc:grid divId="div_homePayBankItem" boName="HomePayBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPAYBANKITEM.PAYMENTID='${homePayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homeDocuBankItem" boName="HomeDocuBankItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YDOUCARYBANKITEM.PAYMENTID='${homePayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homePaymentRelat" boName="HomePaymentRelat" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YPAYMENTRELATED.PAYMENTID='${homePayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:attachement businessId="${businessId}" allowDelete="false" divId="div_attachement" boName="HomePayment" boProperty="attachement" gridPageSize="10" gridHeight="285" allowUpload="false"></fisc:attachement>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.supplier" nodeId="${workflowNodeDefId}"/> >${vt.property.supplier}：</td>
		<td width="30%">
			<div id="div_supplier_sh"></div>
			<fisc:searchHelp divId="div_supplier_sh" boName="HomePayment" boProperty="supplier"  value="${homePayment.supplier}"></fisc:searchHelp>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.dept_id" nodeId="${workflowNodeDefId}"/> >${vt.property.dept_id}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.paymenttype" nodeId="${workflowNodeDefId}"/> >${vt.property.paymenttype}：</td>
		<td width="30%">
			<div id="div_paymenttype_dict"></div>
			<fisc:dictionary boName="HomePayment" boProperty="paymenttype" dictionaryName="YDPAYTRADETYPE" divId="div_paymenttype_dict" isNeedAuth="false"  value="${homePayment.paymenttype}"  ></fisc:dictionary>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.pay_type" nodeId="${workflowNodeDefId}"/> >${vt.property.pay_type}：</td>
		<td  width="40%">
			<div id="div_pay_type_dict"></div>
			<fisc:dictionary boName="HomePayment" boProperty="pay_type" dictionaryName="YDPAYTYPE" divId="div_pay_type_dict" isNeedAuth="false"  value="${homePayment.pay_type}"  ></fisc:dictionary>
		</td>
	</tr>
	<tr>
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.applyamount" nodeId="${workflowNodeDefId}"/> >${vt.property.applyamount}：</td>
		<td  width="40%">
			<input type="text" class="inputText" id="HomePayment.applyamountT" name="HomePayment.applyamountT" value="${homePayment.applyamount}" readonly="readonly">
		    <input type="hidden" class="inputText" id="HomePayment.applyamount" name="HomePayment.applyamount" value="${homePayment.applyamount}">
			
			
			<script type="text/javascript">
			var o = document.getElementById('HomePayment.applyamountT');
			var re=/\d{1,3}(?=(\d{3})+$)/g;
			o.value=o.value.replace(/^(\d+)((\.\d+)?)$/,function(s,s1,s2){return s1.replace(re,"$&,")+s2;});
            </script>
		</td>
	</tr>
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.currency" nodeId="${workflowNodeDefId}"/> >${vt.property.currency}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.closeexchangerat" nodeId="${workflowNodeDefId}"/> >${vt.property.closeexchangerat}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.collectbankid" nodeId="${workflowNodeDefId}"/> >${vt.property.collectbankid}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.collectbankacc" nodeId="${workflowNodeDefId}"/> >${vt.property.collectbankacc}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.finumber" nodeId="${workflowNodeDefId}"/> >${vt.property.finumber}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.replacedate" nodeId="${workflowNodeDefId}"/> >${vt.property.replacedate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.musttaketickleda" nodeId="${workflowNodeDefId}"/> >${vt.property.musttaketickleda}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.arrivegoodsdate" nodeId="${workflowNodeDefId}"/> >${vt.property.arrivegoodsdate}：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.draftdate" nodeId="${workflowNodeDefId}"/> >${vt.property.draftdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.ticketbankid" nodeId="${workflowNodeDefId}"/> >${vt.property.ticketbankid}：</td>
		<td width="30%">
		...
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.billbc" nodeId="${workflowNodeDefId}"/> >${vt.property.billbc}：</td>
		<td width="30%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="HomePayment" userId="${homePayment.creator}"></fisc:user>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.factamount" nodeId="${workflowNodeDefId}"/> >${vt.property.factamount}：</td>
		<td width="30%">
			<input type="text" class="inputText" id="HomePayment.factamountT" name="HomePayment.factamountT" value="${homePayment.factamount}" readonly="readonly"  >
			<input type="hidden" class="inputText" id="HomePayment.factamount" name="HomePayment.factamount" value="${homePayment.factamount}">

		    <script type="text/javascript">
			var o = document.getElementById('HomePayment.factamountT');
			var re=/\d{1,3}(?=(\d{3})+$)/g;
			o.value=o.value.replace(/^(\d+)((\.\d+)?)$/,function(s,s1,s2){return s1.replace(re,"$&,")+s2;});
            </script>
		</td>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.factcurrency" nodeId="${workflowNodeDefId}"/> >${vt.property.factcurrency}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right"  <fisc:authentication sourceName="HomePayment.exchangerate" nodeId="${workflowNodeDefId}"/> >${vt.property.exchangerate}：</td>
		<td width="30%">
...
<td width="40%" >
<input type="text" class="inputText" id="HomeSettSubj.amount1" name="HomeSettSubj.amount1" value="${homePayment.homeSettSubj.amount1}" <fisc:authentication sourceName="HomeSettSubj.amount1" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeSettSubj.standardamount1" name="HomeSettSubj.standardamount1" value="${homePayment.homeSettSubj.standardamount1}" <fisc:authentication sourceName="HomeSettSubj.standardamount1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%">
<input type="text" class="inputText" id="HomeSettSubj.orderno1" name="HomeSettSubj.orderno1" value="${homePayment.homeSettSubj.orderno1}" >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeSettSubj.amount2" name="HomeSettSubj.amount2" value="${homePayment.homeSettSubj.amount2}" <fisc:authentication sourceName="HomeSettSubj.amount2" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeSettSubj.standardamount2" name="HomeSettSubj.standardamount2" value="${homePayment.homeSettSubj.standardamount2}" <fisc:authentication sourceName="HomeSettSubj.standardamount2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%">
<input type="text" class="inputText" id="HomeSettSubj.orderno2" name="HomeSettSubj.orderno2" value="${homePayment.homeSettSubj.orderno2}" >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeSettSubj.amount3" name="HomeSettSubj.amount3" value="${homePayment.homeSettSubj.amount3}" <fisc:authentication sourceName="HomeSettSubj.amount3" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeSettSubj.standardamount3" name="HomeSettSubj.standardamount3" value="${homePayment.homeSettSubj.standardamount3}" <fisc:authentication sourceName="HomeSettSubj.standardamount3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%">
<input type="text" class="inputText" id="HomeSettSubj.orderno3" name="HomeSettSubj.orderno3" value="${homePayment.homeSettSubj.orderno3}" >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeSettSubj.amount4" name="HomeSettSubj.amount4" value="${homePayment.homeSettSubj.amount4}" <fisc:authentication sourceName="HomeSettSubj.amount4" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeSettSubj.standardamount4" name="HomeSettSubj.standardamount4" value="${homePayment.homeSettSubj.standardamount4}" <fisc:authentication sourceName="HomeSettSubj.standardamount4" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="30%">
<input type="text" class="inputText" id="HomeSettSubj.orderno4" name="HomeSettSubj.orderno4" value="${homePayment.homeSettSubj.orderno4}" >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeFundFlow.amount1" name="HomeFundFlow.amount1" value="${homePayment.homeFundFlow.amount1}" <fisc:authentication sourceName="HomeFundFlow.amount1" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeFundFlow.standardamount1" name="HomeFundFlow.standardamount1" value="${homePayment.homeFundFlow.standardamount1}" <fisc:authentication sourceName="HomeFundFlow.standardamount1" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeFundFlow.amount2" name="HomeFundFlow.amount2" value="${homePayment.homeFundFlow.amount2}" <fisc:authentication sourceName="HomeFundFlow.amount2" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeFundFlow.standardamount2" name="HomeFundFlow.standardamount2" value="${homePayment.homeFundFlow.standardamount2}" <fisc:authentication sourceName="HomeFundFlow.standardamount2" nodeId="${workflowNodeDefId}"/> >
</td>
...
<td width="40%" >
<input type="text" class="inputText" id="HomeFundFlow.amount3" name="HomeFundFlow.amount3" value="${homePayment.homeFundFlow.amount3}" <fisc:authentication sourceName="HomeFundFlow.amount3" nodeId="${workflowNodeDefId}"/> >
</td>
</tr>
<tr>
...
<td width="30%" >
<input type="text" class="inputText" id="HomeFundFlow.standardamount3" name="HomeFundFlow.standardamount3" value="${homePayment.homeFundFlow.standardamount3}" <fisc:authentication sourceName="HomeFundFlow.standardamount3" nodeId="${workflowNodeDefId}"/> >
</td>
...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/xdss3/payment/homePaymentView.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/xdss3/payment/homePaymentViewGen.js"></script>
...
function _saveDate(){
	var param='?action=_saveDate&paymentid='+paymentid+'&musttaketickleda='+$('HomePayment.musttaketickleda').value+'&arrivegoodsdate='+$('HomePayment.arrivegoodsdate').value+'&replacedate='+$('HomePayment.replacedate').value;
	new AjaxEngine(contextPath + '/xdss3/payment/homePaymentController.spr', 
...
{id:'_print1',text:'打印至出纳',handler:_printHomePayment1,iconCls:'task'},'-',
