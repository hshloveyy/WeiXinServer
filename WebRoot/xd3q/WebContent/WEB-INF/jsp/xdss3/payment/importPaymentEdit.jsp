...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="ImportPayment.factcurrency" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.factcurrency}：</td>
		<td  width="40%">
...
<td width="40%">
<input type="text" class="inputText" id="ImportSettSubj.amount1" name="ImportSettSubj.amount1" value="${importPayment.importSettSubj.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportSettSubj.standardamount1" name="ImportSettSubj.standardamount1" value="${importPayment.importSettSubj.standardamount1}" >
</td>
...
<td width="30%">
<div id="div_ImportSettSubjorderno1_sh"></div>
<fisc:searchHelp divId="div_ImportSettSubjorderno1_sh" boName="ImportSettSubj" boProperty="orderno1" value="${importPayment.importSettSubj.orderno1}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportSettSubj.amount2" name="ImportSettSubj.amount2" value="${importPayment.importSettSubj.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportSettSubj.standardamount2" name="ImportSettSubj.standardamount2" value="${importPayment.importSettSubj.standardamount2}" >
</td>
...
<td width="30%">
<div id="div_ImportSettSubjorderno2_sh"></div>
<fisc:searchHelp divId="div_ImportSettSubjorderno2_sh" boName="ImportSettSubj" boProperty="orderno2" value="${importPayment.importSettSubj.orderno2}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportSettSubj.amount3" name="ImportSettSubj.amount3" value="${importPayment.importSettSubj.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportSettSubj.standardamount3" name="ImportSettSubj.standardamount3" value="${importPayment.importSettSubj.standardamount3}" >
</td>
...
<td width="30%">
<div id="div_ImportSettSubjorderno3_sh"></div>
<fisc:searchHelp divId="div_ImportSettSubjorderno3_sh" boName="ImportSettSubj" boProperty="orderno3" value="${importPayment.importSettSubj.orderno3}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportSettSubj.amount4" name="ImportSettSubj.amount4" value="${importPayment.importSettSubj.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportSettSubj.standardamount4" name="ImportSettSubj.standardamount4" value="${importPayment.importSettSubj.standardamount4}" >
</td>
...
<td width="30%">
<div id="div_ImportSettSubjorderno4_sh"></div>
<fisc:searchHelp divId="div_ImportSettSubjorderno4_sh" boName="ImportSettSubj" boProperty="orderno4" value="${importPayment.importSettSubj.orderno4}"></fisc:searchHelp>
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportFundFlow.amount1" name="ImportFundFlow.amount1" value="${importPayment.importFundFlow.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportFundFlow.standardamount1" name="ImportFundFlow.standardamount1" value="${importPayment.importFundFlow.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportFundFlow.amount2" name="ImportFundFlow.amount2" value="${importPayment.importFundFlow.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportFundFlow.standardamount2" name="ImportFundFlow.standardamount2" value="${importPayment.importFundFlow.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="ImportFundFlow.amount3" name="ImportFundFlow.amount3" value="${importPayment.importFundFlow.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="ImportFundFlow.standardamount3" name="ImportFundFlow.standardamount3" value="${importPayment.importFundFlow.standardamount3}" >
</td>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/importPaymentEditGen.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/importPaymentEdit.js"></script>
