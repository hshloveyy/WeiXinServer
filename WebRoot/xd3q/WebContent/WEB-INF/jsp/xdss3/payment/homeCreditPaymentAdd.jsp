<%-- 
  ...
  - Date: 2013年11月20日 15点47分19秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象国内信用证(HomeCreditPayment)增加页面
--%>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td   width="40%" >
			<input type="text" class="inputText" id="HomeCreditPayment.paymentno" name="HomeCreditPayment.paymentno" readonly="readonly" value="${homeCreditPayment.paymentno}" <fisc:authentication sourceName="HomeCreditPayment.paymentno" nodeId="${workflowNodeDefId}"/>  readonly="readonly">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td   width="40%" >
		    <input type="text" class="inputText" id="HomeCreditPayment.createtime" name="HomeCreditPayment.createtime" value="${homeCreditPayment.createtime}"  readonly="readonly" <fisc:authentication sourceName="HomeCreditPayment.createtime" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/homeCreditPaymentAdd.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/homeCreditPaymentAddGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					...
					{id:'_saveOrUpdateHomeCreditPayment',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateHomeCreditPayment,iconCls:'icon-table-save'},'-',
...
if(Boolean.parseBoolean(haveBindWorkFlow.toString())){%>
					{id:'_submitProcess',text:'${vt.mSubmitProcess}',handler:_submitProcessHomeCreditPayment,disabled:true,iconCls:'task'},'-',					
<%}%>		
