<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>主对象国内信用证(HomeCreditPayment)编辑页面
--%>
...
<body>
<fisc:grid divId="div_homeCreditPayItem" boName="HomeCreditPayItem" needCheckBox="true" editable="true" defaultCondition=" YPAYMENTITEM.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homeCreditPayCbill" boName="HomeCreditPayCbill" needCheckBox="true" editable="true" defaultCondition=" YPAYMENTCBILL.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homeCreditBankItem" boName="HomeCreditBankItem" needCheckBox="true" editable="true" defaultCondition=" YPAYBANKITEM.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homeCreditDocuBank" boName="HomeCreditDocuBank" needCheckBox="true" editable="true" defaultCondition=" YDOUCARYBANKITEM.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:attachement businessId="${businessId}" allowDelete="true" divId="div_attachementAttachement" boName="HomeCreditPayment" boProperty="attachement" gridPageSize="10" gridHeight="285" ></fisc:attachement>
<fisc:grid divId="div_homeCreditRebank" boName="HomeCreditRebank" needCheckBox="true" editable="true" defaultCondition=" YBILLPAYMENTBANK.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
<fisc:grid divId="div_homeCreditRelatPay" boName="HomeCreditRelatPay" needCheckBox="true" editable="true" defaultCondition=" YPAYMENTRELATED.PAYMENTID='${homeCreditPayment.paymentid}'" needAutoLoad="true" height="285" nameSapceSupport="true" ></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.supplier" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.supplier}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.paymentno" nodeId="${workflowNodeDefId}"/> >${vt.property.paymentno}：</td>
		<td  width="40%">
			<input type="text" class="inputText" id="HomeCreditPayment.paymentno" name="HomeCreditPayment.paymentno" value="${homeCreditPayment.paymentno}"   readonly="readonly" <fisc:authentication sourceName="HomeCreditPayment.paymentno" nodeId="${workflowNodeDefId}"/>>
		</td>
	</tr>
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.paymenttype" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>付款方式：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.pay_type" nodeId="${workflowNodeDefId}"/> >${vt.property.pay_type}：</td>
		<td  width="40%">
	...
	<tr>
        <td></td>
        <td></td>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.applyamount" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.applyamount}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.currency" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.currency}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.closeexchangerat" nodeId="${workflowNodeDefId}"/> >${vt.property.closeexchangerat}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.collectbankid" nodeId="${workflowNodeDefId}"/> >${vt.property.collectbankid}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.collectbankacc" nodeId="${workflowNodeDefId}"/> >${vt.property.collectbankacc}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.doctaryinterest" nodeId="${workflowNodeDefId}"/> >${vt.property.doctaryinterest}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.musttaketickleda" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.musttaketickleda}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.arrivegoodsdate" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.arrivegoodsdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.paydate" nodeId="${workflowNodeDefId}"/> >${vt.property.paydate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.payer" nodeId="${workflowNodeDefId}"/> >${vt.property.payer}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.documentarydate" nodeId="${workflowNodeDefId}"/> >${vt.property.documentarydate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.documentarylimit" nodeId="${workflowNodeDefId}"/> >${vt.property.documentarylimit}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.exchangerate" nodeId="${workflowNodeDefId}"/> >${vt.property.exchangerate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.dept_id" nodeId="${workflowNodeDefId}"/> ><font color="red">★</font>${vt.property.dept_id}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.billbc" nodeId="${workflowNodeDefId}"/> >${vt.property.billbc}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.draft" nodeId="${workflowNodeDefId}"/> >${vt.property.draft}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.draftdate" nodeId="${workflowNodeDefId}"/> >${vt.property.draftdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.ticketbankid" nodeId="${workflowNodeDefId}"/> >${vt.property.ticketbankid}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.writelistno" nodeId="${workflowNodeDefId}"/> >${vt.property.writelistno}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.redocarybc" nodeId="${workflowNodeDefId}"/> >${vt.property.redocarybc}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.redocaryamount" nodeId="${workflowNodeDefId}"/> >${vt.property.redocaryamount}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.replacedate" nodeId="${workflowNodeDefId}"/> >${vt.property.replacedate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.currency2" nodeId="${workflowNodeDefId}"/> >${vt.property.currency2}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.expiredate" nodeId="${workflowNodeDefId}"/> >${vt.property.expiredate}：</td>
		<td  width="40%">
	...
	<tr>
		<td></td>
		<td></td>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.documentarypaydt" nodeId="${workflowNodeDefId}"/> >${vt.property.documentarypaydt}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.text" nodeId="${workflowNodeDefId}"/> valign="top"><font color="red">★</font>${vt.property.text}：</td>
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.remark" nodeId="${workflowNodeDefId}"/> valign="top">${vt.property.remark}：</td>
		<td width="30%" colspan="3" >
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.accountdate" nodeId="${workflowNodeDefId}"/> >${vt.property.accountdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.voucherdate" nodeId="${workflowNodeDefId}"/> >${vt.property.voucherdate}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.payrealdate" nodeId="${workflowNodeDefId}"/> >${vt.property.payrealdate}：</td>
		<td width="30%">
		...
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.factamount" nodeId="${workflowNodeDefId}"/> >${vt.property.factamount}：</td>
		<td  width="40%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.factcurrency" nodeId="${workflowNodeDefId}"/> >${vt.property.factcurrency}：</td>
		<td width="30%">
	...
	<tr>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.creator" nodeId="${workflowNodeDefId}"/> >${vt.property.creator}：</td>
		<td width="30%">
			<fisc:user boProperty="creator" boName="HomeCreditPayment" userId="${homeCreditPayment.creator}"></fisc:user>
		</td>
		<td align="right" width="15%"  <fisc:authentication sourceName="HomeCreditPayment.createtime" nodeId="${workflowNodeDefId}"/> >${vt.property.createtime}：</td>
		<td  width="40%">
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount1" name="SettleSubject.amount1" value="${homeCreditPayment.settleSubject.amount1}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount1" name="SettleSubject.standardamount1" value="${homeCreditPayment.settleSubject.standardamount1}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno1" name="SettleSubject.rowno1" value="${homeCreditPayment.settleSubject.rowno1}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount2" name="SettleSubject.amount2" value="${homeCreditPayment.settleSubject.amount2}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount2" name="SettleSubject.standardamount2" value="${homeCreditPayment.settleSubject.standardamount2}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno2" name="SettleSubject.rowno2" value="${homeCreditPayment.settleSubject.rowno2}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount3" name="SettleSubject.amount3" value="${homeCreditPayment.settleSubject.amount3}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount3" name="SettleSubject.standardamount3" value="${homeCreditPayment.settleSubject.standardamount3}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno3" name="SettleSubject.rowno3" value="${homeCreditPayment.settleSubject.rowno3}" >
</td>
</tr>
<tr>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.amount4" name="SettleSubject.amount4" value="${homeCreditPayment.settleSubject.amount4}" >
</td>
</tr>
<tr>
...
<td width="30%">
<input type="text" class="inputText" id="SettleSubject.standardamount4" name="SettleSubject.standardamount4" value="${homeCreditPayment.settleSubject.standardamount4}" >
</td>
...
<td width="40%">
<input type="text" class="inputText" id="SettleSubject.rowno4" name="SettleSubject.rowno4" value="${homeCreditPayment.settleSubject.rowno4}" >
</td>
</tr>
<tr>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/homeCreditPaymentEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/homeCreditPaymentEditGen.js"></script>
...
//Ext.onReady(function(){
	...
	var toolbars = new Ext.Toolbar({
			items:[
					'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdateHomeCreditPayment,iconCls:'icon-table-save'},'-',
...
{id:'_print',text:'打印',handler:_printHomeCreditPayment,iconCls:'task'},'-',
' '
],
