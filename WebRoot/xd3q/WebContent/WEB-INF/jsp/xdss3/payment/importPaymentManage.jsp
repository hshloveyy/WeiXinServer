...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/xdss3/payment/importPaymentManageGen.js"></script>
</head>
<body>
<fisc:grid divId="div_southForm" 
           boName="ImportPayment"  
           editable="false" 
           needCheckBox="true" 
           needToolbar="true" 
           needAuthentication="true"
           needAutoLoad="true" orderBySql="YPAYMENT.CREATETIME desc"
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td  width="30%" >
			<input type="text" class="inputText" id="paymentno.fieldValue" name="paymentno.fieldValue" value="" <fisc:authentication sourceName="ImportPayment.paymentno" taskId=""/>>
...
var Txt={
	...
	// 请选择需要进行【进口付款复制创建】操作的记录！
	importPayment_CopyCreate_SelectToOperation:'${vt.copyCreate_SelectToOperate}',
	// 进行【进口付款复制创建】操作时，只允许选择一条记录！
	importPayment_CopyCreate_AllowOnlyOneItemForOperation:'${vt.copyCreate_AllowOnlyOneItemForOperation}',
	// 您选择了【进口付款批量删除】操作，是否确定继续该操作？
	importPayment_Deletes_ConfirmOperation:'${vt.deletes_ConfirmOperation}',
	// 请选择需要进行【进口付款批量删除】操作的记录！
	importPayment_Deletes_SelectToOperation:'${vt.deletes_SelectToOperate}',
	// 您选择了【进口付款删除】操作，是否确定继续该操作？
