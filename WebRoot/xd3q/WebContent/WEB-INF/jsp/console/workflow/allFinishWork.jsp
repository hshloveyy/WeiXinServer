...
<table width="100%" border="1" cellspacing="1" bordercolor="#6699FF" class="datatable">
    <tr>
      <td>事务状态：
      	<select name="processState">
      		<option value="">请选择</option>
      		<option value="finish">已结束</option>
      		<option value="unfinish" selected="selected">未结束</option>
      	</select>
	  </td>
    ...
    <tr>
      ...
      <table cellpadding="0" cellspacing="0" border="0">
         <tr>
            <td>流程开始时间:从</td><td><div id="div-op-startDate"></div></td><td>&nbsp;到&nbsp;</td><td><div id="div-op-endDate"></div></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td>流程结束时间：从</td><td><div id="div-startDate"></div></td><td>&nbsp;到&nbsp;</td><td><div id="div-endDate"></div></td>
         </tr>
      </table>
      </td>
    </tr>
...
function find(){
	var url = 'workflowController.spr?action=getAllProcessInstancesHistory&isAll=${isAll}&'+Form.serialize('findCondictionFR');
