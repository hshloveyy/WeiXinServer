...
var roleId = '${roleid}';
var upRoleId = '${uproleid}';

var tree;
var checkresult="";

function addRoleResource(){
	var param = param + "?action=addRoleResource&roleid="+roleId+'&resourcelist='+checkresult;
...
Ext.onReady(function(){
	Ext.QuickTips.init();
   	...
   	var systemTreeLoader = new Ext.tree.TreeLoader({
    	...
    	url:'orgController.spr?action=queryResourceForTree&roleid='+roleId+'&uproleid='+upRoleId
    });
