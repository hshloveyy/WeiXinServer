...
<tr>
	...
	<input type="text" id="contractGroupNo" name="contractGroupNo" value="" size="17"></input>
	</td>
	<td>
	<input type="text" id="contractGroupName" name="contractGroupName" value="" size="17"></input>
	</td>
	<td>
	<input type="text" id="contractNo" name="contractNo" value="" size="18"></input>
	</td>		
	<td>
	<input type="text" id="contractName" name="contractName" value="" size="18"></input>
	</td>
	<td>
    ...
    <!-- td>
      	<select name="hasQuantity">
      		<option value="open" selected="selected">未发完</option>
      		<option value="">已发完</option>
      	</select>
	</td>
	 -->
    <td>
...
function findPurchaseInfo(){
	...
	var requestUrl  = 'shipController.spr?action=queryPurchaseInfo&' + param;
