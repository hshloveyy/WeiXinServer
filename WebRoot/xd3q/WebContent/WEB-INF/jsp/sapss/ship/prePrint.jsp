...
<td>
<input type="button" value="打印提货联" onclick="printForm(3)">
</td>
<td>
...
function printForm(printType){
    window.open('shipController.spr?action=dealPrint&shipId=${shipId}&printType='+printType,'_blank','location=no,resizable=yes');
}
</script>
</body>
</html>
