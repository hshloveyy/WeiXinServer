...
<tr>
	...
	<input type="text" id="noticeNo" name="noticeNo" value="" size=10></input>
	</td>
	<td>
	<input type="text" id="lcNo" name="lcNo" value="" size=10></input>
	</td>
	<td>
	<input type="text" id="projectName" name="projectName" value="" size=13></input>
	</td>	
	<td>	
	...
	<td>
	<input type="text" id="paperNo" name="paperNo" value="" size=13></input>
	</td>
	<td>
	<div id="div_tradeType"></div>
	</td>
	<td>
	<input type="button" value="查找" onclick="findExportApply()"></input>
	</td>
	<td>
...
function findExportApply(){
	...
	var requestUrl  = 'shipController.spr?action=queryExportApply&' + param;
    ...
    var viewport = new Ext.Viewport({
		...
		items:[{
			...
			buttons:[{
				text:'确定',
				handler:function(){
					if (exportApplygrid.selModel.hasSelection()){
						var records = exportApplygrid.selModel.getSelections();
