...
function selectSalesWin(){
	...
	'shipNotifyController.spr?action=selectSalesInfo&tradeType=' + '${tExportApply.tradeType}' +'&orderState=3&&deptid=',
	'',
...
function selectLcNoWin(){
	...
	'shipNotifyController.spr?action=toFindLcNo&contractSalesId=' + contractSalesId,
	'',
	lcNoCallback,
	...
	<table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
     ...
     <tr>
       ...
       <td align="right">
        ...
        <td align="left">
          <input id="customer" name="customer" type="text" value="${tExportApply.customer}"/>
        </td>         
     </tr>
     <tr>
     	<td align="right">
        ...
        <td width="22%" align="left"><input id="cmd" name="cmd" type="text" value="${tExportApply.cmd}" size=25 />
        </td>            
    </tr>
	</table>
</form>
