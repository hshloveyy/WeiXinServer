...
<TR><TD></TD><TD><DIV id="page<%=p %>">
     <table border="0" cellpadding="4" cellspacing="1" class="datatable" align="center">
       <tr><td align="center" colspan="4"><br><br><br></td></tr>
       <tr><td align="center" colspan="3"><font size="4" color="black">${title }货物<font size="5" color="black">出</font>仓单
       <c:choose>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td align="right"><font color="black">序号:${main.serialNo }&nbsp;&nbsp;出仓单号:${main.shipNo }<%=pageCount<=1?"":"_"+p %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td></tr>
       <tr><td colspan="3">
		<table width="700" border="1" cellpadding="4" cellspacing="1" bordercolor="black" class="datatable" align="center">
			<tr>
				...
				<td align="center" width="60"><font color="black">报关单号</font></td>
				<td align="center" width="100"><font color="black">${main.declarationsNo }</font></td>
			</tr>
			<tr>
				...
				<td align="center" width="100" colspan="2"><font color="black">${main.sapOrderNo }</font></td>
				<td align="center" width="60"><font color="black">SAP交货单号</font></td>
				<td align="center" width="100"><font color="black">
					${main.sapReturnNo}</font>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center" colspan=<c:if test="${printType=='3'}">2</c:if><c:if test="${printType!='3'}">1</c:if>><font color="black"><%=quantity %></font></td>
				<c:if test="${printType!='3'}">
