...
Ext.onReady(function(){
	...
	//{LARGEITEM=01, NAME=一、 营业收入, MIDDLEITEM=00, HEJI=9653315.80, LINEROW=01, LITTLEITEM=00, BENYUE=17094.02}, 
 	var ds = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'sapReportController.spr?action=rtnXianjinliuliang&noPage=1&kuaijiniandu=${kuaijiniandu}&kuaijiqijian=${kuaijiqijian}&gongsidaima=${gongsidaima}'}),
...
function findMaterial(){
	...
	var url = 'sapReportController.spr?action=rtnXianjinliuliang&noPage=1&'+Form.serialize('materialForm');
	Ext.Ajax.request({
		url: url,
		params:'',
