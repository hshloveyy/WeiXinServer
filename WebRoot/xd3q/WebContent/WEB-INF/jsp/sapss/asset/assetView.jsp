...
<form id="mainForm" action="" name="mainForm">
     ...
     <tr>
      ...
      <tr>
        ...
        <td  align="left">
        	<input name="assetName" type="text" value="${info.assetName }" readonly="readonly"/>
        </td>
        <td align="right">型号配置<font color="red">▲</font>：</td>
        <td align="left">
        	<input name="assetConfig" type="text" value="${info.assetConfig}" readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="right">设备序列号<font color="red">▲</font>：</td>
        <td align="left">
        	<input name="assetSerialNo" type="text" value="${info.assetSerialNo }" readonly="readonly"/>
        </td>
        <td align="right">外部编号<font color="red">▲</font>：</td>
        <td align="left">
        	<input name="outsideNo" type="text" value="${info.outsideNo}" readonly="readonly"/>
        </td>
        <td align="right">存放位置<font color="red">▲</font>：</td>
        <td align="left">
        	<input name="location" type="text" value="${info.location}" readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="right">数量：</td>
        <td align="left">
        	<input name="quality" type="text" readonly="readonly" value="${info.quality}"/>
        </td>
        <td align="right">计量单位：</td>
        <td align="left">
        	<input name="measure" type="text" value="${info.measure}" readonly="readonly"/>
        </td>
      ...
      <tr>
        ...
        <td align="left">
        	<input name="contractPuchaseNo" type="text" value="${info.contractPuchaseNo}" readonly="readonly"/>
        </td>
        <td align="right">采购金额<font color="red">▲</font>：</td>
        <td align="left">
        	<input name="cost" type="text" value="${info.cost}" readonly="readonly"/>
        </td>
        <td align="right">供应商名称：</td>
        <td align="left">
        	<input name="supplierName" type="text" value="${info.supplierName}" readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="right">采购联系人：</td>
        <td align="left">
        	<input name="purchaseLinkMan" type="text" value="${info.purchaseLinkMan}" readonly="readonly"/>
        </td>
        <td align="right">采购联系电话：</td>
        <td align="left">
        	<input name="purchaseLinkTel" type="text" value="${info.purchaseLinkTel}" readonly="readonly"/>
        </td>
        <td align="right">保修期：</td>
        <td align="left">
        	<input name="guaranteeDate" type="text" value="${info.guaranteeDate}" readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="right">维修电话：</td>
        <td align="left">
        	<input name="maintainTel" type="text" value="${info.maintainTel}" readonly="readonly"/>
        </td>
        <td align="right">折旧年限：</td>
        <td align="left">
        	<input name="depreciationYear" type="text" value="${info.depreciationYear}" onchange="countScrapDate();" readonly="readonly"/>月
        </td>
      ...
      <tr>
        ...
        <td align="left">
        	<input id="frozenMark" name="frozenMark" type="checkbox" value="${info.frozenMark}" ${info.frozenMark==1?"checked":""} readonly="readonly"/>
        </td>
        <td align="right">冻结原因：</td>
        <td align="left" colspan="3">
        	<input name="frozenReason" type="text" value="${info.frozenReason}" size="68" readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="right">备注：</td>
        <td colspan="5">
        	 <textarea cols="80" rows="1" id="memo" name="memo" style="width:95%;overflow-y:visible;word-break:break-all;" readonly="readonly">${info.memo}</textarea>
        </td>
    </tr>
	</table>
</form>
...
<fiscxd:dictionary divId="div_assetType" fieldName="assetType" dictionaryName="BM_ASSET_TYPE" width="153" selectedValue="${info.assetType }" disable="true"></fiscxd:dictionary>
<fiscxd:dictionary divId="div_businessScope" fieldName="businessScope" dictionaryName="BM_BUSINESS_SCOPE" width="153" selectedValue="${info.businessScope}" disable="true"></fiscxd:dictionary>
<fiscxd:dictionary divId="div_state" fieldName="state" dictionaryName="BM_ASSET_STATE" width="153" selectedValue="${info.state}" disable="true"></fiscxd:dictionary>
