...
Ext.onReady(function(){
	...
	otherds = new Ext.data.Store({
   		proxy : new Ext.data.HttpProxy({url:'contractController.spr?action=queryContractSeMaterielCase&salesrowsid='+strSalesRowsId +"&saprowno="+strSapRowNo}),
    ...
    var addOther = new Ext.Toolbar.Button({
   		...
   		iconCls:'add',
		handler:function(){
			var requestUrl = 'contractController.spr?action=addContractSeMaterielCase&salesrowsid='+strSalesRowsId + '&saprowno=' + strSapRowNo;
			Ext.Ajax.request({
				url: requestUrl,
				...
				top.Ext.Msg.show({
					title:'提示',
  						...
  						fn: function(buttonId,text){
  							if(buttonId=='yes'){
  								var param = "?action=deleteSalesMaterielCase";
    ...
    otherds.load({params:{start:0, limit:10}});
     ...
     function afterEdit(obj){
        ...
        var requestUrl = 'contractController.spr?action=updateSalesMaterielCase';
