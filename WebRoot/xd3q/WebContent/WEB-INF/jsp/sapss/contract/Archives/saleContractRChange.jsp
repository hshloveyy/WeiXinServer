...
<tr>
    ...
    function viewTradeMonint(){
    	_getMainFrame().maintabs.addPanel('贸易监控','', 'tradeMonitoringController.spr?action=_conditionManage&isdefault=08&queryValue=${sales.contractNo}');
    }
    </script>
	<td align="right" width="13%" >合同组名称：</td>
	<td width="20%">
	<input type="text" readonly="readonly" id="contractGroupName" name="contractGroupName" value="${contractGroupName}"></input>
	</td>	
...
<tr>
	...
	<td>
	<input type="text" readonly="readonly" id="contractNo" name="contractNo" value="${sales.contractNo}" size="10"></input>
...
<tr>
	...
	<td>
	<input type="text" id="vbkdKurrf" name="vbkdKurrf" value="${sales.vbkdKurrf}" readonly="readonly"></input>
	</td>
	<td align="right">
...
<tr>
	...
	<td colspan="3">
		<textarea name="mask" style="width:100%;overflow-y:visible;word-break:break-all;" readonly="readonly">${sales.mask}</textarea>
    </td>
</tr>
</table>
</form>
...
<fiscxd:fileUpload divId="div_accessory" increasable="false" erasable="false" 
		...
		items:[{
			...
			items:[{
	            ...
	            items:[{
					title:'合同变更',
					id:'alterId',
					html:'<iframe src="saleChangeController.spr?action=toChangeTab&from=${from}&contractId=${sales.contractSalesId}&shortSAP=${shortSAP}" width="100%" height="100%" id="alter" ></iframe>'
		        },{
	            	title:'订单信息',
...
<fiscxd:dictionary divId="div_vbakWaerk" fieldName="vbakWaerk" dictionaryName="BM_CURRENCY" width="150" selectedValue="${sales.vbakWaerk}" disable="true" ></fiscxd:dictionary>
...
<fiscxd:dictionary divId="div_vbkdInco1" fieldName="vbkdInco1" dictionaryName="BM_INCOTERM_TYPE" width="150" selectedValue="${sales.vbkdInco1}" disable="true" ></fiscxd:dictionary>
