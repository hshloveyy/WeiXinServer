...
<table width="100%">
<tr>	
	<td align="right"><nobr>项目名称：</nobr></td>
	<td><nobr>
...
<tr>
	...
	<td>
	<input  type="text" readonly="readonly" id="oldContractNo" name="oldContractNo" value="${purchase.oldContractNo}"></input>
	</td>
</tr>
<tr>
	<td align="right"><nobr>采购凭证日期：</nobr></td>
	<td>
...
<tr>
	...
	<td>
		<input type="hidden" size="20" readonly="readonly" id="totalAmount" name="totalAmount" value="${purchase.totalAmount}"></input>
		<input type="text" size="20" readonly="readonly" id="totalAmount1" name="totalAmount1" value="${purchase.totalAmount}"></input>
		<script>$("totalAmount1").value=Utils.commafy(${purchase.totalAmount})</script>
	</td>
	<td align="right">订单币别税费总计：</td>
	<td>
		<input type="hidden" size="20" readonly="readonly" id="totalTaxes" name="totalTaxes" value="${purchase.totalTaxes}"></input>
		<input type="text" size="20" readonly="readonly" id="totalTaxes1" name="totalTaxes1" value="${purchase.totalTaxes}"></input>
		<script>$("totalTaxes1").value=Utils.commafy(${purchase.totalTaxes})</script>
	</td>
	<td align="right">订单币别总计：</td>
	<td>
		<input type="hidden" size="20" readonly="readonly" id="total" name="total" value="${purchase.total}"></input>
		<input type="text" size="20" readonly="readonly" id="total1" name="total1" value="${purchase.total}"></input>
		<script>$("total1").value=Utils.commafy(${purchase.total})</script>
	</td>
</tr>
<tr>
	<td align="right">
...
<tr id="trView1">
	<td align="right" id="tdView1">合同规定付款日:</td>
	<td id="tdView2">
...
<tr>
	...
	<td colspan="3">
		<textarea name="mask" style="width:96%;overflow-y:visible;word-break:break-all;">${purchase.mask}</textarea>
    </td>
...
<fiscxd:fileUpload divId="div_accessory" resourceId="2222" increasable="${fileEdit}" erasable="${fileEdit}" 
		...
		items:[{
			...
			items:[{
	            ...
	            items:[{
					...
					id:'alterId',
					layout:'fit',
					html:'<iframe src="purchaseChangeController.spr?action=toChangeTab&from=changeR&contractId=${purchase.contractPurchaseId}" width="100%" height="100%" id="alter" ></iframe>'
	            }]
			}],
			buttons:[{
            	text:'写入SAP',
            	...
            	handler:function(){
            		var param1 = Form.serialize('baseForm');
            		var param2 = Form.serialize('contractForm');
					var param = param1 + "&" + param2 + "&action=mgModifyPurchaserInfo";
					new AjaxEngine('contractController.spr', 
						   {method:"post", parameters: param, onComplete: callBackHandle});
            	}
            }]
...
<fiscxd:dictionary divId="div_ekkoInco1" fieldName="ekkoInco1" needDisplayCode="true" dictionaryName="BM_INCOTERM_TYPE" width="150" selectedValue="${purchase.ekkoInco1}" disable="true"></fiscxd:dictionary>
<fiscxd:dictionary divId="div_ekkoWaers" fieldName="ekkoWaers" dictionaryName="BM_CURRENCY" width="150" selectedValue="${purchase.ekkoWaers}" needDisplayCode="true" disable="true"></fiscxd:dictionary>
<fiscxd:dictionary divId="div_ekkoEkgrp" fieldName="ekkoEkgrp" dictionaryName="BM_PURCHASING_GROUP" width="150" selectedValue="${purchase.ekkoEkgrp}" needDisplayCode="true" disable="true"></fiscxd:dictionary>
<fiscxd:dictionary divId="div_vbkdZlsch" fieldName="payType" dictionaryName="BM_PAY_TYPE" width="150" selectedValue="${purchase.payType}" disable="true"></fiscxd:dictionary>
