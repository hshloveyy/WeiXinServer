...
Ext.onReady(function(){
    ...
    var addBillApply = new Ext.Toolbar.Button({
	    ...
	    iconCls:'add',
		handler:function(){
			top.ExtModalWindowUtil.show('新增利息税开票申请单',
			'interestBillController.spr?action=newCreateView',
			'',
		...
		handler:function(){
			if (billApplygrid.selModel.hasSelection()){
				...
				if (records.length > 1){
					...
					if (records[0].data.EXAM_STATE != "1" )
						...
						title:'提示',
   						...
   						fn: function(buttonId,text){
   							if(buttonId=='yes'){
								...
								param = param + "&interestBillId=" + records[0].data.INTEREST_BILL_ID;
