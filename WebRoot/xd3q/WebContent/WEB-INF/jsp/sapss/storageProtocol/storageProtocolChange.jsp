	...
	tabs = new Ext.TabPanel({
        ...
        items:[{
            ...
            },
            {
				id:'alterEl',
				title:'仓储协议变更',
				html:'<iframe src="storageProtocolController.spr?action=toChangeTab&infoId=${info.infoId}&from=${from}" width="770" height="430" id="alter" ></iframe>'
             }]
	});
...
<fiscxd:fileUpload divId="fileDiv" erasable="false"  increasable="${increateFile==true}"
