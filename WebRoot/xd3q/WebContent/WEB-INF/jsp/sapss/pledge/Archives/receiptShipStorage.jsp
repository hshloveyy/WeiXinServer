...
function findreceiptsInfo(){
	...
	var requestUrl = 'pledgeReceiptsController.spr?action=queryStorage&' + param;
...
function _expExcel()
{
	...
	window.location.href(contextPath+'/pledgeReceiptsController.spr?action=dealStorageToExcel&'+param);
}
Ext.onReady(function(){
	...
	receiptsInfods = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'pledgeReceiptsController.spr?action=queryStorage'}),
...
<fiscxd:dictionary divId="div_wareHouse" fieldName="wareHouse" dictionaryName="BM_WAREHOUSE" width="153"></fiscxd:dictionary>
</body>
</html>