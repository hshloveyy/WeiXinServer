...
function alertInfo(obj){
	if(obj.value=='Y') Ext.Msg.alert('提示','请上传“额度申请表”（即客户尽职调查表）及最新相关财报等附件');
}
</script>
</head>
<body>
...
<table width="755" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
  <tr >
    ...
    <table width="755" align="center" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
      ...
      <tr>
        <td colspan="2"><div align="center"><font color="red">*</font><c:if test="${main.tradeType=='1'||main.tradeType=='6'}">代理协议号</c:if><c:if test="${main.tradeType!='1'&&main.tradeType!='6'}">协 议 号</c:if></div></td>
        <td><input name="oldProjectNo" type="text" size="55" tabindex="3"  value="${main.oldProjectNo}"/><font color='red'>如无协议号，请填“无”</font></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input id="availableDataEnd" name="availableDataEnd" type="text" size="55" tabindex="5" value="${main.availableDataEnd}" readonly="readonly"/></td>
      </tr>
       <tr>
        <td colspan="2"><div align="center"  >是 否 授 信<font color="red">*</font></div></td>
        <td>
        	<select id="isCredit" name="isCredit" tabindex="27" onchange="alertInfo(this)">
			...
			<select id="cmd" name="cmd" tabindex="27">
				<option value="Y"
					<c:if test="${main.cmd=='Y'}"> selected </c:if>>Y</option>
				<option value="N"
					<c:if test="${main.cmd=='N'||main.cmd==''||empty main.cmd}"> selected </c:if>>N</option>
			</select>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	...
  	<table width="750">
  		<tr>
  			...
  			<td width="1%" >
  				...
  				<input type="hidden" name="interestRate" value="${empty main.interestRate?INTEREST_RATE:main.interestRate}"/>
  			</td>
...
<form id="detailForm">
<input type="hidden" name="tradeType" value="${main.tradeType}"/>
<c:if test="${main.tradeType=='7'||main.tradeType=='10'||main.tradeType=='8'}">
...
<c:if test="${main.tradeType=='1'||main.tradeType=='3'||main.tradeType=='9'||main.tradeType=='11'||main.tradeType=='12'}">
