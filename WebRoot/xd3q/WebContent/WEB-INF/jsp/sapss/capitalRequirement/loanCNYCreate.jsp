...
repayds = new Ext.data.Store({
   		proxy : new Ext.data.HttpProxy({url:'loanCNYController.spr?action=findRepay&loanID='+re_loanID}),
 ...
 var addRepay = new Ext.Toolbar.Button({
   		...
   		iconCls:'add',
		handler:function(){
			var requestUrl = 'loanCNYController.spr?action=createRepay&loanID='+re_loanID;
			Ext.Ajax.request({
				url: requestUrl,
					...
					title:'提示',
  						...
  						fn: function(buttonId,text){
  							if(buttonId=='yes'){
								...
								new AjaxEngine('loanCNYController.spr', 
...
repaygrid.on("afteredit", afterEdit, repaygrid);
 function afterEdit(obj){
        ...
        var requestUrl = 'loanCNYController.spr?action=saveRepay';
...
<table width="775" align="center" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
	  ...
	  <tr>
        ...
        <td colspan="4">
        	<input name="balance" type="text" size="25" tabindex="5" value="${main.balance}" readonly="readonly"/>
			<font color="#FF0000">注：保存后，余额系统自动计算</font>
        </td>
      </tr>
</table>
