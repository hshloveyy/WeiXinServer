...
<table width="755" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
	  ...
	  <tr>
        ...
        <td colspan="2" align="right">开证行<font color="red">▲</font></td>
        <td>
        	<input name="bank" type="text" size="25" tabindex="2" value="${main.bank}"/>
        </td>
      </tr>
	  <tr>
        <td align="right">开证日<font color="red">▲</font></td>
        <td>
	  ...
	  <tr>
        <td align="right">收益人名称<font color="red">▲</font></td>
        <td>
