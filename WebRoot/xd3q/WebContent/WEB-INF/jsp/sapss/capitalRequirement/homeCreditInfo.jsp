...
Ext.onReady(function(){
	...
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'fundsRequireQueryController.spr?action=rtnHomeCreditInfo&date=${date}'}),
...
function colClick(paymentId){
	top.ExtModalWindowUtil.show("国内证详细","xdss3/payment/homePaymentController.spr?action=_view&paymentid="+paymentId,
