...
<form action="" id="findsalesForm" name="findForm">
<table width="100%">
<tr>
	<td align="center" >信用证号码</td>
	<td align="center" >开证行</td>
	<td align="center" >关联合同号</td>
...
function find(){
	...
	var requestUrl  = 'creditQueryController.spr?action=rtnFindCredit&' + param;
