...
Ext.onReady(function(){
	...
	var customerForm=new Ext.form.FormPanel({
 	...
 	var ds = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'masterQueryController.spr?action=rtnFindMaterial'}),
...
function findMaterial(){
	var url = 'masterQueryController.spr?action=rtnFindMaterial&'+Form.serialize('materialForm');
...
<form id="materialForm">
	<table width="715"  border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" >
		...
		<tr>	
			...
			<td><input type="text" size="18"  name="materialOrg" value="${materialOrg}"  readOnly/></td>	
		</tr>
		<tr align="center">
			<td colspan="6">
