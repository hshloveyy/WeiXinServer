...
//						productOrg:Ext.getDom('productOrg').value
 	...
 	var ds = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'masterQueryController.spr?action=rtnFindCustomer'}),
...
function findCustomer(){
	var url = 'masterQueryController.spr?action=rtnFindCustomer&'+Form.serialize('customerForm');
