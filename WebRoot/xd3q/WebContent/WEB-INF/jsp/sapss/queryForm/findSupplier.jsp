...
Ext.onReady(function(){
	...
	var ds = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'masterQueryController.spr?action=rtnFindSupplier'}),
...
function findSupply(){
	var url = 'masterQueryController.spr?action=rtnFindSupplier&'+Form.serialize('supplierForm');
