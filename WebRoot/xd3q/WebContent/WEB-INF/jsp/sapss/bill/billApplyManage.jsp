...
Ext.onReady(function(){
	...
	billApplyds = new Ext.data.Store({
        		proxy : new Ext.data.HttpProxy({url:'billApplyController.spr?action=queryBillApply&tradeType='+tradeType}),
...
function viewForm(billApplyId){
	...
	top.ExtModalWindowUtil.show(strBillApplyTitle + '开票申请单信息',
		'billApplyController.spr?action=addBillApplyView&billApplyId='+ billApplyId +"&tradeType="+ tradeType +"&operType=001",
		'',
