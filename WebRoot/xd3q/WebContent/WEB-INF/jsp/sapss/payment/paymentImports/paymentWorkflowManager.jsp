...
Ext.onReady(function(){
	var mainForm = new Ext.form.FormPanel({
		...
		items:[{
			...
			html:'<iframe src="${iframeSrc}" width=100% height=400 id="content" ></iframe>',
			minHeight:100,
			autoHeight:true,
...
function printHandler(){
    window.open('paymentImportsInfoController.spr?action=dealPrint&paymentId=${businessRecordId}','_blank','location=no,resizable=yes');
}
</script>
</head>
<body>
