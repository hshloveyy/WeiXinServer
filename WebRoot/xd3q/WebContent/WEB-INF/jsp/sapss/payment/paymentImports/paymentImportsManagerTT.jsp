...
<tr>
	...
	<td>
		<input type="text" id="applyTime" name="applyTime" value=""></input>
	</td>
	<td align="right">审批通过时间：</td>
	<td>
		<input type="text" id="approvedTime" name="approvedTime" value=""></input>
	</td>
	<td align="right">即期/承兑到期付款日：</td>
	<td>
		<input type="text" id="payTime" name="payTime" value=""></input>
	</td>
</tr>
<tr>
