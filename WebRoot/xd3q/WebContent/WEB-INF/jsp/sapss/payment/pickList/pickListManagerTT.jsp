...
String pickListType=request.getParameter("pickListType"); %><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
    <head>
            ...
            <form action="" id="findFrom" name="findFrom">
				<table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="collectionBank" name="collectionBank" value=""></input>
                        </td>
	...
	function operaForm(pickListId){
		...
		top.ExtModalWindowUtil.show(paymentTitle + '到单管理',
			'pickListInfoController.spr?action=addPickListInfoView&pickListId='+ pickListId + '&pickListType=' + pickListType,
			'',
	...
	function viewForm(){
		...
		top.ExtModalWindowUtil.show(paymentTitle + '到单管理',
			'pickListInfoController.spr?action=viewPickListInfo&pickListId='+ pickListId + '&pickListType=' + pickListType,
			'',
			PickListInfocallbackFunction,
			{width:900,height:550});
	}
