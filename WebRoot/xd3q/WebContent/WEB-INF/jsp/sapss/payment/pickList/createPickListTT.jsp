...
function selectPurchaseInfoCallBack(){
	...
	Ext.getDom('timeLimit').value = returnvalue.EKKO_ZTERM_D_PAYMENT_TYPE;
...
<form id="mainForm" action="" name="mainForm">
	 <table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
      ...
      <tr>
        ...
        <td width="22%" align="left">
			<input id="collectionBank" name="collectionBank" type="text" size="20" value="${tPickListInfo.collectionBank}"/>
        </td>      	
      </tr>
      <tr>
