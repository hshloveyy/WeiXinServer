...
<form id="mainForm" action="" name="mainForm">
	<table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
      <tr>
		...
		<td>
			<input value="${selectText_dept}" readonly="readonly"/>
		</td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="11%" align="right">D/P D/A No.：</td>
        <td width="22%" align="left">
        	<input name="dpDaNo" type="text" size="20" tabindex="1" value="${tPickListInfo.dpDaNo}" readOnly="true"/>
        </td>      
      ...
      <tr>
        ...
        <td width="22%" align="left">
            <input id="securityPickDate" name="securityPickDate" type="text" value="${tPickListInfo.securityPickDate}" readOnly="true"/>                
        </td>
      </tr>
      <tr>
        <td width="11%" align="right">承兑日：</td>
        <td width="22%" align="left">
            <input id="acceptanceDate" name="acceptanceDate" type="text" value="${tPickListInfo.acceptanceDate}" readOnly="true"/>
        </td>      
      ...
      <tr>
        ...
        <td width="22%" align="left">
			<input name="collectionBank" type="text" size="20" value="${tPickListInfo.collectionBank}" readOnly="true"/>
        </td>
      ...
      <tr>
        <td width ="11%" align="right">贸管意见：</td>
