...
function selectPurchaseWin(){
	...
	'pickListInfoController.spr?action=selectPurchaseInfo&orderState=3',
	'',
...
<form id="mainForm" action="" name="mainForm">
	 <table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
      <tr>
        <td width="11%" align="right">单号：</td>
        <td width="22%" align="left">
        	<input name="pickListNo" type="text" size="20" tabindex="1" value="${tPickListInfo.pickListNo}" readOnly="true"/>
        </td>
        <td width="11%" align="right">到单类型：</td>
        <td width="22%" align="left">
           <div id="div_pickListType"></div>
        </td>
		<td align="right">部门/创建者：</td>
		<td>
			${sysDept.deptname}/${creatorName}
      ...
      <tr>
        ...
        <td width="22%" align="left">
        	<input name="contractNo" type="text" size="20" tabindex="1" value="${tPickListInfo.contractNo}" readOnly="true"/>
        </td>
      ...
      <tr>
        ...
        <td width="22%" align="left">
        	<input name="shipmentPort" type="text" size="20" tabindex="1" value="${tPickListInfo.shipmentPort}" readOnly="true"/>
        </td>      
        <td  align="right">目的港：</td>
        <td  align="left">
        	<input name="destinationPort" type="text" size="20" tabindex="1" value="${tPickListInfo.destinationPort}" readOnly="true"/>
        </td>
        <td width="11%" align="right">付款日：</td>
        <td width="22%" align="left">
             <input id="payDate" name="payDate" type="text" value="${tPickListInfo.payDate}" readOnly="true" />        
        </td>
      </tr>
      <tr>
        <td  align="right">预计到货日：</td>
        <td  align="left">
            <input id="arrivalDate" name="arrivalDate" type="text" value="${tPickListInfo.arrivalDate}" readOnly="true" />      	
        </td>      
        <td width="11%" align="right">单到日：</td>
        <td width="22%" align="left">
            <input id="pickListRecDate" name="pickListRecDate" type="text" value="${tPickListInfo.pickListRecDate}" readOnly="true" />    
        </td> 
        <td width="11%" align="right">代收行：</td>
        <td width="22%" align="left">
			<input name="collectionBank" type="text" size="20" value="${tPickListInfo.collectionBank}" readonly="readonly"/>
        </td>     	
      </tr>
      <tr>
        ...
        <td width="11%" align="right">TT期限：</td>
        <td width="22%" align="left" >
	...
	<input name="lcNo" type="hidden" size="40" value="${tPickListInfo.lcNo}"/>	
	<input name="collectionBank" type="hidden" size="40" value="${tPickListInfo.collectionBank}"/>
	<input name="dpDaNo" type="hidden" size="40" value="${tPickListInfo.dpDaNo}"/>
	<input name="issuingDate" type="hidden" size="40" value="${tPickListInfo.issuingDate}"/>
	<input name="securityPickDate" type="hidden" size="40" value="${tPickListInfo.securityPickDate}"/>
	<input name="examineState" type="hidden" size="40" value="${tPickListInfo.examineState}"/>
	<input name="deptId" type="hidden" size="40" value="${tPickListInfo.deptId}"/>												
</form>
</div>
...
<fiscxd:dictionary divId="div_pickListType" fieldName="pickListType" dictionaryName="BM_PICK_LIST_TYPE_TT" width="150" selectedValue="${tPickListInfo.pickListType}" disable="true" ></fiscxd:dictionary>
