...
<table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
	...
	<td width="25%" >
		<div id="dept"></div>
		<input type="hidden" name="returnType" type="text" size="20" value="0"/>
	</td>    
...
function view(){
	var record = tempGrid.selModel.getSelections();
	top.ExtModalWindowUtil.show('未开票退货信息','salesReturnController.spr?action=forView&id='+record[0].json.RETURN_ID,'',find,{width:800,height:600,closable:false});
}
