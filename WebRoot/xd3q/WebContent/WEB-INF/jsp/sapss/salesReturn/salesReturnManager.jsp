...
<table width="100%" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF" class="datatable">
	...
	<td >
		<div id="dept"></div>
		<input type="hidden" name="returnType" type="text" value="${returnType}"/>
	</td>    
      <td width="10%" align="right">立项号:</td>
     <td ><input name="projectNo" type="text" size="15"/></td>
      <td width="10%" align="right">合同编码:</td>
      <td><input name="contractNo" type="text" size="15"/></td>
      <td width="10%" align="right">SAP订单号(原单):</td>
...
function view(){
	var record = tempGrid.selModel.getSelections();
	top.ExtModalWindowUtil.show('已开票退货信息','salesReturnController.spr?action=forView&id='+record[0].json.RETURN_ID,'',find,{width:800,height:600});
}
