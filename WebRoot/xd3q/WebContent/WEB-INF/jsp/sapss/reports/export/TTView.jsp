...
Ext.onReady(function(){
	Ext.QuickTips.init();
   	...
   	var column=[new Ext.grid.RowNumberer(),
			...
			,{header:'T/T NO.',sortable:true,dataIndex:'LCDPDA_NO',width:80}
			,{header:'T/T期限',sortable:true,dataIndex:'VALID_DATE',width:80}
			...
			/*,{header:'开票日期',sortable:true,dataIndex:'EXAM_DATE',width:80}*/
			,{header:'出单日期',sortable:true,dataIndex:'EXAM_DATE',width:80}
	...
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'exportRController.spr?action=rtnTTView&'+serv_param}),
...
function doExport(){
	...
	window.location.href('exportRController.spr?action=TTViewToExcel&'+param);
