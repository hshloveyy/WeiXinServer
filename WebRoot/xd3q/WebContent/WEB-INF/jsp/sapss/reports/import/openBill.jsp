...
Ext.onReady(function(){
	...
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'importController.spr?action=rtnOpenBill&'+serv_param}),
...
function doExport(){
	...
	window.location.href('importController.spr?action=openBillToExcel&'+param);
