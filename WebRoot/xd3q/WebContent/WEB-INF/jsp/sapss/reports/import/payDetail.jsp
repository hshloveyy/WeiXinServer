...
Ext.onReady(function(){
	Ext.QuickTips.init();
   	...
   	var column=[new Ext.grid.RowNumberer(),
	            		...
	            		,{header:'到单号',sortable:true,dataIndex:'PICK_LIST_NO',width:80}
	            		...
	            		,{header:'付汇日期',sortable:true,dataIndex:'PAY_REAL_TIME',width:80}
	            		,{header:'付汇金额',sortable:true,dataIndex:'PAY_REAL_VALUE',width:80}
	            		,{header:'币别',sortable:true,dataIndex:'CURRENCY',width:80}
	            		,{header:'用途',sortable:true,dataIndex:'PAY_USE',width:80}
					];
   		
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'importController.spr?action=rtnPayDetail&'+serv_param}),
...
function doExport(){
	...
	window.location.href('importController.spr?action=payDetailToExcel&'+param);
