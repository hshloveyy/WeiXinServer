...
Ext.onReady(function(){
	...
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'homeTradeController.spr?action=rtnBillValidate&'+serv_param}),
...
function doExport(){
	...
	window.location.href('homeTradeController.spr?action=billValidateToExcel&'+param);
