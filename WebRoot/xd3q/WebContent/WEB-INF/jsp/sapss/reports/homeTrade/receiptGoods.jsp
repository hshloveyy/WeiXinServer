...
Ext.onReady(function(){
	Ext.QuickTips.init();
   	...
   	var field=[{name:'DEPT_NAME'},{name:'TRADE_TYPE'},{name:'CONTRACT_NO'},{name:'OLD_CONTRACT_NO'},{name:'EKKO_LIFNR_NAME'},{name:'EKPO_TXZ01'}
	...
	store = new Ext.data.Store({
		proxy : new Ext.data.HttpProxy({url:'homeTradeController.spr?action=rtnReceiptGoods&'+serv_param}),
...
function doExport(){
	...
	window.location.href('homeTradeController.spr?action=receiptGoodsToExcel&'+param);
