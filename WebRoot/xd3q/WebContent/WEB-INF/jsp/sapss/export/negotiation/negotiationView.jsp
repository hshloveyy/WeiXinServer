  ...
  <tr>
    <td width="585" height="100%" valign="top"><table width="585" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
     ...
     <tr>
        ...
        <td><input type="text" name="bank" value="${tNegotiation.bank}" readonly="readonly" /></td>
      </tr>
     <tr>
     ...
     <tr>
        ...
        <td><input type="text" name="applyMoney" value="${tNegotiation.applyMoney}" readonly="readonly" /></td>
     </tr>
     <tr>
        <td><div align="right">实际金额:</div></td>
        <td><input type="text" name="realMoney" value="${tNegotiation.realMoney}" readonly="readonly" /></td>
     </tr> 
      <tr height="25">  
      </tr>
      <tr>
...
Ext.onReady(function(){
	...
	function viewContractSalesForm(){
			top.ExtModalWindowUtil.show('查看销售合同','contractController.spr?action=archSalesInfoView&businessRecordId=${tNegotiation.contractSalesId}','','',{width:800,height:500});
    }
...
<fiscxd:workflow-taskHistory divId="div_history" businessRecordId="${tNegotiation.negotiationId}" width="750"></fiscxd:workflow-taskHistory>
<fiscxd:dictionary divId="div_currency" fieldName="currency"  dictionaryName="BM_CURRENCY" width="153" selectedValue="${tNegotiation.currency}" needDisplayCode="true" disable="true"></fiscxd:dictionary>
