  ...
  <tr>
    <td width="585" height="100%" valign="top"><table width="585" border="1" cellpadding="4" cellspacing="1" bordercolor="#6699FF">
     ...
     <tr>
        ...
        <td><input type="text" name="bank" value="${tDiscount.bank}" /></td>
      </tr>
     <tr>
     ...
     <tr>
        ...
        <td><input type="text" name="applyMoney" value="${tDiscount.applyMoney}" /></td>
     </tr>
      ...
      <tr>
        <td colspan="2" align="center">
			...
			<input type="button" name="Submit2" value="提交" onclick="submitForm()"/>        	
          	...
          	<input type="hidden" name="realMoney" value="${tDiscount.realMoney}"/>
...
<fiscxd:dictionary divId="div_currency" fieldName="currency"  dictionaryName="BM_CURRENCY" width="153" selectedValue="${tDiscount.currency}" needDisplayCode="true"></fiscxd:dictionary>
