...
<tr><td colspan="2" align="center"><input type="button" onclick="sysAll(this)" value="同步所有"/></td></tr>
<c:forEach var="name" items="${files}">
    <tr>
      <td width="50%" height="20" align="right">${name}</td>
      <td align="center"><input type="button" onclick="sysByname(this,'${name}')" value="同步"/></td>
    </tr>
</c:forEach>
</table>
</form>
  ...
  btn.disabled=true;
	Ext.Msg.show({
   		...
   		fn: function(buttonId,text){
   			if(buttonId=='yes'){
					Ext.Ajax.request({
					url: 'dictionarySyncController.spr?action=sysByName&file_name='+name,
