...
function findProjectInfo(){
	...
	var requestUrl  = 'creditArriveController.spr?action=queryProjectInfo&' + param;
	requestUrl = requestUrl + "&tradeType=" + dict_div_tradeType.getSelectedValue().trim()+'&deptId='+selectId_deptDiv;
...
<fiscxd:dictionary divId="div_tradeType" fieldName="tradeType" disable="true" dictionaryName="BM_BUSINESS_TYPE" selectedValue="${tradeType}" width="153"></fiscxd:dictionary>
