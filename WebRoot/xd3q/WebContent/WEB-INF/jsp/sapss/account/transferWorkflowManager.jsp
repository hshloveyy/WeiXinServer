...
function printTransfer(){
	window.open('innerTransferController.spr?action=print&transferID=${businessRecordId}');
}
</script>
</head>
<body>
...
<table width="755" border="0" cellspacing="1" cellpadding="1">
	<tr>
		...
		<td align="left" width="45%">
			...
			if("出纳付款".equals(taskName)){%>
				&nbsp;&nbsp;&nbsp;<input type="button" onClick="printTransfer()" value="打印"/>
			<%}%>
		</td>
