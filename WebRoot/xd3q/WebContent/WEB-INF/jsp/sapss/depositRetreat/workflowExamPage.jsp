...
Ext.onReady(function(){
	var mainForm = new Ext.form.FormPanel({
		...
		items:[{
			...
			html:'<iframe src='+src+' width="99%" style="height:280" id="content" ></iframe>',
			height:280,
			autoHeight:true,
			title:'审批内容',
			autoScroll:true,
...
function printHandler(){
    window.open('depositRetreatController.spr?action=dealPrint&depositRetreatId=${businessRecordId}','_blank','location=no,resizable=yes');
}
</script>
</head>
<body>
	...
	<div id="action">
		<table width="755" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td align="left">
				<c:if test="${printHandle=='true'}">
				   <input type="button" value="打印" onclick="printHandler()">
				</c:if>
				</td>
			</tr>
		</table>
