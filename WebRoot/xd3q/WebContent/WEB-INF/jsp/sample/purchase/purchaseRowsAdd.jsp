<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象采购订单行项目信息(SAP)(PurchaseRows)增加页面
--%>
...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchaseRowsAdd.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchaseRowsAddGen.js"></script>
</head>
<body>
