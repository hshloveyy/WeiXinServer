...
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchaseInfoEdit.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchaseInfoEditGen.js"></script>
</head>
<body>
<fisc:grid divId="div_purchaseRows" boName="PurchaseRows" needCheckBox="true" editable="true" defaultCondition=" YPURCHASEROWS.PURCHASEINFOID='${purchaseInfo.purchaseinfoId}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td  width="40%">
		    <input type="text" class="inputText" id="PurchaseInfo.createTime" name="PurchaseInfo.createTime" value="${purchaseInfo.createTime}"  readonly="readonly" <fisc:authentication sourceName="PurchaseInfo.createTime" taskId="${workflowTaskId}"/>>
		</td>
	</tr>
	<tr>
		<td align="right" width="15%" >${vt.property.lastmodifyTime}：</td>
		<td width="30%">
		    <input type="text" class="inputText" id="PurchaseInfo.lastmodifyTime" name="PurchaseInfo.lastmodifyTime" value="${purchaseInfo.lastmodifyTime}"  readonly="readonly" <fisc:authentication sourceName="PurchaseInfo.lastmodifyTime" taskId="${workflowTaskId}"/>>
		</td>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deletePurchaseInfo,iconCls:'icon-delete'},'-',
{id:'_create',text:'${vt.mCreate}',handler:_createPurchaseInfo,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdatePurchaseInfo,iconCls:'icon-table-save'},'-',
