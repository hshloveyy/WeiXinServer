<%-- 
  ...
  - Date: 2009年12月04日 10点48分27秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>主对象SAP采购凭证(PurchasingDoc)查看页面
--%>
...
<title>SAP采购凭证查看页面</title>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchasingDocView.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/purchase/purchasingDocViewGen.js"></script>
<style type="text/css">
  .x-grid3-header-offset {width: auto;}
</style>
</head>
<body>
<fisc:grid divId="div_purchasingDocItem" boName="PurchasingDocItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" EKPO.EBELN='${purchasingDoc.ebeln}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="15%" align="right" >采购凭证的状态：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td width="15%" align="right" >最后审批人：</td>
		<td  width="40%">
	...
	<tr>
		...
		<td width="15%" align="right" >最后审批时间：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >付款条件代码：</td>
		<td width="30%">
