<%-- 
  ...
  - @(#)
  - Description:  
  - <功能>子业务对象采购订单明细(OporDocItem)编辑页面
--%>
...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/b1/opor/oporDocItemEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/b1/opor/oporDocItemEditGen.js"></script>
</head>
<body>
