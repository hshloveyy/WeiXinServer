...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/b1/opor/oporDocView.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/b1/opor/oporDocViewGen.js"></script>
</head>
<body>
<fisc:grid divId="div_oporDocItem" boName="OporDocItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YOPORDOCITEM.OPORDOCID='${oporDoc.oporDocId}'" needAutoLoad="true" height="285" nameSapceSupport="true" orderBySql=" YOPORDOCITEM.ITEMCODE "></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.docDueDate}：</td>
		<td width="30%">
		...
		<td width="15%" align="right" >${vt.property.docTotal}：</td>
		<td  width="40%">
	...
	<tr>
		<td width="15%" align="right" >${vt.property.u_lc}：</td>
		<td width="30%">
