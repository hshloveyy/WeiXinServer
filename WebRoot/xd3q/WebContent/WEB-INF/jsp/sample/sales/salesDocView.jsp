...
<title>SAP销售订单查看页面</title>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/sales/salesDocView.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/sales/salesDocViewGen.js"></script>
<style type="text/css">
  .x-grid3-header-offset {width: auto;}
</style>
</head>
<body>
<fisc:grid divId="div_salesDocItem" boName="SalesDocItem" needToolbar="false" needCheckBox="true" editable="false" defaultCondition=" YVSOITEM.VBELN='${salesDoc.vbeln}'" needAutoLoad="true" height="285" nameSapceSupport="true"></fisc:grid>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		<td width="15%" align="right" >付款条件：</td>
		<td width="30%">
