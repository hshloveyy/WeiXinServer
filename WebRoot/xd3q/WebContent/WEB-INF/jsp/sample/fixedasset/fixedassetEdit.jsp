<%-- 
  ...
  - Date: 2009年12月08日 08点18分09秒
  - Copyright Notice:版权声明 福建讯盟软件有限公司, 版权所有 违者必究
  - @(#)
  - Description:  
  - <功能>固定资产(Fixedasset)编辑页面
--%>
...
<title>固定资产编辑页面</title>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/fixedasset/fixedassetEdit.js"></script>
<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/sample/fixedasset/fixedassetEditGen.js"></script>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Fixedasset.createtime" name="Fixedasset.createtime" value="${fixedasset.createtime}"  readonly="readonly" <fisc:authentication sourceName="Fixedasset.createtime" taskId="${workflowTaskId}"/>>
		</td>
	...
	<tr>
		...
		<td width="30%">
		    <input type="text" class="inputText" id="Fixedasset.lastmodifytime" name="Fixedasset.lastmodifytime" value="${fixedasset.lastmodifytime}"  readonly="readonly" <fisc:authentication sourceName="Fixedasset.lastmodifytime" taskId="${workflowTaskId}"/>>
		</td>
        <td></td>
        <td></td>
	</tr>
...
{id:'_delete',text:'删除',handler:_deleteFixedasset,iconCls:'icon-delete'},'-',
{id:'_create',text:'创建',handler:_createFixedasset,iconCls:'icon-add'},'-',
'->','-',
{id:'_saveOrUpdate',text:'保存',handler:_saveOrUpdateFixedasset,iconCls:'icon-table-save'},'-',
