...
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/orderManage/purchaseOrder/purchaseOrderEdit.js"></script>
<script language="javascript" type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/sample/orderManage/purchaseOrder/purchaseOrderEditGen.js"></script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		...
		<td width="30%">
			<input type="text" class="inputText" id="PurchaseOrder.purchaseOrderNo" name="PurchaseOrder.purchaseOrderNo" value="${purchaseOrder.purchaseOrderNo}"   readonly="readonly" <fisc:authentication sourceName="PurchaseOrder.purchaseOrderNo" taskId="${workflowTaskId}"/>>
		</td>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
			...
			<tr>
				...
				<td  width="40%">
		    		<input type="text" class="inputText" id="PurchaseOrder.createTime" name="PurchaseOrder.createTime" value="${purchaseOrder.createTime}"  readonly="readonly" <fisc:authentication sourceName="PurchaseOrder.createTime" taskId="${workflowTaskId}"/>>
				</td>
				</tr>
			<tr>
				...
				<td  width="40%">
		    		<input type="text" class="inputText" id="PurchaseOrder.lastModifyTime" name="PurchaseOrder.lastModifyTime" value="${purchaseOrder.lastModifyTime}"  readonly="readonly" <fisc:authentication sourceName="PurchaseOrder.lastModifyTime" taskId="${workflowTaskId}"/>>
				</td>
				</tr>
	</table>
	</form>
...
{id:'_delete',text:'${vt.mDelete}',handler:_deletePurchaseOrder,iconCls:'icon-delete'},'-',
{id:'_print',xtype:'printbutton',text:'${vt.sPrint}',boName:'PurchaseOrder',methodName:'_print',className:'com.infolion.sample.orderManage.purchaseOrder.domain.PurchaseOrder',businessId:'${purchaseOrder.purchaseOrderId}'},'-',
'->','-',
{id:'_saveOrUpdate',text:'${vt.mSaveOrUpdate}',handler:_saveOrUpdatePurchaseOrder,iconCls:'icon-table-save'},'-',
