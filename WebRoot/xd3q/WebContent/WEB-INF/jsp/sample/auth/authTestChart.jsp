...
<div id="div_chart_container" class="chart">
	<div id="AuthTestChart_div"></div>
</div>

<div id="AuthTestChartDetail_div" style="width: 100%"></div>
</body>
</html>
...
Ext.onReady(function(){
			...
			items:[{
				...
				items:[{
					...
					items:[{
						...
						id:'AuthTestChart_div_ext'
					},{
						title:'${vt.chartDetail}',
						contentEl:"AuthTestChartDetail_div"
					}]
				}]
			}]
		});
		Ext.getDom('AuthTestChart_div_ext').align='center';
	});
	...
	**/
	function _queryChart()
	{
		...
		AuthTestChart_div_reload_chart({queryParameters:queryParam,title:chartTitle});
	}
	//清空操作
	function _resetForm()
	{
...
<fisc:chart divId="AuthTestChart_div" divDetailId="AuthTestChartDetail_div" width="400" height="300" boName="AuthTest" defaultCondition=""></fisc:chart>