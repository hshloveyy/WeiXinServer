...
<%@ tag	import="com.infolion.platform.basic.util.StringUtils"%>
<script type="text/javascript" defer="defer" src="<%= request.getContextPath() %>/js/ext-2.0/TreeCheckNodeUI.js"></script>
...
<script type="text/javascript" defer="defer">
    ...
    var ${treeload} = new Ext.tree.TreeLoader({
    	...
    	url:'orgController.spr?action=querySelectDeptInfo'
    });
    ...
    var ${treename} = new Ext.tree.TreePanel({
        ...
        autoHeight:true,
        enableDD:true,
        <%="true".equals(isMutilSelect)?"":"checkModel:'single',"%>
