/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象${beanAttribute.boDescription}(${beanAttribute.boName})增加页面用户可编程扩展JS文件
 */
 ...
 */
function ${gridColumn.method.methodName}${subBo.boName}()
{
   //方法执行体
...
<#--EEEEEEEE生成子业务对象grid上超级链接所用到的方法-->
