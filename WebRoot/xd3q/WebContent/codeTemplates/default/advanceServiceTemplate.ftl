 ...
 *  描　述：创建
 */
package ${beanAttribute.packageName}.exservice;
...
/**
 * <pre>
 * ${beanAttribute.boDescription}(${beanAttribute.boName})扩展服务类
 * </pre>
 * 
 * <br>
 * JDK版本:1.5
 ...
 */
@Service
public class ${beanAttribute.beanName} implements AdvanceService
{
