/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象${beanAttribute.boDescription}(${beanAttribute.boName})管理页面JS文件
 */
...
<#if bo.boType=="1">
	<@commonObjectTypeManageJsLib.generatorCommonObjectTypeManageJsGen/>
<#else>
	<@treeObjectTypeManageJsLib.generatorCommonObjectTypeManageJsGen/>
</#if>