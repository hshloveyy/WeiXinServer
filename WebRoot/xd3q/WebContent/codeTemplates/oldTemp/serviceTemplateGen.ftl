...
<#if subBo.boName=="Attachement" >
	@Autowired
	protected ${subBo.boName}JdbcDao ${subBo.beanAttribute.boInstanceName}JdbcDao;
	
	public void set${subBo.boName}JdbcDao(${subBo.boName}JdbcDao ${subBo.beanAttribute.boInstanceName}JdbcDao)
	{
		this.${subBo.beanAttribute.boInstanceName}JdbcDao = ${subBo.beanAttribute.boInstanceName}JdbcDao;
	}
</#if>
</#if>
</#list>
  ...
  <#list subBoList?if_exists as subBo>     <#-- 遍历业务对象下所有子对象 -->
   <#if property.propertyType=="业务对象" && property.subBoName==subBo.boName>
      <#if (property.subBoRelType=="2" || property.subBoRelType=="3") && subBo.parentBusinessObjectName!="" && property.subBoName=="Attachement">
	    ...
	    ${property.propertyName?uncap_first}JdbcDao.update(${property.propertyName}s,${bo.primaryKeyProperty.propertyName});
      </#if>
    </#if>
   </#list>
</#list>
  ...
  <#list subBoList?if_exists as subBo>     <#-- 遍历业务对象下所有子对象 -->
   <#if property.propertyType=="业务对象" && property.subBoName==subBo.boName>
      <#if (property.subBoRelType=="2" || property.subBoRelType=="3") && subBo.parentBusinessObjectName!="" && property.subBoName=="Attachement">
        //删除业务附件
       	String ${bo.primaryKeyProperty.propertyName} = ${beanAttribute.boInstanceName}.get${bo.primaryKeyProperty.propertyName?cap_first}();
	    ${property.propertyName?uncap_first}Service.deleteByBusinessId(${bo.primaryKeyProperty.propertyName});
      </#if>
    </#if>
   </#list>
</#list>
