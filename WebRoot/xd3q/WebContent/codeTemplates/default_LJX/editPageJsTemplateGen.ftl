...
<#if property.columnName=="CREATOR" ||  property.columnName=="LASTMODIFYER" ||  property.columnName=="LASTMODIFYOR"> 
	document.getElementById("${beanAttribute.boName}.${property.propertyName}_text").value = result.${property.propertyName}_text;
	document.getElementById("${beanAttribute.boName}.${property.propertyName}").value = result.${property.propertyName};
...
<#elseif subBo.subBoAttribute.subBoRelType=="2" || subBo.subBoAttribute.subBoRelType=="3" || subBo.subBoAttribute.subBoRelType=="4">
	...
	reload_${subBo.boName}_grid("defaultCondition=${subBo.tableName}.${bo.primaryKeyProperty.columnName}='"+ ${bo.primaryKeyProperty.propertyName} +"'");
	<#else>
	reload_${subBo.boName}_grid("defaultCondition=${subBo.tableName}.BUSINESSID='"+ ${bo.primaryKeyProperty.propertyName} +"'");
	</#if>
</#if>  
</#list>  
</#if>  	
