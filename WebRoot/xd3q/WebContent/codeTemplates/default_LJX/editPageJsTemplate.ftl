/**
  ...
  * @(#)
  * Description:  
  * <功能>主对象${beanAttribute.boDescription}(${beanAttribute.boName})编辑页面用户可编程扩展JS文件
 */
 ...
 */
function ${toolbar.method.methodName}()
{
   if(pre${toolbar.method.methodName}()){
   //方法执行体
   }
   post${toolbar.method.methodName}();
}

/**
 *  ${toolbar.method.methodDesc}
 */
function pre${toolbar.method.methodName}()
{
	return true ;
}
 ...
 *  ${toolbar.method.methodDesc}
 */
function post${toolbar.method.methodName}()
{
 ...
 *  ${toolbar.method.methodDesc}
 */
function ${gridColumn.method.methodName}()
{
   if(pre${gridColumn.method.methodName}()){
   //方法执行体
   }
   post${gridColumn.method.methodName}();
}
/**
